...
export class Dynamic extends SampleBase<{}, {}> {
    ...
    public gaugeLoaded(args: ILoadedEventArgs): void {
        ...
        this.circularGauge3.axes[0].annotations = [{
            ...
            content: '<div id="templateWrap"><img src="http://npmci.syncfusion.com/production/react/demos/src/circulargauge/images/fuel.png"></div>',
            angle: 180
        }];
        ...
        this.circularGauge4.axes[0].annotations = [{
            radius: '50%',
            content: '<div id="templateWrap"><img src="http://npmci.syncfusion.com/production/react/demos/src/circulargauge/images/battery.png"></div>',
...
ReactDOM.render(<Dynamic />, document.getElementById('sample'));