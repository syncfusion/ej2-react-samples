                                        ...
                                        <AxesDirective>
                                            <AxisDirective startAngle={230} endAngle={130} minimum={0} maximum={100}
                                                ...
                                                <AnnotationsDirective>
                                                    <AnnotationDirective
                                                        content='<div id="templateWrap"><img class="imageStyle" src="http://npmci.syncfusion.com/production/react/demos/src/circulargauge/images/positive.png" /><div class="fontDes">${pointers[0].value}%</div></div></div>'
                                                        angle={180} zIndex='1'
                                                        radius='30%' />
                                                    <AnnotationDirective
                                    ...
                                    <CircularGaugeComponent style={{ height: "250px" }} ref={gauge => this.sampleGauge3 = gauge} loaded={this.onChartLoad.bind(this)} id='sample3-container'>
                                        ...
                                        <AxesDirective>
                                            <AxisDirective startAngle={230} endAngle={130} minimum={0} maximum={100}
                                                ...
                                                <AnnotationsDirective>
                                                    <AnnotationDirective
                                                        content='<div id="templateWrap"><img class="imageStyle" src="http://npmci.syncfusion.com/production/react/demos/src/circulargauge/images/negative.png" /><div class="fontDes">${pointers[0].value}%</div></div></div>'
                                                        angle={180} zIndex='1'
                                                        radius='30%' />
                                                    <AnnotationDirective
...
ReactDOM.render(<SampleData />, document.getElementById('sample'));