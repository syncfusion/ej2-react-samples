                            ...
                            <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
                                <tbody>
                                    <tr style={{ height: '50px' }}>
                                        <td>
                                            <img id='random' src="http://npmci.syncfusion.com/production/react/demos/src/circulargauge/images/gauge1.png" style={{ marginLeft: '25px', marginTop: '10px' }} onClick={this.random.bind(this)} ref={d => this.image1 = d} />
                                        ...
                                        <td>
                                            <img id='usage' src="http://npmci.syncfusion.com/production/react/demos/src/circulargauge/images/gauge2.png" style={{ marginLeft: '25px', marginTop: '10px' }} onClick={this.usage.bind(this)} ref={d => this.image2 = d} />
...
ReactDOM.render(<Customization />, document.getElementById('sample'));