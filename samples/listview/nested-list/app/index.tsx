...
.folder {
    ...
    background-image: url('http://npmci.syncfusion.com/production/react/demos/src/listview/images/file_icons.png');
...
ReactDOM.render(<Nested />, document.getElementById('sample'));