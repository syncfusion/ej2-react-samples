                ...
                <div className='control-section'>
                    <ChartComponent id='charts' style={{ textAlign: "center" }} ref={charts => this.chartInstance = charts}
                        ...
                        <AnnotationsDirective>
                            <AnnotationDirective content='<div id="chart_cloud"><img src="http://npmci.syncfusion.com/production/react/demos/src/chart/images/cloud.png" style={{width: "41px"; height: "41px"}} /></div>' x='Sun' y={2} coordinateUnits='Point' verticalAlignment='Top'>
                            </AnnotationDirective>
                            <AnnotationDirective content='<div id="chart_cloud"><img src="http://npmci.syncfusion.com/production/react/demos/src/chart/images/sunny.png"   style={{width: "41px"; height: "41px"}}/></div>' x='Tue' y={33} coordinateUnits='Point' verticalAlignment='Top'>
                            </AnnotationDirective>
                        </AnnotationsDirective>
...
ReactDOM.render(<Spline />, document.getElementById('sample'));