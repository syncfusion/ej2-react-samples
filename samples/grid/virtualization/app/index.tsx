...
.image {
        ...
        background-image: url('http://npmci.syncfusion.com/production/react/demos/src/grid/images/spinner.gif');
...
ReactDOM.render(<Virtualization />, document.getElementById('sample'));