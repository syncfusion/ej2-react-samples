      ...
      <div className='control-pane'>
        ...
        <div id="description">
          <p>
            ...
            <a href="http://ej2.syncfusion.com/react/documentation/numerictextbox/api-numericTextBoxComponent.html#min-number" target="_blank">min</a>,
            <a href="http://ej2.syncfusion.com/react/documentation/numerictextbox/api-numericTextBoxComponent.html#max-number" target="_blank">max</a>, and
            <a href="http://ej2.syncfusion.com/react/documentation/numerictextbox/api-numericTextBoxComponent.html#strictmode-boolean" target="_blank">strictMode</a> properties.
          </p>
          <ul>
            <li>
          ...
          <p>
            ...
            <a href="http://ej2.syncfusion.com/react/documentation/numerictextbox/getting-started.html#range-validation" target="_blank"> documentation section</a>.
          </p>
        </div>
      </div >
    )
