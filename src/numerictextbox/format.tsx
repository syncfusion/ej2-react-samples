  ...
  render() {
    return (
      <div className='control-pane'>
        ...
        <div id="description">
          <p>
            The NumericTextBox provides an option to customize the display format of the numeric value using the <a href="http://ej2.syncfusion.com/react/documentation/numerictextbox/api-numericTextBoxComponent.html#format-string" target="_blank">format</a> property.
          ...
          <p>
            More information on the format configuration can be found in the <a href="http://ej2.syncfusion.com/react/documentation/numerictextbox/getting-started.html#formatting-the-value" target="_blank">documentation section</a>.
          </p>
        </div>
      </div >
    )
