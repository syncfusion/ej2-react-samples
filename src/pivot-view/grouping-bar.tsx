        ...
        return (
            <div className='control-pane'>
                <div className='col-lg-9 control-section' id='pivot-grid-section' style={{ overflow: 'initial' }}>
                    <PivotViewComponent id='PivotView' ref={(scope) => { this.pivotGridObj = scope; }} dataSourceSettings={dataSourceSettings} width={'100%'} height={'300'} showGroupingBar={true} showFieldList={true} gridSettings={{columnWidth: 140}}>
