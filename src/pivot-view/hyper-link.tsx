            ...
            <div className='control-pane'>
                <div className='control-section' style={{ overflow: 'auto' }}>
                    <div className='col-lg-8 adaptive'>
                        <PivotViewComponent id='PivotView' ref={(pivotview) => { pivotGridObj = pivotview }} showTooltip={false} dataSourceSettings={dataSourceSettings}
                ...
                <div id="action-description">
                    <p>This sample demonstrates showing the hyperlink options for pivot grid cells.</p>
                </div>
                <div id="description">
                    <p>
