...
export class Grouping extends SampleBase<{}, {}> {
    ...
    onClick(): void {
        ...
        this.pivotGridObj.dataSourceSettings.groupSettings = groupSettings;
    };
        ...
        return (
            <div className='control-pane'>
                <div className='col-lg-8 control-section' id='pivot-grid-section' style={{ overflow: 'initial' }}>
                    <PivotViewComponent id='PivotView' ref={(scope) => { this.pivotGridObj = scope; }} load={this.onLoad} dataSourceSettings={dataSourceSettings} width={'100%'} height={'300'} showGroupingBar={true} gridSettings={{ columnWidth: 140, columnRender: this.beforeColumnsRender }}>
