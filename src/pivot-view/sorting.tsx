...
export class Sorting extends SampleBase<{}, {}> {
    ...
    onClick(): void {
        if (this.checkBoxObj.checked) {
            this.pivotGridObj.dataSourceSettings.enableSorting = true;
            this.pivotGridObj.dataSourceSettings.sortSettings = [
            ...
            this.pivotGridObj.dataSourceSettings.enableSorting = false;
            this.pivotGridObj.dataSourceSettings.sortSettings = [];
        }
    }
            ...
            <div className='control-pane'>
                <div className='control-section' style={{ overflow: 'auto' }}>
                    <div className='col-lg-8 adaptive'>
                        <PivotViewComponent id='PivotView' ref={(pivotview) => { this.pivotGridObj = pivotview }} dataSourceSettings={dataSourceSettings} width={'100%'} height={'300'} gridSettings={{ columnWidth: 140 }}>
                        </PivotViewComponent>
                    </div>
