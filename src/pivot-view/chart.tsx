        ...
        return (
            <div className='control-pane'>
                <div className='col-lg-9 control-section' style={{ overflow: 'auto' }}>
                    <PivotViewComponent id='PivotView' ref={d => this.pivotGridObj = d} dataSource={dataSource} width={'100%'} height={'300'} showFieldList={true} displayOption={{ view: 'Chart' }} chartSettings={{ title: 'Sales Analysis', chartSeries: { type: "Column" }, load: this.chartOnLoad.bind(this) }}>
