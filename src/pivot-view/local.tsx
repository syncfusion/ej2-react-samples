        ...
        return (
            <div className='control-pane'>
                ...
                <div className='control-section' style={{ overflow: 'auto' }}>
                    <PivotViewComponent id='PivotView' ref={(pivotview) => { pivotGridObj = pivotview }} load={this.onLoad} dataSourceSettings={dataSourceSettings} width={'100%'} height={'300'} gridSettings={{columnWidth: 120}}>
                    </PivotViewComponent>
                </div>
