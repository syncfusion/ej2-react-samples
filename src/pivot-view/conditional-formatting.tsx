...
export class ConditionalFormattingClass extends SampleBase<{}, {}> {
    ...
    resetFormat(): void {
        if (this.pivotGridObj.dataSourceSettings.conditionalFormatSettings.length > 0) {
            this.pivotGridObj.setProperties({ dataSourceSettings: { conditionalFormatSettings: [] } }, true);
            ...
            <div className='control-pane'>
                ...
                <div className='control-section'>
                    <div className='col-lg-9 adaptive'>
                        <PivotViewComponent id='PivotView' ref={(pivotview) => { this.pivotGridObj = pivotview }} dataSourceSettings={dataSourceSettings} showFieldList={true} width={'100%'} height={'300'} allowConditionalFormatting={true} gridSettings={{ columnWidth: 100 }}>
