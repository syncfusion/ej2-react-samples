                                                ...
                                                <RibbonCollectionsDirective>
                                                    <RibbonCollectionDirective>
                                                        <RibbonItemsDirective>
                                                            ...
                                                            <RibbonItemDirective type="ComboBox" comboBoxSettings={{ dataSource: this.fontSize, index: 3, width: '80px', select: function (args) { this.updateContent("Font Size -> " + args.itemData.text); } }}>
                                                            </RibbonItemDirective>
                                                        </RibbonItemsDirective>
                                                    </RibbonCollectionDirective>
                                                    <RibbonCollectionDirective>
                                                        <RibbonItemsDirective>
                                                            <RibbonItemDirective type="ColorPicker" allowedSizes={RibbonItemSize.Small} displayOptions={DisplayMode.Simplified} colorPickerSettings={{value: '#123456', change: function (args) { this.updateContent(args.currentValue.hex + " color"); }}}>
                                                            </RibbonItemDirective>
                            ...
                            <div id="ribbonPlaceHolder">
                                <div style={{ width: '100%', height: '40px' }}>
                                    ...
                                    <div id='ribbonSlider' style={{ width: '200px', margin: '0 15px' }}>
                                        <SliderComponent id='slider' ref={this.sliderRef} min={350} change={this.onChange.bind(this)} created={this.onCreated.bind(this)} />
                                    </div>
                                </div>
