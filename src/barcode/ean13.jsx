...
export class Ean13 extends SampleBase {
    rendereComplete() {
    ...
    render() {
        ...
        }} height={"150px"} mode='SVG' type='Ean13' value='9735940564824'></BarcodeGeneratorComponent>
              </div>
            </div>
            <div className='allowedText'>
              <span style={{ fontWeight: 600 }}> Allowed Input characters :</span> This barocode supports 13 numbers as input.
        </div>
          </div>
        </div>
