...
var UpcE = /** @class */ (function (_super) {
    ...
    UpcE.prototype.rendereComplete = function () {
    ...
    UpcE.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "control-pane" },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample visualizes a product package identification number consist of 6 digits. A UPC-E barcode is mainly used for scanning products in small packages.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null, "This sample shows how to create the UPC-E barcode. The `type` property can be used to set the barcode type as `UpcE`. By default, `enableCheckSum` is set as true, but the checksum can be disabled by assigning false to it."),
