...
var DataMatrix = (function (_super) {
                ...
                React.createElement("div", { className: "content-wrapper", style: { width: "100%", height: "590px" } },
                    React.createElement("div", { className: 'center' },
                        React.createElement("div", { className: 'centercontrol' },
                            React.createElement(ej2_react_barcode_generator_1.DataMatrixGeneratorComponent, { id: "barcode", ref: function (barcode) { return (barcodeInstance = barcode); }, width: "200px", displayText: { visibility: false }, invalid: function (arg) {
                                    canShowError = true;
                                    _this.formObject.validate();
                                }, height: "150px", mode: 'SVG', type: 'DataMatrix', value: 'WWW.Syncfusion.com' }))))),
            React.createElement("div", { className: "col-lg-4 property-section", style: { width: "36%", paddingRight: "0px", paddingLeft: "18px" } },
                ...
                React.createElement("div", { className: "row sb-child-row" },
                    React.createElement("div", { className: "col-xs-2 top", style: { paddingLeft: '0px' } }, "DataMatrix Size"),
                    React.createElement("div", { className: "col-xs-3", style: { width: '33%', paddingLeft: '0px' } },
                ...
                React.createElement("div", { className: "row sb-child-row" },
                    React.createElement("div", { className: "col-xs-2 top", style: { paddingLeft: '0px' } }, "DataMatrix Encoding"),
                    React.createElement("div", { className: "col-xs-3", style: { width: '33%', paddingLeft: '0px' } },
                        React.createElement("div", { style: { paddingBottom: '8px' } },
