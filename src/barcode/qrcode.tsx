    ...
    return (
      <div className="control-pane">
        ...
        <div className="col-lg-4 property-section" style={{ paddingRight: "0px", minWidth:"36%" }} >
              ...
              <div className="col-xs-6 left">
                <div className="col-xs-12 left">
                  <CheckBoxComponent
                    ...
                    change={logo}
                  />
                  <div style={{display:"inline-block", verticalAlign:"middle", paddingLeft:"4px"}}>Show Logo</div>
                </div>
              </div>
            </div>
              ...
              <div className="col-xs-6 left">
                <div className="col-xs-12 left">
                  <CheckBoxComponent
                    ...
                    change={modeChange}
                  />
                  <div style={{display:"inline-block", verticalAlign:"middle", paddingLeft:"4px"}}>SVG</div>
                </div>
              </div>
            </div>
          ...
          <div className="row sb-child-row">
            <div className="col-xs-5 top left">Version</div>
          ...
          <div className="row sb-child-row">
            <div className="col-xs-5 top left">Error Correction Level</div>
            <div className="col-xs-7 left">
                <div className="padding-bottom: 8px">
                <DropDownListComponent
                id="position"
          ...
          <div className="row sb-child-row">
                <div className="col-xs-6 top barcode-panel-left">
                    ...
                    onClick={()=>{
                      barcodeInstance.exportImage("SyncfusionQR", "PNG");
                    }}
...
function logo(args: CheckBoxChangeEventArgs) {
  if (barcodeInstance.logo) {
    barcodeInstance.logo.imageSource = args.checked ? logoImage : '';
  }
}
