...
var Code128B = (function (_super) {
    ...
    Code128B.prototype.rendereComplete = function () {
    ...
    Code128B.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "control-pane" },
                    ...
                    React.createElement("div", { className: 'center' },
                        React.createElement("div", { className: 'centercontrol' },
                            React.createElement(ej2_react_barcode_generator_1.BarcodeGeneratorComponent, { id: "barcode", ref: function (barcode) { return (barcodeInstance = barcode); }, width: "200px", invalid: function (arg) {
                                ...
                                }, height: "150px", mode: 'SVG', type: 'Code128B', value: 'SYNCFUSION' }))),
            ...
            React.createElement("div", { id: "description" },
                React.createElement("p", null, "This sample shows how to create the Code 128B barcode type with alphanumeric characters. The `type` property can be used to set the barcode type as `Code128B`."),
