...
export class Code39Extd extends SampleBase {
    ...
    render() {
        ...
        }} height={"150px"} mode='SVG' type='Code39Extension' value='SYNCFUSION'></BarcodeGeneratorComponent>
              </div>
            </div>
            <div className='allowedText'>
              <span style={{ fontWeight: 600 }}> Allowed Input characters :</span>  This barcode support only ASCII characters.
            </div>
          </div>
        </div>
