...
export class Code39 extends SampleBase {
    rendereComplete() {
    ...
    render() {
        ...
        }} height={"150px"} mode='SVG' type='Code39' value='SYNCFUSION'></BarcodeGeneratorComponent>
              </div>
            </div>
            <div className='allowedText'>
              <span style={{ fontWeight: 600 }}> Allowed Input characters :</span> A-Z, 0-9
            </div>
          </div>  
        </div>
