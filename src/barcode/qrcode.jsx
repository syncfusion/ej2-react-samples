    ...
    render() {
        ...
        <div className="content-wrapper" style={{ width: "100%", height: "590px" }}>
            <div className='center'>
              <div className='centercontrol'>
                <QRCodeGeneratorComponent id="barcode" ref={barcode => (barcodeInstance = barcode)} width={"200px"} displayText={{ visibility: false }} invalid={(arg) => {
            canShowError = true;
        ...
        id="width" enabled={true} format={"###.##"} value={150} step={2} min={100} max={200} change={barcodeheightChange}/>
          ...
          <div className="row sb-child-row">
            ...
            <div className="col-xs-3" style={{ width: '33%', paddingLeft: '0px' }}>
              <div className="padding-bottom: 8px">
                <NumericTextBoxComponent id="version" enabled={true} format={"###.##"} value={1} step={1} min={1} max={40} change={versionChange}/>
          ...
          <div className="row sb-child-row">
            ...
            <div className="col-xs-3" style={{ width: '33%', paddingLeft: '0px' }}>
                <div className="padding-bottom: 8px">
                <DropDownListComponent id="position" popupWidth={150} width={"100%"} value='Medium' index={0} dataSource={errorCorrectionLevel} change={errorCorrectionChange} ref={fontfamily => (alignment = fontfamily)}/>
