...
var Ean13 = (function (_super) {
    ...
    Ean13.prototype.rendereComplete = function () {
    ...
    Ean13.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "control-pane" },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample visualizes the 13-digit Global Trade Identification Numbers. These 13 digits comprise the following components: GS1 company prefix, manufacturer code, product code, and check digit.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null, "This sample shows how to create the EAN-13 barcode. The `type` property can be used to set the barcode type as `Ean13`."),
