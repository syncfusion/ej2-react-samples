...
export class Code32 extends SampleBase {
    rendereComplete() {
    ...
    render() {
        ...
        }} height={"150px"} mode='SVG' type='Code32' value='01234567'></BarcodeGeneratorComponent>
              </div>
            </div>
            <div className='allowedText'>
              <span style={{ fontWeight: 600 }}> Allowed Input characters :</span> This barcode supports 8 numbers as input.
            </div>
          </div>
        </div>
