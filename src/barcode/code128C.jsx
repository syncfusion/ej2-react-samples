...
export class Code128C extends SampleBase {
    rendereComplete() {
    ...
    render() {
        ...
        }} height={"150px"} mode='SVG' type='Code128C' value='01234567'></BarcodeGeneratorComponent>
              </div>
            </div>
            <div className='allowedText'>
              <span style={{ fontWeight: 600 }}> Allowed Input characters :</span>  Support  even number of digits
            </div>
          </div>
        </div>
