...
import { DataMatrixGeneratorComponent, TextPosition, Alignment, DataMatrixEncoding } from "@syncfusion/ej2-react-barcode-generator";
...
let barcodeInstance: DataMatrixGeneratorComponent;
...
function encodingChange(args: ChangeEventArgs){
  barcodeInstance.encoding = ((args.itemData.value.toString()) as DataMatrixEncoding);
}
...
function matrixSizenChange(args:ChangeEventArgs){
