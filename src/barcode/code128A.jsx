...
export class Code128A extends SampleBase {
    rendereComplete() {
    ...
    render() {
        ...
        }} mode='SVG' type='Code128A' value='SYNCFUSION'></BarcodeGeneratorComponent>
              </div>
            </div>
            <div className='allowedText'>
              <span style={{ fontWeight: 600 }}> Allowed Input characters :</span>  support 0-9 A-Z and special character
            </div>
          </div>
        </div>
