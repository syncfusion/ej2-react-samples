...
var Code93 = /** @class */ (function (_super) {
    ...
    Code93.prototype.rendereComplete = function () {
    ...
    Code93.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "control-pane" },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample visualizes how to present a model number with higher density and data security enhancements compared to Code 39. Code 93 has a native character set of 26 uppercase letters, 10 digits, and 7 special characters.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null, "This sample shows how to create the Code 93 barcode with two check characters. The `type` property can be used to set the barcode type as `Code93`. By default, `enableCheckSum` is set as true, but the checksum can be disabled by assigning false to it."),
