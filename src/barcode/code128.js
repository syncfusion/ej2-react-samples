...
var Code128 = (function (_super) {
    __extends(Code128, _super);
    function Code128() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Code128.prototype.rendereComplete = function () {
    ...
    Code128.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "control-pane" },
                    ...
                    React.createElement("div", { className: 'center' },
                        React.createElement("div", { className: 'centercontrol' },
                            React.createElement(ej2_react_barcode_generator_1.BarcodeGeneratorComponent, { id: "barcode", ref: function (barcode) { return (barcodeInstance = barcode); }, width: "200px", invalid: function (arg) {
                                ...
                                }, height: "150px", mode: 'SVG', type: 'Code128', value: 'SYNCFUSION' }))),
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample visualizes a barcode image that presents alphanumeric combinations. Code 128 barcode consists of a start character, data digits, a modulo 103 check digit, and a stop character.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null, "This sample shows how to create the Code 128 barcode type with alphanumeric characters. The `type` property can be used to set the barcode type as `Code128`."),
