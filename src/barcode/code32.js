...
var Code32 = (function (_super) {
    ...
    Code32.prototype.rendereComplete = function () {
    ...
    Code32.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "control-pane" },
            ...
            React.createElement("div", { className: "col-lg-4 property-section", style: { paddingRight: "0px", paddingLeft: "18px" } },
                ...
                React.createElement("div", { className: "row sb-child-row" },
                    React.createElement("div", { className: "col-xs-2" }, "Alignment"),
                    React.createElement("div", { className: "textPropertyClass" },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample visualizes the pharmaceutical code that encodes numeric data in a compressed format. This type of barcode supports all numeric digits and all uppercase letters.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null, "This sample shows how to create the Code 32 barcode with five bars and four spaces for encoding each character. The `type` property can be used to set the barcode type as `Code32`."),
