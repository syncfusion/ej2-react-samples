...
var Code39Extd = /** @class */ (function (_super) {
    __extends(Code39Extd, _super);
    function Code39Extd() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Code39Extd.prototype.rendereComplete = function () {
    ...
    Code39Extd.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "control-pane" },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample visualizes the model number of an item in the automotive industry. This barcode supports both standard and extended Code 39 barcodes. The extended mode gives access to the full set of ASCII letters.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null, "This sample shows how to create the extended Code 39 barcode with an added checksum. The `type` property can be used to set the barcode type as `Code39Extension`. By default, `enableCheckSum` is set as true, but the checksum can be disabled by assigning false to it."),
                React.createElement("br", null))));
    };
    return Code39Extd;
}(sample_base_1.SampleBase));
exports.Code39Extd = Code39Extd;
