...
export class UpcE extends SampleBase {
    rendereComplete() {
    ...
    render() {
        ...
        }} height={"150px"} mode='SVG' type='UpcE' value='123456'></BarcodeGeneratorComponent>
              </div>
            </div>
            <div className='allowedText'>
              <span style={{ fontWeight: 600 }}> Allowed Input characters :</span> This barcode supports 6 numbers as input
        </div>
          </div>
        </div>
