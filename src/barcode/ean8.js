...
var Ean8 = (function (_super) {
    ...
    Ean8.prototype.rendereComplete = function () {
    ...
    Ean8.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "control-pane" },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample visualizes the 8-digit Global Trade Identification Numbers. It was introduced for use on small packages where an EAN-8 barcode would be too large.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null, "This sample shows how to create the EAN-8 barcode. The `type` property can be used to set the barcode type as `Ean8`"),
