...
export class Api extends SampleBase<{}, chipSample> {
    data = data as any;
    colorCss = '';
    outlineCss = '';
            ...
            <div>
                <div className="col-lg-8 control-section">
                    <div id="chip-api-wrapper">
                        ...
                        <ChipListComponent id="chip" text="Janet Leverling" cssClass={this.state.cssClass}
                            avatarIconCss={this.state.avatarIconCss} trailingIconCss={this.state.trailingIconCss}
                            avatarText={this.state.avatarText} leadingIconCss={this.state.leadingIconCss}>
                        </ChipListComponent>
                    </div>
                </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style={{ width: "50%", "paddingRight": "10px" }}>
                                        < div >
                                            ...
                                            <DropDownListComponent id="chip-color" dataSource={this.data.ddlData} placeholder="Select a color"
                                                change={this.colorChange.bind(this)}></DropDownListComponent>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style={{ width: "50%", paddingRight: "10px" }}>
                                        <div>
                                            {/* initialize dropdownlist component */}
                                            <DropDownListComponent id="chip-avatar" dataSource={this.data.avatarData} placeholder="Select an avatar"
                                                change={this.avatarHandler.bind(this)}></DropDownListComponent>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
