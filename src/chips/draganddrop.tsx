        ...
        return (
            <div>
                ...
                <div id="action-description">
                    <p>This React Chips sample demonstrates the drag and drop functionality of Chips component. To drag and drop a chip element, select and drag the desired chip and drop it at the target index within the required container.</p>
                </div>
                <div id="description">
