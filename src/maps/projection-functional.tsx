...
function ProjectionMaps() {
    ...
    function change(): void {
        mapInstance.projectionType = dropElement.value as ProjectionType;
        mapInstance.refresh();
    }
                            ...
                            <tr style={{ height: '50px' }}>
                                ...
                                <td style={{ width: '40%' }}>
                                    <div style={{ marginRight: '0px' }}>
                                        <DropDownListComponent width="100%" index={0} change={change.bind(this)} ref={d => dropElement = d} dataSource={droplist} fields={{ text: 'value', value: 'value' }} placeholder='Select projection type' />
                                    </div>
                                </td>
                            </tr>
                        </table>
