...
import { MapsComponent, Inject, LayersDirective, LayerDirective, MapsTooltip, Legend, Marker } from '@syncfusion/ej2-react-maps';
        ...
        return (<div className='control-pane'>
            ...
            textStyle: {
                size: '16px'
                            ...
                            <LayersDirective>
                                <LayerDirective shapeData={new MapAjax('./src/maps/map-data/india.json')} shapePropertyPath='NAME_1' shapeDataPath='Name' dataSource={datasource.heatmap} tooltipSettings={{
            visible: true,
