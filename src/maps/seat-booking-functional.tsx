...
function SeatBookingMaps() {
    ...
    function shapeSelected(args: ISelectionEventArgs): void {
            ...
            <div className='control-section row'>
                <div className='col-md-8'>
                    ...
                    <div style={{ border: '3px solid darkgray', width: 200, display: 'block', margin: 'auto' }}>
                        ...
                        <MapsComponent id="maps" load={load} ref={m => mapInstance = m}
                            ...
                            height="400"
                            itemSelection={shapeSelected.bind(this)}
                        >
                ...
                <div className='col-md-4 property-section'>
                    <PropertyPane title='Seat Selection'>
                        ...
                        <br></br>
                        <div id="seat-parent">
                            <span id='clear-btn' onClick={clearseats.bind(this)}>Clear Selection</span><br /><br />
