        ...
        return (<div className='control-pane'>
            ...
            textStyle: {
                size: '16px'
                            ...
                            <LayersDirective>
                                <LayerDirective shapeData={new MapAjax('./src/maps/map-data/usa.json')} shapeSettings={{
            fill: '#E5E5E5',
            border: {
                color: 'black',
                width: 0.1
            ...
            smartLabelMode: 'Hide'
                                ...
                                <LayerDirective shapeData={datasource} type='SubLayer' shapeSettings={{
            ...
            { latitude: 37.09023980307208,
                longitude: -119.35546875000001
                                ...
                                <LayerDirective shapeData={datasource1} type='SubLayer' shapeSettings={{
