...
let markers1: object[] = [
    {
        longitude: -96.9412994,
        latitude: 36.0446575,
        name: 'Mehan',
    },
    {
        longitude: -99.0925598,
        latitude: 35.0299964,
        name: 'Hobart',
    },
    {
        longitude: -98.4924316,
        latitude: 33.9137338,
        name: 'Wichita Falls',
    },
    {
        longitude: -98.9675903,
        latitude: 35.5154609,
        name: 'Clinton',
    },
    {
    ...
    {
        longitude: -99.2985535,
        latitude: 36.1500735,
        name: 'Vici',
    },
    {
        longitude: -95.3173828,
        latitude: 36.3084855,
        name: 'Pryor',
    },
    {
        longitude: -96.7524719,
        latitude: 34.9596836,
        name: 'Konawa',
    },
    {
        longitude: -101.9450281,
        latitude: 35.2018863,
        name: 'Amarillo',
    },
    {
        longitude: -98.0971969,
        latitude: 35.5514624,
        name: 'El Reno',
    },
    {
        longitude: -97.8432238,
        latitude: 35.5150073,
        name: 'Yukon',
    },
    {
        longitude: -97.2557752,
        latitude: 35.4933852,
        name: 'Harrah',
    },
    {
        longitude: -97.1019391,
        latitude: 35.3620257,
        name: 'Shawnee',
    },
    {
    ...
    {
        longitude: -96.2093353,
        latitude: 36.133417,
        name: 'Lotsee',
    },
    {
        longitude: -96.3077788,
        latitude: 36.1879088,
        name: 'Sand Springs',
    },
    {
        longitude: -98.7075369,
        latitude: 35.931371,
        name: 'Oakwood',
    },
    {
        longitude: -98.0003367,
        latitude: 35.0403272,
        name: 'Chickasha',
    },
    {
        longitude: -97.1836494,
        latitude: 36.4595554,
        name: 'Red Rock',
    },
    {
        longitude: -96.7148021,
        latitude: 35.4859752,
        name: 'Prague',
    },
    {
        longitude: -97.9339651,
        latitude: 36.1022835,
        name: 'Hennessey',
    },
    {
        longitude: -96.2595621,
        latitude: 35.2453183,
        name: 'Wetumka',
    },
    {
        longitude: -97.4499583,
        latitude: 35.0304344,
        name: 'Purcell',
    },
    {
        longitude: -96.1059044,
        latitude: 35.605942,
        name: 'Okmulgee',
    },
    {
        longitude: -97.9684792,
        latitude: 35.8439429,
        name: 'Kingfisher',
    },
    {
        longitude: -95.7691956,
        latitude: 34.9332303,
        name: 'McAlester',
    },
    {
        longitude: -96.1289978,
        latitude: 34.3853794,
        name: 'Atoka',
    },
    {
        longitude: -97.1191406,
        latitude: 34.5042932,
        name: 'Davis',
    },
    {
    ...
    return (
        <main><div className='control-panel'>
                        ...
                        <LayersDirective>
                            <LayerDirective shapeData={okalahomaMap} shapeSettings={{ fill: '#F5F5F5', border: { color: '#EEDA97', width: 1 } }}>
                                <MarkersDirective>
                                    ...
                                    <MarkerDirective visible={true} template='<div style="color: black;">{{:name}}</div>' dataSource={markers1} />
                                </MarkersDirective>
                            </LayerDirective>
                        </LayersDirective>
                    </MapsComponent>
            ...
            <div style={{ float: 'right', marginRight: '10px' }}>
                Source:<a href="https://www.google.co.in/maps/search/atm+in+oklahoma/@35.3864432,-98.2888719,8z/data=!3m1!4b1" target="_blank">www.google.co.in/maps</a>
            </div>
        </div>
