export const MapSampleOrder: Object = [
    {
        'path': 'maps/default', 'component': 'DefaultMaps', 'name': 'Default Functionalities', 'sourceFiles': [
            ...
            { 'displayName': 'default.jsx', 'path': './src/maps/default.jsx' },
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control visualizes the continents in the world by rendering those in a map layer.', 'order': '01', 'category': 'Maps'
    },
    {
        'path': 'maps/projection', 'component': 'ProjectionMaps', 'name': 'Projection', 'sourceFiles': [
            ...
            { 'displayName': 'projection.jsx', 'path': './src/maps/projection.jsx' },
            { 'displayName': 'world-map.json', 'path': './src/maps/map-data/world-map.json' },
            { 'displayName': 'projection-datasource.json', 'path': './src/maps/map-data/projection-datasource.json' }
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control shows the details of permanent and non-permanent countries in the UN Security Council, in 2017.', 'order': '02', 'category': 'Features'
    },
    {
        'path': 'maps/multilayer', 'component': 'MultilayerMaps', 'name': 'Multi-layers', 'sourceFiles': [
            ...
            { 'displayName': 'multilayer.jsx', 'path': './src/maps/multilayer.jsx' },
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control depicts the layer along with sublayers for California and Texas.', 'order': '02', 'category': 'Features'
    },
    {
        'path': 'maps/marker', 'component': 'MarkerMaps', 'name': 'Marker', 'sourceFiles': [
            { 'displayName': 'marker.tsx', 'path': './src/maps/marker.tsx' },
            { 'displayName': 'marker.jsx', 'path': './src/maps/marker.jsx' },
            { 'displayName': 'world-map.json', 'path': './src/maps/map-data/world-map.json' },
            { 'displayName': 'top-population.json', 'path': './src/maps/map-data/top-population.json' }
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control shows the top 25 populated cities in the world by displaying the markers in their locations.', 'order': '02', 'category': 'Features'
    },
    {
        'path': 'maps/marker-template', 'component': 'MarkerTemplateMaps', 'name': 'Marker template', 'sourceFiles': [
            ...
            { 'displayName': 'marker-template.jsx', 'path': './src/maps/marker-template.jsx' },
            { 'displayName': 'australia.json', 'path': './src/maps/map-data/australia.json' }
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control indicates the temperature of various cities of Australia in marker templates.', 'order': '02', 'category': 'Features'
    },
    {
        'path': 'maps/marker-cluster', 'component': 'MarkerCluster', 'name': 'Marker Clustering', 'sourceFiles': [
            ...
            { 'displayName': 'marker-cluster.jsx', 'path': './src/maps/marker-cluster.jsx' },
            { 'displayName': 'world-map.json', 'path': './src/maps/map-data/world-map.json' },
            { 'displayName': 'marker-cluster.json', 'path': './src/maps/map-data/marker-cluster.json' }
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control indicates the create the marker cluster in more than one marker intersect.', 'order': '02', 'category': 'Features'
    },
    {
        'path': 'maps/label', 'component': 'LabelMaps', 'name': 'Labels', 'sourceFiles': [
            { 'displayName': 'label.tsx', 'path': './src/maps/default.tsx' },
            { 'displayName': 'label.jsx', 'path': './src/maps/default.jsx' },
            { 'displayName': 'usa.json', 'path': './src/maps/map-data/usa.json' }
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control shows the names of all the states in USA in data label. Intersect action and smart labels mode can be changed.', 'order': '02', 'category': 'Features'
    },
    {
        'path': 'maps/bubble', 'component': 'BubbleMaps', 'name': 'Bubble', 'sourceFiles': [
            { 'displayName': 'bubble.tsx', 'path': './src/maps/bubble.tsx' },
            { 'displayName': 'bubble.jsx', 'path': './src/maps/bubble.jsx' },
            { 'displayName': 'world-map.json', 'path': './src/maps/map-data/world-map.json' },
            { 'displayName': 'bubble-datasource.json', 'path': './src/maps/map-data/bubble-datasource.json' }
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control illustrates the top 30 countries which has highest Internet users in bubbles of the year 2016.', 'order': '02', 'category': 'Features'
    },
    {
        'path': 'maps/navigation-line', 'component': 'NavigationLineMaps', 'name': 'Navigation Lines', 'sourceFiles': [
            ...
            { 'displayName': 'navigation-line.jsx', 'path': './src/maps/navigation-line.jsx' },
            ...
            { 'displayName': 'world-map.json', 'path': './src/maps/map-data/world-map.json' }
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control illustrates the sea routes between various cities for shipping.', 'order': '02', 'category': 'Features'
    },
    {
        'path': 'maps/legend', 'component': 'LegendMaps', 'name': 'Legend', 'sourceFiles': [
            { 'displayName': 'legend.tsx', 'path': './src/maps/legend.tsx' },
            { 'displayName': 'legend.jsx', 'path': './src/maps/legend.jsx' },
            { 'displayName': 'world-map.json', 'path': './src/maps/map-data/world-map.json' },
            { 'displayName': 'legend-datasource.json', 'path': './src/maps/map-data/legend-datasource.json' }
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control visualizes grouping of countries in the legend based on its population density.', 'order': '02', 'category': 'Features'
    },
    {
        'path': 'maps/color-mapping', 'component': 'ColorMap', 'name': 'Color Mapping', 'sourceFiles': [
            ...
            { 'displayName': 'color-mapping.jsx', 'path': './src/maps/color-mapping.jsx' },
            { 'displayName': 'usa.json', 'path': './src/maps/map-data/usa.json' },
            { 'displayName': 'color-mapping.json', 'path': './src/maps/map-data/color-mapping.json' }
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control illustrates the average amount of rainfall and snowfall in spring season of all the states in US.', 'order': '02', 'category': 'Features'
    },
    {
        'path': 'maps/annotation', 'component': 'AnnotationMaps', 'name': 'Annotations', 'sourceFiles': [
            ...
            { 'displayName': 'annotation.jsx', 'path': './src/maps/annotation.jsx' },
            { 'displayName': 'africa-continent.json', 'path': './src/maps/map-data/africa-continent.json' }
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control depicts the facts about Africa continent and a direction compass in an annotation.', 'order': '02', 'category': 'Features'
    },
    {
        'path': 'maps/polygon', 'component': 'Polygon', 'name': 'Polygon', 'sourceFiles': [   
            { 'displayName': 'polygon.tsx', 'path': './src/maps/polygon.tsx' },
            { 'displayName': 'polygon.jsx', 'path': './src/maps/polygon.jsx' }
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control depicts the polygon shape rendering over the OpenStreetMap.', 'order': '03', 'category': 'Polygon'
    },
    {
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control illustrates the location of United Nations Headquarters in the OpenStreetMap with marker.',
    ...
    },
    {
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control illustrates the Africa continent location in the World map.', 'order': '04', 'category': 'Map Providers'
    },
    {
        'path': 'maps/osm-with-marker-clustering', 'component': 'OSMMarkerCluster', 'name': 'OSM with Marker Clustering', 'sourceFiles': [
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control illustrates the popular attractions from various countries, represented as markers and grouped using clustering.', 'order': '04', 'category': 'Map Providers'
    },
    {
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control illustrates the flight route from Los Angeles to Mexico City using Navigation lines.', 'order': '04', 'category': 'Map Providers'
    },
    {
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control depicts the displaying the OpenStreetMap with legend for markers.', 'order': '04', 'category': 'Map Providers'
    },
    {
        'path': 'maps/tooltip', 'component': 'TooltipMaps', 'name': 'Tooltip', 'sourceFiles': [
            ...
            { 'displayName': 'world-map.json', 'path': './src/maps/map-data/world-map.json' }
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control depicts the countries that were appeared in the finals of Cricket World Cup and their counts.', 'order': '05', 'category': 'User Interaction'
    },
    {
        'path': 'maps/selection', 'component': 'SelectionMaps', 'name': 'Selection & Highlight', 'sourceFiles': [
            ...
            { 'displayName': 'usa.json', 'path': './src/maps/map-data/usa.json' }
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control visualizes USA president election results in the year 2016. Default and interactive are the two types of legend.', 'order': '05', 'category': 'User Interaction'
    },
    {
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control depicts the properties required to zoom and pan the rendered map.', 'order': '05', 'category': 'User Interaction'
    },
    {
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control demonstrates capitals of south american counntries usign markers.', 'order': '05', 'category': 'User Interaction'
    },
    {
        'path': 'maps/drilldown', 'component': 'DrilldownMaps', 'name': 'Drill down', 'sourceFiles': [
            ...
            { 'displayName': 'drilldown.jsx', 'path': './src/maps/drilldown.jsx' },
            { 'displayName': 'default-datasource.json', 'path': './src/maps/map-data/default-datasource.json' },
            { 'displayName': 'world-map.json', 'path': './src/maps/map-data/world-map.json' },
            { 'displayName': 'africa.json', 'path': './src/maps/map-data/africa.json' },
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control demonstrates drill down with all the continents in the initial view and countries on drill.', 'order': '05', 'category': 'User Interaction'
    },
    {
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control illustrates the printing functionality in the maps control.', 'order': '06', 'category': 'Print and Export'
    },
    {
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control illustrates the exporting functionality in the maps control.', 'order': '06', 'category': 'Print and Export'
    },
    {
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control visualizes the state wise population of India in the year 2011. Color for states will be applied based on its value.', 'order': '07', 'category': 'Use Cases'
    },
    {
        'path': 'maps/curved', 'component': 'CurvedMaps', 'name': 'Flight routes', 'sourceFiles': [
            { 'displayName': 'curved.tsx', 'path': './src/maps/curved.tsx' },
            { 'displayName': 'curved.jsx', 'path': './src/maps/curved.jsx' },
            { 'displayName': 'world-map.json', 'path': './src/maps/map-data/world-map.json' },
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control demonstrates the flight routes from India to China using navigation lines feature.', 'order': '07', 'category': 'Use Cases'
    },
    {
        'path': 'maps/earthquake', 'component': 'EarthquakeMaps', 'name': 'Earthquake indication', 'sourceFiles': [
            ...
            { 'displayName': 'asia.json', 'path': './src/maps/map-data/asia.json ' }
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control demonstrates the earth quack occurred in Sumatra, Indonesia in the year 2009.', 'order': '07', 'category': 'Use Cases'
    },
    {
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control depicts the ATM populated areas in Oklahoma by highlighting the regions.', 'order': '07', 'category': 'Use Cases'
    },
    {
        'path': 'maps/cyber-attack-map', 'component': 'CyberAttackMaps', 'name': 'Cyber Attack Map', 'sourceFiles': [
            ...
            { 'displayName': 'world-map.json', 'path': './src/maps/map-data/world-map.json' }
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control depicts to display the cyber attacks and threats from various countries to USA.', 'order': '07', 'category': 'Use Cases'
    },
    {
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control visualizes the dynamically added the marker and navigation line.', 'order': '07', 'category': 'Use Cases'
    },
    {
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control visualizes the placing of pie charts on the maps using marker templates.', 'order': '07', 'category': 'Use Cases'
    },
    {
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control demonstrates the average annual population growth of the countries in the North America continent.', 'order': '07', 'category': 'Use Cases'
    },
    {
    ...
    },
    {
        ...
        ], 'description': 'This demo for Essential<sup>®</sup> JS2 Maps control demonstrates the rendering of normal geometry type shapes on the map.', 'order': '07', 'category': 'Use Cases'
    }
];
