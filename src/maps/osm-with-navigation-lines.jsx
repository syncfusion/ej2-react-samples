...
import { MapsComponent, Inject, LayersDirective, LayerDirective, AnnotationDirective, MarkersDirective, MarkerDirective, MapsTooltip, NavigationLine, Bubble, Zoom, Marker, NavigationLineDirective, NavigationLinesDirective, AnnotationsDirective } from '@syncfusion/ej2-react-maps';
    ...
    render() {
        return (<div className='control-pane'>
            ...
            enable: false
                            ...
                            <LayersDirective>
                                <LayerDirective layerType='OSM'>
                                    <MarkersDirective>
                                    <MarkerDirective visible={true} template='<div><img src="src/maps/images/group.svg" style="height:15px;width:15px;"></img></div>' dataSource={[{
                name: 'Mexico City',
                latitude: 23.6445,
                longitude: -102.832
            }]} tooltipSettings={{
            ...
            valuePath: 'name'
                                    ...
                                    <MarkerDirective visible={true} template='<div><img src="src/maps/images/ballon.png" style="height:30px;width:20px;"></img></div>' dataSource={[{
                name: 'Mexico City',
                latitude: 24.2005,
                longitude: -102.832
            }]} tooltipSettings={{
            ...
            valuePath: 'name'
                                    ...
                                    <MarkerDirective visible={true} template='<div style= "font-weight:500; font-size: 13px; text-align: left">Mexico</div>' dataSource={[{
                name: 'Mexico City',
                latitude: 24.0005,
                longitude: -101.200
            }]}>
                                    </MarkerDirective>
                                    <MarkerDirective visible={true} template='<div><img src="src/maps/images/oval.svg" style="height:15px;width:15px;"></img></div>' dataSource={[{
                name: 'Los Angeles',
                latitude: 34.0522,
                longitude: -118.2437
            }]} tooltipSettings={{
            ...
            valuePath: 'name'
                                    ...
                                    <MarkerDirective visible={true} template='<div><div style="text-align: right; font-weight:500; font-size: 13px;">Los Angeles</br>International Airport</div></div>' dataSource={[{
                name: 'Los Angeles City',
                latitude: 34.7000,
                longitude: -121.5000
            }]}>
                                    </MarkerDirective>
                                    <MarkerDirective visible={true} template='<div><img src="src/maps/images/map-tooltip.svg" style="height:50px;width:100px;"></img></div>' dataSource={[{
                latitude: 28.5,
                longitude: -110.400
            }]}>
                                    </MarkerDirective>
