...
import {
    ...
    MapsTooltip, Marker, Zoom, MarkerDirective, MarkersDirective
...
export class OSMMarkerCluster extends SampleBase<{}, {}> {
    render() {
        return (
    ...
    public load(args: ILoadedEventArgs): void {
        ...
        args.maps.theme = ((theme.charAt(0).toUpperCase() +
            theme.slice(1)).replace(/-dark/i, 'Dark').replace(/-high/i, 'High').replace(/contrast/i, 'Contrast').replace(/5.3/i, '5')) as MapsTheme;
        // custom code end
    };
}
