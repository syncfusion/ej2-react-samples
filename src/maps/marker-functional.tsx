...
function MarkerMaps() {
    ...
    function shapeChange(args: ChangeEventArgs) {
        if (args.checked) {
            mapInstance.layers[0].markerSettings[0].shapeValuePath = 'shape';
        } else {
            mapInstance.layers[0].markerSettings[0].shapeValuePath = null;
        }
        mapInstance.refresh();
    }

    function colorChange(args: ChangeEventArgs) {
        if (args.checked) {
            mapInstance.layers[0].markerSettings[0].colorValuePath = 'color';
        } else {
            mapInstance.layers[0].markerSettings[0].colorValuePath = null;
        }
        mapInstance.refresh();
    }
                            ...
                            <tr style={{ }}>
                                ...
                                <td style={{ width: "30%" }} >
                                    <div className="col" style={{ paddingTop: '0px', marginTop: '-10px' }}>
                                        <CheckBoxComponent id="shapeCheckBox" change={shapeChange.bind(this)} />
                                    </div>
                                </td>
                            </tr>
                            <tr style={{ }}>
                                ...
                                <td style={{ width: "30%" }}>
                                    <div className="col" style={{ paddingTop: '0px', marginTop: '-10px' }}>
                                        <CheckBoxComponent id="colorCheckBox" change={colorChange.bind(this)} />
                                    </div>
                                </td>
                            </tr>
                        </table>
