        ...
        return (
            <div className='control-pane'>
                ...
                <div id="action-description">
                    <p>
                        This sample shows the average amount of rainfall and snowfall in spring season of all the states in US. Color mapping is applied to the shapes to differentiate it from other shapes.
                    </p>
                </div>
                <div id="description">
                    <p>
