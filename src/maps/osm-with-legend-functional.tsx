...
import { MapsComponent, Inject, ILoadedEventArgs, MapsTheme, LayersDirective, LayerDirective, MapsTooltip, Marker, Zoom, MarkerDirective, MarkersDirective, Legend } from '@syncfusion/ej2-react-maps';
