        ...
        return (<div className='control-pane'>
                ...
                <div className='control-section row'>
                    <div className='col-md-8'>
                        <MapsComponent id="maps" loaded={this.onMapsLoad.bind(this)} load={this.load} ref={m => this.mapInstance = m} titleSettings={{
            ...
            border: { color: 'black', width: 0.1 }
                                    ...
                                    <MarkersDirective>
                                        <MarkerDirective visible={true} animationDuration={0} shape="Balloon" fill='#E13E40' width={15} height={20} dataSource={[
