        ...
        return (<div className='control-panel'>
            ...
            textStyle: {
                size: '16px'
                        ...
                        <LayersDirective>
                            <LayerDirective shapeData={new MapAjax('./src/maps/map-data/world-map.json')} shapePropertyPath='continent' shapeDataPath='continent' dataSource={datasource.default} shapeSettings={{
            colorValuePath: 'color'
                                ...
                                <MarkersDirective>
                                    ...
                                    <MarkerDirective visible={true} shape='Image' imageUrl='src/maps/images/ballon.png' height={20} width={20} animationDuration={0} tooltipSettings={{
            visible: true,
            valuePath: 'name'
        }} dataSource={[
