            ...
            <div className='control-section row'>
                <div className='col-md-12'>
                    <MapsComponent id="maps" loaded={onMapsLoad} load={load} zoomSettings={{ enable: true, pinchZooming: true }} titleSettings={{ text: 'Samsung Semiconductor office locations in USA', textStyle: { size: '16px' } }}>
                        ...
                        <LayersDirective>
                            <LayerDirective shapeData={usa} shapeSettings={{ fill: '#E5E5E5', border: { color: 'black', width: 0.1 } }} dataLabelSettings={{ visible: true, labelPath: 'iso_3166_2', smartLabelMode: 'Hide', textStyle: { color: 'black' } }} />
                            <LayerDirective shapeData={california} type='SubLayer' shapeSettings={{ fill: 'rgba(141, 206, 255, 0.6)', border: { color: '#1a9cff', width: 0.25 } }}>
                                <MarkersDirective>
                            ...
                            <LayerDirective shapeData={texas} type='SubLayer' shapeSettings={{ fill: 'rgba(141, 206, 255, 0.5)', border: { color: '#1a9cff', width: 0.25 } }}>
                                <MarkersDirective>
