        ...
        return (<div className='control-pane'>
            ...
            textStyle: {
                size: '16px'
                        ...
                        <LayersDirective>
                            <LayerDirective shapeData={new MapAjax('./src/maps/map-data/world-map.json')} shapePropertyPath='name' shapeDataPath='Country' dataSource={datasource.population} shapeSettings={{
            fill: '#C3E6ED'
        }}><MarkersDirective>
