...
import { MapsComponent, Inject, LayersDirective, LayerDirective, Marker, MarkersDirective, MarkerDirective, Zoom, MapsTooltip } from '@syncfusion/ej2-react-maps';
    ...
    render() {
        return (<div className='control-panel'>
            ...
            longitude: -97.3
                            ...
                            <LayersDirective>
                                <LayerDirective shapeData={new MapAjax('./src/maps/map-data/okalahoma.json')} shapeSettings={{
            fill: '#F5F5F5',
            border: { color: '#EEDA97', width: 1 }
        }}>
                               <MarkersDirective>
                               <MarkerDirective visible={true} width={20} height={20} shape='Image' imageUrl='src/maps/images/ballon.png' fill='#000080' border={{ color: 'transparent' }} dataSource={marker2} tooltipSettings={{
            visible: true,
            valuePath: 'title'
        }}>
                               </MarkerDirective>
                               ...
                               <MarkerDirective visible={true} template='<div style="color: black;">{{:name}}</div>' dataSource={markers1}></MarkerDirective>
                           </MarkersDirective>
                                </LayerDirective>
                            </LayersDirective>
                        </MapsComponent>
