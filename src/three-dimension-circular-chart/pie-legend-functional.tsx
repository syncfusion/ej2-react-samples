    ...
    return (<div className='control-pane'>
        ...
        <div className='control-section'>
            <div>
                ...
                }} load={load.bind(this)} title='Browser Market Shares in November 2023' loaded={onChartLoad.bind(this)} rotation={15} tilt={-15} tooltip={{ enable: true, format: '<b>${point.x}</b><br>Browser Share: <b>${point.y}%</b>', header: "" }}>
