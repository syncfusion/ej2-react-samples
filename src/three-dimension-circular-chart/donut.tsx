...
import {
    PieSeries3D, CircularChartDataLabel3D, CircularChartLegend3D, CircularChartTooltip3D, CircularChart3DLoadedEventArgs, CircularChart3DTheme, CircularChart3DComponent, CircularChart3DSeriesCollectionDirective, CircularChart3DSeriesDirective, Inject
...
export class DonutSeries extends SampleBase<{}, {}> {
        ...
        return (
            <div className='control-pane'>
                ...
                <div className='control-section'>
                    <div>
                        <CircularChart3DComponent id='charts' style={{ textAlign: "center" }} legendSettings={{ visible: false }} tilt={-30} enableRotation={true} load={this.load.bind(this)} title='Top Selling Electric Cars in China' loaded={this.onChartLoad.bind(this)} tooltip={{ enable: true, header: "${point.x}", format: 'Sales Count : <b>${point.y}' }}>
    ...
    public load(args: CircularChart3DLoadedEventArgs): void {
        ...
        args.chart.theme = (selectedTheme.charAt(0).toUpperCase() + selectedTheme.slice(1)).
            replace(/-dark/i, "Dark").replace(/contrast/i, 'Contrast') as CircularChart3DTheme;
    };
