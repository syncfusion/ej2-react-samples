                ...
                <div id="api-wrapper" className="control-section apimaincontent">
                    ...
                    <div id="description">
                        ...
                        <ul>
                            ...
                            <li>The Sidebar <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/sidebar#position">position</a> can be changed by clicking on the position button.</li>
                            <li>The Sidebar <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/sidebar#type">types</a> can be changed from the Dropdown List.</li>
                            <li>The Sidebar can be collapsed or closed on <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/sidebar#closeondocumentclick">document click</a> from the provided options.</li>
                            <li>The Sidebar overlay can be enabled or disabled by clicking on the <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/sidebar#showbackdrop">Backdrop button</a>.</li>
                        </ul>
                    </div>
                </div>
            </div>
