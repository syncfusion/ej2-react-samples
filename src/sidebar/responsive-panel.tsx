    ...
    render() {
        ...
        return (
            <div className="control-section" id="responsive-wrapper">                
                ...
                <div id="description">
                    <p>
                        The <code>Sidebar</code> will be shown or hidden based on the resolutions of the screen. It will be shown on larger resolution screens and hidden automatically in lower resolution screens. This can be achieved by the <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/sidebar#mediaquery">mediaquery</a> property.
                    </p>
                    <p>
