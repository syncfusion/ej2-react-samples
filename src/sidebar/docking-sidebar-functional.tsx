    ...
    return(
        <div className="control-section" id="dock-wrapper">
            ...
            <div id="description">
                ...
                <p>
                    In this demo, the list item has an icon with text representation. On dock state, only the icon listed out to interact. It can be achieved by using the <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/sidebar/#enabledock">EnableDock</a> property.
                </p>
            </div>
        </div>
    );
