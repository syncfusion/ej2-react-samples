        ...
        <div className='control-pane'>
            <div className="col-lg-12 control-section">
                <div className="content-wrapper breadcrumb-control-wrapper">
                    ...
                    <div className="row material2">
                        <div className="col-xs-12 col-sm-12 col-lg-12 col-md-12">
                            <BreadcrumbComponent url='https://ej2.syncfusion.com/react/demos/breadcrumb/bind-to-location' beforeItemRender={beforeItemRenderHandler}></BreadcrumbComponent>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id='description'>
                <p>
                    ...
                    In this demonstration, URL navigation is enabled for bind to location sample and <code>beforeItemRender</code> event is used to customize rendering Breadcrumb item.
                </p>
                <p>
                    More information about Breadcrumb component navigations feature can be found in this <a target='_blank' href="https://ej2.syncfusion.com/react/documentation/breadcrumb/data-binding/#items-based-on-current-url">documentation section</a>.
                </p>
            </div>
        </div>
    );
