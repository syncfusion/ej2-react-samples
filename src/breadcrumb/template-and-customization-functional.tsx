...
function TemplateAndCustomization() {
    React.useEffect(() => {
        updateSampleSection();
    }, [])
    ...
    function customTemplate(data: any): JSX.Element {
        return (
    ...
    function customSeparatorTemplate(): JSX.Element {
        return (
            <div className="e-custom-separator"></div>
        );
    }

    function beforeItemRenderHandler(args: BreadcrumbBeforeItemRenderEventArgs) {
