...
function Hyperlink() {
    ...
    const style1: CellStyleModel = { fontWeight: 'bold', textAlign: 'center', backgroundColor: '#279377', color: '#ffffff' };
                    ...
                    <SheetsDirective>
                        <SheetDirective name='Cart' selectedRange='D3'>
                            ...
                            <RowsDirective>
                                ...
                                <RowDirective index={2}>
                                    <CellsDirective>
                                        <CellDirective value='Product ID' style={style1}></CellDirective>
                                    </CellsDirective>
                                </RowDirective>
                                <RowDirective>
                                    <CellsDirective>
                                ...
                                <RowDirective>
                                    <CellsDirective>
                                        ...
                                        <CellDirective formula='=Sum(F4:F12)' format={currencyFormat} style={{ border: '1px solid #A6A6A6', textAlign: 'center', verticalAlign: 'middle', fontWeight: 'bold' }}></CellDirective>
                                    </CellsDirective>
                                </RowDirective>
                            </RowsDirective>
                            <ColumnsDirective>
                        ...
                        <SheetDirective name='Stock' selectedRange='D3'>
                            ...
                            <RowsDirective>
                                <RowDirective>
                                    <CellsDirective>
                                        <CellDirective index={4} value='Place Order' style={style1}></CellDirective>
                                    </CellsDirective>
                                </RowDirective>
                                <RowDirective>
                                    <CellsDirective>
