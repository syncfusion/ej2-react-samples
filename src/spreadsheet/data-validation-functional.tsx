                            ...
                            <RowsDirective>
                                ...
                                <RowDirective index={13}>
                                    <CellsDirective>
                                        ...
                                        <CellDirective index={8} formula='=Sum(I4:I13)' format={currencyFormat} style={{ border: '1px solid #A6A6A6', textAlign: 'center', verticalAlign: 'middle', fontWeight: 'bold' }}></CellDirective>
                                    </CellsDirective>
                                </RowDirective>
                            </RowsDirective>
                            <ColumnsDirective>
