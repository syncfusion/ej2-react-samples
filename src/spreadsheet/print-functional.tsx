...
function Print() {
    ...
    let printType: PrintType = "ActiveSheet";
    function printTypeChange() {
        printType = dropDownListInstance.value as PrintType;
    }

    function enableRowColumnHeader(args: ChangeEventArgs) {
        allowRowColumnHeader = args.checked;
    }

    function enableGridLines(args: ChangeEventArgs) {
                            ...
                            <RowsDirective>
                                <RowDirective height={51}>
                                    <CellsDirective>
                                        ...
                                        <CellDirective colSpan={5} value='          Ivaa Premium Cars' style={{ fontSize: '30pt', fontWeight: 'bold', textAlign: 'left' }} ></CellDirective>
                                    </CellsDirective>
                                </RowDirective>
                                <RowDirective height={45}>
                                    <CellsDirective>
                                        ...
                                        <CellDirective style={cellStyle}></CellDirective>
                                        <CellDirective style={cellStyle}></CellDirective>
                                        <CellDirective wrap={true} style={cellStyle}></CellDirective>
                                        <CellDirective wrap={true} style={cellStyle}></CellDirective>
                                        <CellDirective style={cellStyle}></CellDirective>
                                    </CellsDirective>
                                </RowDirective>
                                ...
                                <RowDirective index={58} height={25}>
                                    <CellsDirective>
                                        ...
                                        <CellDirective formula='=Sum(F3:F56)' format={currencyFormat} style={{ border: '1px solid #A6A6A6', textAlign: 'right', verticalAlign: 'middle', fontWeight: 'bold' }}></CellDirective>
                                    </CellsDirective>
                                </RowDirective>
                            </RowsDirective>
                            <ColumnsDirective>
                            ...
                            <tr style={{ height: "60px" }}>
                                ...
                                <td>
                                    <div style={{ marginLeft: '0px' }}>
                                        <DropDownListComponent id="printingOption" width="100%" index={0} change={printTypeChange.bind(this)} ref={d => dropDownListInstance = d} dataSource={printTypeDataSource} fields={{ text: 'text', value: 'value' }} />
                                    </div>
                                </td>
                            </tr>
                            <tr style={{ height: "55px" }}>
                                ...
                                <td>
                                    <div className="col" style={{ marginLeft: '0px', paddingLeft: '0px', marginTop: '-19px' }}>
                                        <CheckBoxComponent id="header" change={enableRowColumnHeader.bind(this)} style={{ paddingLeft: '0px' }} />
                                    </div>
                                </td>
                            </tr>
                            <tr style={{ height: "55px" }}>
                                ...
                                <td>
                                    <div className="col" style={{ marginLeft: '0px', paddingLeft: '0px', marginTop: '-19px' }}>
                                        <CheckBoxComponent id="gridline" change={enableGridLines.bind(this)} style={{ paddingLeft: '0px' }} />
                                    </div>
                                </td>
                            </tr>
                            <tr style={{ height: '55px' }}>
