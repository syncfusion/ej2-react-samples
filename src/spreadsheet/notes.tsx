...
export class Notes extends SampleBase<{}, {}> {
    ...
    public cellStyle: CellStyleModel = { fontWeight: 'bold', textAlign: 'center' };
                            ...
                            <SheetDirective name='Cart'>
                                ...
                                <RowsDirective>
                                    ...
                                    <RowDirective index={2}>
                                        <CellsDirective>
                                            <CellDirective value='Product ID' style={this.cellStyle}></CellDirective>
                                    ...
                                    <RowDirective>
                                        <CellsDirective>
                                            ...
                                            <CellDirective formula='=Sum(F4:F12)' format={this.currencyFormat} style={{ border: '1px solid #A6A6A6', textAlign: 'right', verticalAlign: 'middle', fontWeight: 'bold' }}></CellDirective>
                                        </CellsDirective>
                                    </RowDirective>
                                </RowsDirective>
                                <ColumnsDirective>
