...
export class AjaxContent extends SampleBase {
    constructor() {
        super(...arguments);
        this.nestAcrdn = AccordionComponent;
    }
    rendereComplete() {
    ...
    render() {
        ...
        function HWSW() {
            return (<div id="Hard_Soft_features" style={{ display: 'none' }}>
                    <table>
                        <tbody><tr>
