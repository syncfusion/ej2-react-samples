...
export class BatchEdit extends SampleBase {
    ...
    render() {
        ...
        <div id="description">
            ...
            <p>
              In this demo, Batch mode is enabled for editing by defining <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-editSettings.html#mode-string">
                editSettings.mode
              ...
              invoking the <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-edit.html#batchsave">
                batchSave
              </a></code> method.
            </p>
            ...
            <p>
              ...
              <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-edit.html">
                Edit
