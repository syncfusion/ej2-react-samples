...
export class AggregateGroup extends SampleBase<{}, {}> {  
  ...
  public groupSettings: Object = {showDropArea:false, columns:['ConsumptionCategory'], showGroupedColumn:true};
  ...
  public footerAverage(props):any{
    return(<span>Average Energy Produced: {props.Average} KWh</span>)
  }
  public groupcFootertMaxMin(props):any{
  ...
  public energyHeaderTemplate(props): any{
      ...
      <div className='control-pane'>
        ...
        <GridComponent id="group-aggregate-grid" dataSource={energyData} enableHover={false} allowSorting={true} gridLines='Vertical' allowMultiSorting={true} height={300} allowGrouping={true} groupSettings={this.groupSettings} allowFiltering={true} filterSettings={this.filterSettings}>
            ...
            { field: 'EnergyProduced', headerText: 'Produced', width: 300, textAlign: 'Right'}]}></ColumnDirective>
              <ColumnDirective field='WeatherCondition' headerText='Weather' width='120'></ColumnDirective>
              <ColumnDirective field='EnergyPrice' headerText='Price ($)' width='130' format='C2'></ColumnDirective>
            </ColumnsDirective>
            <AggregatesDirective>
                <AggregateDirective>
                  <AggregateColumnsDirective>
                    <AggregateColumnDirective field='EnergyProduced' type='Sum' format='N2' footerTemplate={this.footerSum}> </AggregateColumnDirective>
                  </AggregateColumnsDirective>
                  </AggregateDirective>
                  <AggregateDirective>
                  <AggregateColumnsDirective>
                    <AggregateColumnDirective field='EnergyProduced' type='Average' format='N2' footerTemplate={this.footerAverage}> </AggregateColumnDirective>
                  </AggregateColumnsDirective>
                  </AggregateDirective>            
                  <AggregateDirective>
                  <AggregateColumnsDirective>
                    <AggregateColumnDirective field='EnergyProduced' type='Max' format='N2' groupCaptionTemplate={this.groupcFootertMaxMin}> </AggregateColumnDirective>
                  </AggregateColumnsDirective>
                </AggregateDirective>
                <AggregateDirective>
                  <AggregateColumnsDirective>
                    <AggregateColumnDirective field='EnergyProduced' type='Sum' format='N2' groupFooterTemplate={this.groupFooterSum}> </AggregateColumnDirective>
                  </AggregateColumnsDirective>
                </AggregateDirective>
            </AggregatesDirective>
