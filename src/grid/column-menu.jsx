...
export class ColumnMenuSample extends SampleBase {
    ...
    render() {
        return (<div className='control-pane'>
                ...
                by defining the
                <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-gridComponent.html#showcolumnmenu-boolean">showColumnMenu
