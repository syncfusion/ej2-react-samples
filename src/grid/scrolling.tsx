            ...
            <div className='control-pane'>
                ...
                <div id='description'>
                    ...
                    <p>The <code><a target="_blank" className="code"
                        href="http://ej2.syncfusion.com/react/documentation/grid/api-gridComponent.html#height-string---number">height
        </a></code> and <code><a target="_blank" className="code"
                            href="http://ej2.syncfusion.com/react/documentation/grid/api-gridComponent.html#width-string---number">width
