...
export class ColChooser extends SampleBase {
    ...
    render() {
        ...
        icon in the toolbar to open column chooser and you can select columns to hide/show from the checkbox list.
                ...
                <div id="description">
                    <p>The Grid columns can be shown/hidden dynamically by using column chooser.  To enable column chooser behavior, set  <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-grid.html#showColumnChooser-boolean">showColumnChooser
        </a></code> property as true. You can also prevent the show of a column by setting
            <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-column.html#showInColumnChooser-boolean">columns->showInColumnChooser
