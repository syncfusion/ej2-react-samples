...
export class Localbinding extends SampleBase {
    render() {
        return (<div className='control-pane'>
                ...
                <div id='description'>                 
                    <p>
                       The Grid supports data binding. The  <code><a target='_blank' className='code' href='http://ej2.syncfusion.com/react/documentation/grid/api-grid.html#datasource-object---datamanager'>
                            dataSource</a></code> property can be assigned either with the array of JavaScript objects or instance of  <code><a target='_blank' className='code' href='http://ej2.syncfusion.com/react/documentation/grid/api-grid.html#datasource-object---datamanager'>
                            datamanager</a></code>.
          </p>          
                    <p>
