        ...
        return (
            <div className='control-pane'>
                <div className='control-section paging-api'>
                    <GridComponent dataSource={data}  locale='en-US' allowPaging={true} allowSorting={true} editSettings={this.editSettings} allowFiltering={true} filterSettings={this.filterSettings} toolbar={this.toolbar} height={365} pageSettings={{ pageCount: 4, pageSizes: true }}>
                        <ColumnsDirective>
