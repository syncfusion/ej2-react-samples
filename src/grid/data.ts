...
export function createLazyLoadData(): Object[] {
...
export const orderData: Object[] = JSON.parse(stringData, (field: string, value: any) => {
...
let templateDetails = employeeData;
...
export const getTradeData: Object[] = [
    {
        id: 1,
        CountryCode: 'US',
        Change: -1.62,
