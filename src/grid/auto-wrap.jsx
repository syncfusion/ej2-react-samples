...
export class AutoWrap extends SampleBase {
    render() {
        return (<div className='control-pane'>
                ...
                <div id='description'>
                    <p>Auto wrap cell content can be enabled using  <code><a target='_blank' className='code' href='http://ej2.syncfusion.com/react/documentation/grid/api-grid.html#allowtextwrap-boolean'>
                    ...
                    <p>In this demo, the <code><a target='_blank' className='code' href='http://ej2.syncfusion.com/react/documentation/grid/api-grid.html#allowtextwrap-boolean'>
