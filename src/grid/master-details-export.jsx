...
import { GridComponent, Inject, ColumnsDirective, ColumnDirective, DetailRow, Toolbar, PdfExport, ExcelExport } from '@syncfusion/ej2-react-grids';
...
export class HierarchyExport extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          <GridComponent ref={r => this.grid = r} dataSource={employeeData} childGrid={this.childGrid} toolbar={['PdfExport', 'ExcelExport']} allowPdfExport={true} allowExcelExport={true} toolbarClick={this.toolbarClick.bind(this)}>
              <ColumnsDirective>
        ...
        <div id="description">
            ...
            <p>In this demo, ExcelExport and PdfExport items are defined in the toolbar. For these toolbar items, we have defined actions
                ...
                <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/api/grid#excelexport">excelExport</a></code>, 
                <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/api/grid#pdfexport">pdfExport</a></code>
