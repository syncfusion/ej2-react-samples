...
export class AggregateDefault extends SampleBase<{}, {}> {  
  ...
  render() {
    return (
      <div className='control-pane'>
        ...
        href="http://ej2.syncfusion.com/react/documentation/grid/api-aggregateColumn.html#footertemplate-string">
 ...
 href="http://ej2.syncfusion.com/react/documentation/grid/api-aggregateColumn.html#format-string---numberformatoptions---dateformatoptions">
