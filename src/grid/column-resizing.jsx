...
export class ColumnResizing extends SampleBase {
    render() {
        ...
        resize the column.
                ...
                <div id="description">
                    <p>The Grid columns can be resized by clicking and dragging at the right corner of columns header. To enable column, resize behavior, set <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-gridComponent.html#allowresizing-boolean">allowResizing
                        ...
                        And, by double clicking at the right corner of column header, the respective column width will get auto adjusted to its fit by <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-gridComponent.html#autofitcolumns">autoFitColumns
                            </a></code> method.
                    </p>
                    <p>
