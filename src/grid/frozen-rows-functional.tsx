              ...
              <tr>
                ...
                <td style={{ width: '70%', paddingRight: '10px' }}>
                  <div style={{ minWidth: '148px' }}>
                    ...
                    <NumericTextBoxComponent min={0} max={5} value={2} ref={numeric => rowInstance = numeric}></NumericTextBoxComponent>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td style={{ width: '70%', paddingRight: '10px' }}>
                  <div style={{ minWidth: '148px' }}>
                    ...
                    <NumericTextBoxComponent min={0} max={Browser.isDevice ? 1 : 2} value={1} ref={numeric => columnInstance = numeric}></NumericTextBoxComponent>
                  </div>
                </td>
              </tr>
              <tr>
