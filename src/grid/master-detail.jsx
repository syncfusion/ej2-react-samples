    ...
    render() {
        return (<div className='control-pane'>
            ...
            a separate Grid(Detail Grid) by clicking the particular row.
                    ...
                    <ul>
                        <li> Get the selected record of Master Grid in the <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-gridComponent.html#rowselected--emittyperowselecteventargs">
                            rowSelected
        </a></code> event.</li>
                        <li> Filter the data based on the selected record and bind the result to the Detail Grid`s <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-gridComponent.html#datasource-object---datamanager">
                            dataSource
        </a></code> property.</li>
                    </ul>
            ...
            the data will be filtered and set to the Detail Grid. Here the <strong>CustomerID</strong> value is used as key value.</li>
                        <li>Created an another React component named <code>MasterComponent</code> which has Master Grid component with <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-gridComponent.html#rowselected--emittyperowselecteventargs">
                            rowSelected
                    ...
                    <p>Use <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-gridComponent.html#selectedrowindex-number">
                        selectedRowIndex
