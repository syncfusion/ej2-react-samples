...
import { GridComponent, Inject, ColumnsDirective, ColumnDirective, Sort, DetailRow, Toolbar } from '@syncfusion/ej2-react-grids';
...
export class Print extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          ...
          <br />
          <GridComponent ref={r => this.grid = r} dataSource={employeeData} childGrid={this.childGrid} toolbar={['Print']} allowSorting={true} hierarchyPrintMode={'All'}>
              <ColumnsDirective>
        ...
        <div id="description">
            <p>The Grid can be printed using the <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/api/grid#print">print
                </a></code> method. While printing the pager and scrollbar will be removed if they are enabled in Grid.
                By default, all pages will be printed. We can print current page alone by setting the <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/api/grid#printmode">printMode
            ...
            <p>
                We can change the child grid's print option by using the <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/api/grid#hierarchyprintmode">hierarchyPrintMode
                </a></code> property.
            </p>
            <p>
