...
function Grouping() {
    ...
    const groupOptions: Object = { showGroupedColumn: false, columns: ['Country'] };
    ...
    return (
        <div className='control-pane'>
            <div className='control-section'>
                <GridComponent dataSource={inventoryData} allowPaging={true} ref={grid => gridInstance = grid} pageSettings={{ pageCount: 5 }} allowGrouping={true} groupSettings={groupOptions} allowSorting={true} height="320"
                    dataBound={dataBound.bind(this)} load={load}>
                    <ColumnsDirective>
