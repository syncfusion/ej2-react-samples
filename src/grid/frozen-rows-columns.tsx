...
export class FrozenRowsColumns extends SampleBase<{}, {}> {
    ...
    return (
      <div className='control-pane'>
        <div className='control-section'>
          ...
          <GridComponent dataSource={orderDetails} height='350' frozenRows={2} frozenColumns={1} allowSelection={false} enableHover={false} allowResizing={true} allowSorting={true} allowFiltering={true} filterSettings={this.filterSettings} allowMultiSorting={false} ref={g => this.grid = g}>
            <ColumnsDirective>
        ...
        <div id='description'>
          ...
          <p>
              ...
              href="https://ej2.syncfusion.com/react/documentation/api/grid/#frozenrows"><code>frozenRows</code></a> and
              <a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/#frozencolumns"><code>frozenColumns
              </code></a> properties.
          </p>
