...
import { GridComponent, ColumnsDirective, ColumnDirective, Toolbar, Inject, Sort } from '@syncfusion/ej2-react-grids';
        ...
        return (
            <div className='control-pane'>
                <div className='control-section'>
                    <GridComponent dataSource={orderDetails} ref={grid => this.gridInstance = grid} rowHeight={20} height={400} toolbar={this.toolbarOptions} toolbarClick={this.clickHandler.bind(this)} allowSorting={true}>
                        <ColumnsDirective>
