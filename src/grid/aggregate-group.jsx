...
export class AggregateGroup extends SampleBase {
    constructor() {
        ...
        this.groupSettings = { showDropArea: false, columns: ['CategoryName'] };
    }
    ...
    The aggregate configurations can be provided by the <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-grid.html">
        aggregates
        </a></code> property.</p>
    <p>The built-in aggregates are,</p>
     <ul>
        ...
        <li><code>Custom</code> - Requires the <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-aggregateColumn.html#customaggregate-string">
        customAggregate
    ...
    <p>
        In this demo, the <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-aggregateColumn.html#groupfootertemplate-string">
        groupFooterTemplate</a></code> property is used to display the group footer aggregation for the <strong><i>Unit In Stocks</i></strong> and <strong><i>Discontinued</i></strong> columns and <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-aggregateColumn.html#groupcaptiontemplate-string">
    ...
    <p>    To enable group footer aggregation for <strong><i>Unit In Stocks</i></strong> column, the <code>Sum</code> aggregate type is used by setting the <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-aggregateColumn.html#type-string---string">
        type</a></code> and the <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-aggregateColumn.html#field-string">
        field</a></code> property is set as <strong><i>UnitsInStock</i></strong> which will be used to perform the aggregation.
        The aggregate value is accessed inside the <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-aggregateColumn.html#groupfootertemplate-string">
        groupFooterTemplate</a></code> using its <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-aggregateColumn.html#type-string---string">
        type</a></code> name (<code>Sum</code>).
    </p>
    <p>    To enable group caption aggregation for <strong><i>Unit In Stocks</i></strong> column, the <code>Max</code> aggregate type is used by setting the <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-aggregateColumn.html#type-string---string">
        type</a></code> and <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-aggregateColumn.html#field-string">
        field</a></code> property is set as <strong><i>UnitsInStock</i></strong> which will be used to perform the aggregation.
        The aggregate value is accessed inside the<code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-aggregateColumn.html#groupcaptiontemplate-string">
        groupCaptionTemplate</a></code> using its <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-aggregateColumn.html#type-string---string">
