...
import { GridComponent, ColumnsDirective, ColumnDirective, Inject, Page, Toolbar, ExcelExport, PdfExport } from '@syncfusion/ej2-react-grids';
      ...
      <div className='control-pane'>
        <div className='control-section'>
          ...
          <div id="description">
            ...
            <p>In this demo, excelexport, pdfexport and csvexport items are defined in the toolbar. For these toolbar items, we have
