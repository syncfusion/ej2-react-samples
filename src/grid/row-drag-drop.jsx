...
export class Source extends SampleBase {
    ...
    render() {
        return (<div className='control-pane'>
            ...
            enabling <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-gridComponent.html#allowrowdraganddrop-boolean">
                            allowRowDragAndDrop
        </a></code> property. The target control on which the
            Grid rows has to be dropped can be set by using <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-gridComponent.html#rowdropsettings-rowdropsettingsmodel">
            ...
            <a target="_blank" href="http://ej2.syncfusion.com/react/documentation/grid/api-gridComponent.html#rowdropsettings-rowdropsettingsmodel">
