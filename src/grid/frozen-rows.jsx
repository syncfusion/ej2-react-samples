...
export class FrozenRows extends SampleBase {
    ...
    render() {
        ...
        <div id='description'>
          ...
          <p>
              In this demo sample, the first column and two rows are set to frozen by using the <a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-gridComponent.html#frozenrows-number"><code>frozenRows</code></a> and
