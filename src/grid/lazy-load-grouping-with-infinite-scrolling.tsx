...
export class LazyLoadGroupingWithInfiniteScrolling extends SampleBase<{}, {}> {
    ...
    render() {
        return (
            ...
            <div className='control-section'>
                    <GridComponent dataSource={this.lazyLoadData} allowSorting={true} height={400} enableInfiniteScrolling={true} allowGrouping={true} groupSettings={this.groupOptions}>
                        <ColumnsDirective>
