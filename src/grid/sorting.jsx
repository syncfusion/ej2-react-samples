...
export class Sorting extends SampleBase {
    ...
    render() {
        return (<div className='control-pane'>
                ...
                <div id='description'>
                    <p>
                        Sorting feature enables us to order the data in a particular direction. It can be enabled by setting the  <code><a target='_blank' className='code' href='http://ej2.syncfusion.com/react/documentation/grid/api-grid.html#allowsorting-boolean'>
