...
export class Reordering extends SampleBase {
    render() {
        return (<div className='control-pane'>
                ...
                <div id='description'>               
                    <p>
                        Reordering can be enabled by setting  <code><a target='_blank' className='code' href='http://ej2.syncfusion.com/react/documentation/grid/api-grid.html#allowreordering-boolean'>
