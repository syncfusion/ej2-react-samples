    ...
    render() {
        return (<div className='control-pane'>
                <div className='control-section'>
                    <GridComponent dataSource={orderDetails.slice()} allowPaging={true} ref={grid => this.gridInstance = grid} allowFiltering={true} allowSorting={true} editSettings={{ allowEditing: true, allowDeleting: true, allowAdding: true }} filterSettings={{ type: 'Menu' }} toolbar={this.toolbarOptions}>
                        <ColumnsDirective>
                ...
                <div id='description'>
                    <p>
                        ...
                        <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-column.html#datasource-object---datamanager">column.dataSource </a></code>
                        property with either local or remote data and column field and text can be defined by using
                        <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-column.html#foreignkeyfield-string">column.foreignKeyField</a></code> and
                        <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/grid/api-column.html#foreignkeyvalue-string">column.foreignKeyValue</a></code> properties.
                    </p>
