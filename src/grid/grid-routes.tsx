...
import { MultipleExporting } from './multipleexporting';
...
export const gridRoutes = (
    <div>
         ...
         <Route  path='/:theme/grid/exporting' component={ Exporting }/>
         <Route  path='/:theme/grid/multipleexporting' component={ MultipleExporting }/>
         <Route  path='/:theme/grid/rowheight' component={ RowHeight }/>
