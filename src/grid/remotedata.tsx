...
export class RemoteDataBinding extends SampleBase<{}, {}> {
    ...
    public data = new DataManager({ url: 'https://js.syncfusion.com/demos/ejServices/Wcf/Northwind.svc/Products', adaptor: new ODataAdaptor });
    public gridInstance: GridComponent;
    render() {
        return (
            <div className='control-pane'>
                <div className='control-section'>
                    <GridComponent id="Grid" dataSource={this.data} ref={grid => this.gridInstance = grid} allowPaging={true} pageSettings={{ pageCount: 5 }} >
                        <ColumnsDirective>
