    ...
    render() {
        ...
        of a particular record.
                ...
                <div id="description">
                    ...
                    This feature can be enabled by defining <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/documentation/grid/api-grid.html#childgrid-gridmodel">
                        childGrid</a></code> and <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/documentation/grid/api-grid.html#querystring-string">
                        childGrid.queryString</a></code>. And the <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/documentation/grid/api-grid.html#detaildatabound-emittypedetaildataboundeventargs">
