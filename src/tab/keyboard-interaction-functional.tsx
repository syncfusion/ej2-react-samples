...
const KeyboardInteraction = () => {
    ...
    headertext = [{ text: "HTML" }, { text: "C-Sharp(C#)" }, { text: "Java" }, { text: "VB.NET" }, { text: "Xamarin" }, { text: "ASP.NET" }, { text: "ASP.NET MVC" }, { text: "JavaScript" }];
    return (
