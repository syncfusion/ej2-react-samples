...
export class Notes extends SampleBase<{}, {}> {
    ...
    render() {
        return (<div className='control-pane'>
            ...
            <div id="description">
                <div>
                    <p>In this example, you can find footnotes and endnotes feature in DocumentEditor.</p>
                    <ul>
                    ...
                    "blocks": [
                        ...
                        },
                        {
                            ...
                            "inlines": [
                                    ...
                                    "blocks": [
                                        {
                                            ...
                                            "inlines": [
                                                ...
                                                {
                                                    "text": "Giant panda also known as panda bear or simply panda, is a bear native to south central China."
                                                }
                                            ]
                                        }
                                    ],
                                ...
                                {
                                    "text": ", which only lives in China outside of captivity, has captured the hearts of people of all ages across "
                                },
                                {
                                    "text": "the globe. From their furry black and w"
                                },
                                {
                                    "name": "_GoBack",
                                    "bookmarkType": 0
                                ...
                                {
                                    "text": "hite bodies to their shy and docile nature, they are considered one of the world's most loved animals."
                                }
                            ]
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "inlines": [
                                {
                                    "text": "While most adore their fluffy fur and round heads, which help give them their cuddly bear quality, others are fascinated by the many mysteries of the giant panda. Did you know that the giant panda may "
                                },
                                {
                                    "text": "actually be"
                                },
                                ...
                                {
                                    "text": " have an opposable pseudo thumb, and that they’re technically a carnivore even though their diet is primarily vegetarian? These things and more have baffled scientists and naturalists for hundreds of years. "
                                }
                            ]
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "inlines": [
                                {
                                    "text": "A characteristic of the g"
                                },
                                {
                                    "text": "iant panda that has mystified scientists is their movable, elongated wrist bone that acts like an opposable thumb. This human-like quality that helps give them even more of a cuddly-bear appearance enables the giant panda to pick up objects and even eat si"
                                },
                                {
                                    "text": "tting up. "
                                }
                        ...
                        },
                        {
                            ...
                            "inlines": [
                                {
                                    "text": "Giant pandas are generally referred to as bears and are typically called panda bears rather than giant pandas. Though we may think they look like bears, there has been a great deal of discussion for decades about where giant pandas fit in th"
                                },
                                {
                                    "text": "e animal kingdom. Much of the debate has been whether they are more closely related to the red panda, once thought to be a member of the raccoon family, than the bear family."
                                }
                            ]
                        },
                        {
                            ...
                            "inlines": [
                                {
                                    "text": "While a giant panda has a body that resembles a small bear and climbs trees like "
                                },
                                {
                                    "text": "a bear, it also has several characteristics in common with the red panda. For example, both giant pandas and red pandas eat bamboo and have the same pseudo thumb. The table below lists the main characteristics the giant panda shares with bears and red pand"
                                },
                                {
                                    "text": "as."
                                }
                        ...
                        },
                        {
                            ...
                            "inlines": [
                                {
                                    "text": "While the body of a giant panda looks like that of a bear and the dark circles around its eyes resemble those of a red panda or raccoon, its pupils have vertical slits like the eyes of a cat. Because of their unusual eyes, a popular Chinese name for panda "
                                },
                                {
                                    "text": "is ‘big bear cat’ "
                                },
                                {
                                    "text": "or"
                                },
                        ...
                        },
                        {
                            ...
                            "inlines": [
                                {
                                    "text": "DNA analysis has put one mystery to rest. It has revealed that while the red panda is a distant relation, the giant panda's closest relative is the spectacled bear from So"
                                },
                                {
                                    "text": "uth America."
                                }
                        ...
                        },
                        {
                            ...
                            "inlines": [
                                {
                                    "text": "Their ability to digest bamboo is attributed to tiny microbes that live within their digestive system. As they can only digest about 20% of what they eat, the average giant panda consumes around 14 kilograms (30 pounds) of bamboo a day. In comparison, hu"
                                },
                                {
                                    "text": "mans eat about 2 kilograms (5 pounds) of food a day. This enormous diet means the giant panda spends more than 12 hours a day eating to stay nourished. "
                                }
                            ]
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "inlines": [
                                ...
                                {
                                    "text": "than its mother. An average adult mother weighs around 91 kilograms (200 pounds) while newborn weighs only 83 to 190 grams (3 to 4 ounces)."
                                }
                            ]
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "inlines": [
                                {
                                    "text": "Researchers have recently discovered that the gene responsible for tasting savory or uma"
                                },
                                {
                                    "text": "mi flavors, such as meat, is inactive in giant pandas."
                                }
                            ]
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "inlines": [
                                {
                                    "text": "Giant pandas can stand erect on their"
                                },
                                {
                                    "text": " hind legs but rarely walk."
                                }
                            ]
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "inlines": [
                                {
                                    "text": "A newborn giant pan"
                                },
                                {
                                    "text": "da is blind and looks like a tiny, pink, hairless mouse."
                                }
                            ]
                        }
                    ],
