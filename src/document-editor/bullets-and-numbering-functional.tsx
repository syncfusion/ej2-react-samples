    ...
    return (
        <div className="control-pane">
            ...
            <div id="action-description">
                <p>
                    This example demonstrates bullets and numbering support in document
                    editor. Both single list and multi-level lists are supported.
                </p>
            </div>
            <div id="description">
                <div>
                    ...
                    <p style={{ display: "block" }}>
                        ...
                        <a
                            target="_blank"
                            href="https://ej2.syncfusion.com/react/documentation/document-editor/list-format/"
                        >
...
export default BulletsAndNumberingView;
