    ...
    return (
        <div className="control-pane">
            ...
            <div id="action-description">
                <p>
                    This example demonstrates section formatting options in document
                    editor such as page margins, page size, header distance from top, and
...
export default SectionFormatView;
