...
const ParagraphFormatView = () => {
    ...
    const rendereComplete = (): void => {
        ...
        container.current.documentEditorSettings.showHiddenMarks = true;
    ...
    return (
        <div className="control-pane">
            ...
            <div id="action-description">
                <p>
                    This example demonstrates paragraph formatting options in document
                    editor such as indentation, spacing, and text alignment.
                </p>
            </div>
            <div id="description">
                <div>
                    <p>
                        In this example, paragraph formatting features in the document
                        editor can be found.
                    </p>
                    <ul>
                    ...
                    <p style={{ display: "block" }}>
                        ...
                        <a
                            target="_blank"
                            href="https://ej2.syncfusion.com/react/documentation/document-editor/paragraph-format/"
                        >
...
export default ParagraphFormatView;
