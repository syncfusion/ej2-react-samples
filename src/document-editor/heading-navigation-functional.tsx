...
const HeadingNavigation = () => {
    ...
    const onLoadDefault =(): void =>{
        ...
        container.current.documentEditorSettings.showNavigationPane = true;
...
titleBar.showButtons(false);
    ...
    return (
        <div className="control-pane">
            ...
            <div id="description">
    <p>In this example, you can navigate documents by heading allows users to move around the document very quickly.</p>    
    <p style={{ display: "block" }}>
                    ...
                    <a
                        target="_blank"
                        href="https://ej2.syncfusion.com/react/documentation/document-editor/"
                    >
