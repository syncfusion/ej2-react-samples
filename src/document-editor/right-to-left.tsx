    ...
    'ar-AE': {
        'documenteditor': {
            ...
            'Number format tooltip information': 'تنسيق رقم أحادي المستوي:' + '</br>' + '[بادئه]% [مستوي الاعداد] [لاحقه]' + '</br>'
                ...
                + 'علي سبيل االمثال ، "الفصل% 1." سيتم عرض الترقيم مثل' + '</br>' + 'الفصل الأول- البند' + '</br>'
                + 'الفصل الثاني- البند' + '</br>...'
...
export class RightToLeftView extends SampleBase<{}, {}> {
            ...
            <div className='control-section'>
                ...
                <div id="documenteditor_container_body">
                    <DocumentEditorContainerComponent id="container" ref={(scope) => { this.container = scope; }} style={{ 'display': 'block', 'height': '590px' }}
                        enableRtl={true} locale='ar-AE' enableToolbar={true} />
                </div>
            </div>
    ...
    onLoadDefault = (): void => {
        this.container.documentEditor.open(RTL);
