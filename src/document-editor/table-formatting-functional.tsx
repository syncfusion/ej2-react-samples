    ...
    return (
        <div className="control-pane">
            ...
            <div id="action-description">
                <p>
                    This example demonstrates table formatting options in document editor
                    such as cell margins, cell spacing, horizontal merge, vertical merge,
                    border styles, background color, and more.
                </p>
            </div>
            <div id="description">
                <div>
                    <p>
                        In this example, you can find all the table formatting features.
                    </p>
                    <ul>
                    ...
                    <p style={{ display: "block" }}>
                        ...
                        <a
                            target="_blank"
                            href="https://ej2.syncfusion.com/react/documentation/document-editor/table-format/"
                        >
...
export default TableFormatView;
