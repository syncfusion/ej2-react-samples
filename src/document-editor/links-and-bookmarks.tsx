        ...
        return (<div className='control-pane'>
            ...
            <div id="description">
                <div>
                    ...
                    <p style={{ 'display': 'block' }}>You can also add your own screen tip text for a hyperlink.  More information about the document editor features can be found in this <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/document-editor/bookmark/">documentation section.</a>
                    </p>
                </div>
            </div>
        </div>);
