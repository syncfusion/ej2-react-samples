...
const TrackChanges = () => {
    ...
    const onLoadDefault = (): void => {
        ...
        container.current.documentEditor.documentName = "Track Changes";
    ...
    return (
        <div className="control-pane">
            ...
            <div id="action-description">
                <p>
                    This example demonstrates the track changes in DocumentEditor to view,
                    make and accept or reject the changes. To unprotect the document, use
                    password '123'.
                </p>
            </div>
            <div id="description">
                <p>
                    In this example, you can find track changes feature in the document
                    editor.
                </p>
                <ul>
                ...
                <p style={{ display: "block" }}>
                    ...
                    <a
                        target="_blank"
                        href="https://ej2.syncfusion.com/react/documentation/document-editor/getting-started/"
                    >
