...
export class MultipleColumnsView extends SampleBase<{}, {}> {
    ...
    render() {
        return (<div className='control-pane'>
            ...
            <div id="action-description">
                <p>This example demonstrates multiple column layout in document editor.</p>
            </div>
            <div id="description">
                <div>
                    <p>In this example, section formatting features in the document editor can be found.</p>
                    <ul>
                        <li>Continuous section break.</li>
                        <li>Two and three column layout.</li>
                    </ul>
