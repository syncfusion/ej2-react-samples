...
export class FormFields extends SampleBase<{}, {}> {
            ...
            <div className='control-section'>
                ...
                <div id="documenteditor_container_body">
                    <DocumentEditorContainerComponent id="container" ref={(scope) => { this.container = scope; }} style={{ 'display': 'block' }}
                       height={'590px'} toolbarMode={'Ribbon'} serviceUrl={this.hostUrl} enableToolbar={true} showPropertiesPane={false} locale='en-US' documentEditorSettings={this.settings}  />
                </div>
            </div>
