...
const TableOfContentsView = () => {
    ...
    const onLoadDefault = (): void => {
        ...
        container.current.documentEditor.documentName = "Table of Contents";
    ...
    return (
        <div className="control-pane">
            ...
            <div id="action-description">
                <p>
                    This example demonstrates table of contents support in document
                    editor. Many options are available for including table of contents
                    such as hyperlink, page number, right-aligned tabs, and styles.
                </p>
            </div>
            <div id="description">
                <div>
                    <p>
                        In this example, you can find table of content options in document
                        editor.
                    </p>
                    <ul>
                        <li>
                            Include hyperlink: A link with bookmark reference to the content
                            will be included.
                        </li>
                        <li>
                            Include page number: The page number of the content will be
                            included.
                        </li>
                        <li>
                            Right-aligned tabs: The page number will be right-aligned to the
                            content.
                        </li>
                        <li>
                            Heading levels: The range of heading levels to be included in the
                    ...
                    <p style={{ display: "block" }}>
                        ...
                        <a
                            target="_blank"
                            href="https://ej2.syncfusion.com/react/documentation/document-editor/table-of-contents/"
                        >
