...
"daterangepicker": {"default":{"name":"Default Functionalities","category":"DateRangePicker"},"minmax":{"name":"Date Range","category":"DateRangePicker"},"minmaxdays":{"name":"Restrict Range","category":"DateRangePicker"},"globalization":{"name":"Globalization","category":"DateRangePicker"},"presets":{"name":"Preset Ranges","category":"DateRangePicker"},"defaultSample":"daterangepicker/default"},
...
"form-validator": {"default":{"name":"Default Functionalities","category":"FormValidator"},"defaultSample":"form-validator/default"},
"grid": {"default":{"name":"Default Functionalities","category":"GRID"},"gridlines":{"name":"GridLines","category":"GRID"},"paging":{"name":"Paging","category":"GRID"},"filtering":{"name":"Filtering","category":"GRID"},"filtermenu":{"name":"Filtering Menu","category":"GRID"},"grouping":{"name":"Grouping","category":"GRID"},"sorting":{"name":"Sorting","category":"GRID"},"scrolling":{"name":"Default Scrolling","category":"SCROLLING"},"virtualization":{"name":"Virtual Scrolling","category":"SCROLLING"},"searching":{"name":"Searching","category":"GRID"},"masterdetail":{"name":"Master/Detail","category":"GRID"},"rowdraganddrop":{"name":"Row Drag and Drop","category":"GRID"},"hierarchy":{"name":"Hierarchy Grid","category":"GRID"},"clipboard":{"name":"Clipboard","category":"GRID"},"localbinding":{"name":"Local Binding","category":"DATABINDING"},"remotedata":{"name":"Remote Binding","category":"DATABINDING"},"showhide":{"name":"Show Hide Column","category":"COLUMN"},"stackedheader":{"name":"Stacked Header","category":"COLUMN"},"autowrap":{"name":"AutoWrap Column cells","category":"COLUMN"},"reorder":{"name":"Reorder Columns","category":"COLUMN"},"selection":{"name":"Default Selection","category":"SELECTION"},"selectionapi":{"name":"Selection API","category":"SELECTION"},"checkboxselection":{"name":"Checkbox Selection","category":"SELECTION"},"columnchooser":{"name":"Column Chooser","category":"COLUMN"},"columnresizing":{"name":"Column Resizing","category":"COLUMN"},"normaledit":{"name":"Inline Editing","category":"EDITING"},"dialogedit":{"name":"Dialog Editing","category":"EDITING"},"batch":{"name":"Batch Editing","category":"EDITING"},"command-column":{"name":"CommandColumn","category":"EDITING"},"exporting":{"name":"Basic","category":"EXPORTING"},"multipleexporting":{"name":"MultipleExporting","category":"EXPORTING"},"rowheight":{"name":"Row Height","category":"GRID"},"columnmenu":{"name":"Column Menu","category":"COLUMN"},"contextmenu":{"name":"Context Menu","category":"GRID"},"columnspanning":{"name":"Column Spanning","category":"COLUMN"},"defaultSample":"grid/default"},
