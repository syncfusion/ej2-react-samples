...
function CustomPointer() {
    ...
    let textWidget: LinearGaugeComponent;
    let iconWidget: LinearGaugeComponent;
    let multipleWidget: LinearGaugeComponent;
    ...
    function horizontalGauge(e: Event): void {
        textWidget.width = iconWidget.width = multipleWidget.width = '450px';
        textWidget.height = iconWidget.height = multipleWidget.height = '150px';
        textWidget.orientation = iconWidget.orientation = multipleWidget.orientation = "Horizontal";
        textWidget.axes[0].pointers[0].offset = 2;
        multipleWidget.axes[0].pointers[0].offset = 2;
    ...
    function verticalGauge(e: Event): void {
        textWidget.width = iconWidget.width = multipleWidget.width = '170px';
        textWidget.height = iconWidget.height = multipleWidget.height = '350px';
        textWidget.orientation = iconWidget.orientation = multipleWidget.orientation = "Vertical";
        textWidget.axes[0].pointers[0].offset = -2;
        multipleWidget.axes[0].pointers[0].offset = -2;
        if (e.currentTarget != null) {
            e.currentTarget['style']['color'] = "white";
        ...
        <div className='control-pane'>
            ...
            <div className="control-section">
                ...
                <div id="containerText" className="col-xs-5 col-sm-5 col-lg-4 col-md-4" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <LinearGaugeComponent load={load.bind(this)} id='textWidget' title='Text widget' titleStyle={{ fontFamily: 'inherit', fontWeight: '499' }} orientation='Vertical' width='150px' height='350px' background='transparent' ref={textWidgetInstance => textWidget = textWidgetInstance}>
                ...
                <div id="containerIcon" className="col-xs-5 col-sm-5 col-lg-4 col-md-4" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <LinearGaugeComponent load={load.bind(this)} title='Icon widget' titleStyle={{ fontFamily: 'inherit', fontWeight: '499' }} id='iconWidget' orientation='Vertical' width='150px' height='350px' background='transparent' ref={iconWidgetInstance => iconWidget = iconWidgetInstance}>
                        <AxesDirective>
                            <AxisDirective line={{ width: 20 }} minorTicks={{ interval: 10, height: 3 }} majorTicks={{ interval: 20, height: 7, width: 1 }} labelStyle={{ font: { fontFamily: 'inherit' } }} minimum={0} maximum={100} opposedPosition={true}>
                                <PointersDirective>
                ...
                <div id="containerMultiple" className="col-xs-5 col-sm-5 col-lg-4 col-md-4" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <LinearGaugeComponent load={load.bind(this)} title='Multiple widget pointers' titleStyle={{ fontFamily: 'inherit', fontWeight: '499' }} id='multipleWidget' orientation='Vertical' width='170px' height='350px' background='transparent' ref={multipleWidgetInstance => multipleWidget = multipleWidgetInstance}>
                        <Inject services={[Annotations]} />
                        <AxesDirective>
