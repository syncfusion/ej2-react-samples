    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <LinearGaugeComponent load={load.bind(this)} axisLabelRender={axisLabelRender.bind(this)} id='gauge' background='transparent' orientation='Horizontal'>
                    <AxesDirective>
                        <AxisDirective minimum={5} maximum={20} opposedPosition={true} majorTicks={{ height: 0 }} minorTicks={{ height: 0 }} line={{ width: 5 }} labelStyle={{ offset: 20, font: { size: '16px', fontFamily: 'inherit' } }}>
                            <PointersDirective>
                                ...
                                <PointerDirective value={15} height={25} width={25} placement='Near' markerType='Image' imageUrl='src/linear-gauge/images/tick-icon.png'> </PointerDirective>
                                <PointerDirective value={20} height={25} width={15} placement='Center' position='Cross' color='#D1D9DD' offset={-2} markerType='Circle'> </PointerDirective>
                            </PointersDirective>
                            <RangesDirective>
