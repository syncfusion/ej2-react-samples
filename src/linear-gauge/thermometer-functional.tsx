    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <LinearGaugeComponent load={load.bind(this)} id='gauge' background='transparent' orientation='Vertical' container={{ width: 13, roundedCornerRadius: 5, type: 'Thermometer', border: { width: 1 } }}>
