...
export class Ranges extends SampleBase<{}, {}> {
    private defaultRange: LinearGaugeComponent;
    private exponentialRange: LinearGaugeComponent;
    private concaveRange: LinearGaugeComponent;
    private gradientRange: LinearGaugeComponent;
    private multipleRange: LinearGaugeComponent;
