...
exports.LinearGaugeSampleOrder = [
    { 'path': 'linear-gauge/default', 'component': 'Default', 'name': 'Default Functionalities', 'description': 'This demo for Essential JS2 Linear Gauge control illustrates the default rendering of linear gauge that measures the values of scales.', 'order': '01', 'category': 'Linear Gauge' },
