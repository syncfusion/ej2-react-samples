...
function Tooltip() {
    ...
    function tooltipRender(args: ITooltipRenderEventArgs): void {
    ...
    function gaugeResized(args: IResizeEventArgs): void {
        if (args.currentSize.width < 500) {
            gaugeInstance.axes[1].majorTicks.interval = 2;
            gaugeInstance.axes[1].minorTicks.interval = 1;
            gaugeInstance.orientation = 'Vertical';
            gaugeInstance.annotations[0].x = -57;
            gaugeInstance.annotations[0].y = -30;
            gaugeInstance.annotations[1].x = 50;
            gaugeInstance.annotations[1].y = -45;
        } else {
            gaugeInstance.axes[1].majorTicks.interval = 1;
            gaugeInstance.axes[1].minorTicks.interval = 0.2;
            gaugeInstance.orientation = 'Horizontal';
            gaugeInstance.annotations[0].x = 35;
            gaugeInstance.annotations[0].y = -58;
            gaugeInstance.annotations[1].x = 50;
            gaugeInstance.annotations[1].y = 52;
        }
    }
    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <LinearGaugeComponent id='tooltipContainer' ref={gauge => gaugeInstance = gauge} background='transparent' orientation='Horizontal' axisLabelRender={labelRender.bind(this)} load={gaugeLoad.bind(this)} loaded={gaugeLoaded.bind(this)} resized={gaugeResized.bind(this)} tooltipRender={tooltipRender.bind(this)} container={{ width: 140, border: { width: 2, color: '#a6a6a6' } }}
