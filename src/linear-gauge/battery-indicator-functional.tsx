...
import { LinearGaugeComponent, ILoadedEventArgs, LinearGaugeTheme, AxesDirective, AxisDirective, Inject, PointersDirective, PointerDirective, AnnotationDirective, Annotations, AnnotationsDirective, RangesDirective, RangeDirective } from '@syncfusion/ej2-react-lineargauge';
                ...
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <LinearGaugeComponent load={load} background='transparent' id='gauge' orientation='Horizontal' width='200px' container={{ width: 58, type: 'RoundedRectangle', border: { width: 5 } }}>
                        ...
                        <AnnotationsDirective>
                            ...
                            <AnnotationDirective content='<div style="width: 134px;font-size: 20px;margin-top:-47px;margin-left:147px;color:##000000;">Charged: 75%</div>' axisIndex={0} axisValue={0} x={0} zIndex='1' y={0} />
                        </AnnotationsDirective>
