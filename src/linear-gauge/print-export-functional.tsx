...
function Export() {
    ...
    let gauge: LinearGaugeComponent;
        ...
        <div className='control-pane'>
            ...
            <div className='control-section row'>
                <div className='col-lg-8'>
                    <LinearGaugeComponent load={load.bind(this)} id='gauge' background='transparent' allowPrint={true} allowPdfExport={true} allowImageExport={true} title='Speedometer' titleStyle={{ fontFamily: 'inherit' }} orientation='Horizontal' ref={gaugeInstance => gauge = gaugeInstance}>
                    ...
                    <PropertyPane title='Properties'>
                        <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
                            ...
                            <tr style={{ height: '60px' }}>
                                <td style={{ width: '50%' }}>
                                    <div id="btn-control">
                                        <ButtonComponent onClick={onClickExport.bind(this)} style={{ marginLeft: '30%' }} isPrimary={true}>Export</ButtonComponent>
                                    </div>
                                </td>
                                <td style={{ width: '50%' }}>
                                    <div id="btn-control">
                                        <ButtonComponent onClick={onClickPrint.bind(this)} style={{ marginLeft: '-20%' }} isPrimary={true}>Print</ButtonComponent>
                                    </div>
                                </td>
                            </tr>
                        </table>
