...
function Ranges() {
    ...
    let defaultRange: LinearGaugeComponent;
    let exponentialRange: LinearGaugeComponent;
    let concaveRange: LinearGaugeComponent;
    let gradientRange: LinearGaugeComponent;
    let multipleRange: LinearGaugeComponent;
    ...
    function horizontalGauge(e: Event): void {
        defaultRange.width = exponentialRange.width = concaveRange.width = gradientRange.width = multipleRange.width = '450px';
        defaultRange.height = exponentialRange.height = concaveRange.height = gradientRange.height = multipleRange.height = '150px';
        defaultRange.orientation = exponentialRange.orientation = concaveRange.orientation = gradientRange.orientation = multipleRange.orientation = "Horizontal";
    ...
    function verticalGauge(e: Event): void {
        defaultRange.width = exponentialRange.width = concaveRange.width = gradientRange.width = multipleRange.width = '150px';
        defaultRange.height = exponentialRange.height = concaveRange.height = gradientRange.height = multipleRange.height = '350px';
        defaultRange.orientation = exponentialRange.orientation = concaveRange.orientation = gradientRange.orientation = multipleRange.orientation = "Vertical";
        if (e.currentTarget != null) {
            e.currentTarget['style']['color'] = "white";
            e.currentTarget['style']['backgroundColor'] = "#0074E3";
        ...
        <div className='control-pane'>
            ...
            <div className="control-section">
                ...
                <div id='containerDefault' className="col-xs-4 col-sm-4 col-lg-2 col-md-2" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <LinearGaugeComponent load={load.bind(this)} id='defaultRange' title='Default' titleStyle={{ fontFamily: 'inherit', fontWeight: '499' }} orientation='Vertical' width='150px' height='350px' background='transparent' ref={defaultRangeInstance => defaultRange = defaultRangeInstance}>
                        <AxesDirective>
                ...
                <div id='containerExponential' className="col-xs-4 col-sm-4 col-lg-2 col-md-2" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <LinearGaugeComponent load={load.bind(this)} title='Exponential' titleStyle={{ fontFamily: 'inherit', fontWeight: '499' }} id='exponentialRange' orientation='Vertical' width='150px' height='350px' background='transparent' ref={exponentialRangeInstance => exponentialRange = exponentialRangeInstance}>
                        <AxesDirective>
                            <AxisDirective line={{ width: 5 }} minorTicks={{ interval: 10, height: 3, position: 'Outside' }} majorTicks={{ interval: 20, height: 7, width: 1, position: 'Outside' }} labelStyle={{ position: 'Outside', font: { fontFamily: 'inherit' } }} minimum={0} maximum={100} opposedPosition={true}>
                                <PointersDirective>
                                    <PointerDirective width={0}>
                ...
                <div id='containerConcave' className="col-xs-4 col-sm-4 col-lg-2 col-md-2" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <LinearGaugeComponent load={load.bind(this)} title='Concave' titleStyle={{ fontFamily: 'inherit', fontWeight: '499' }} id='concaveRange' orientation='Vertical' width='150px' height='350px' background='transparent' ref={concaveRangeInstance => concaveRange = concaveRangeInstance}>
                        <AxesDirective>
                            <AxisDirective line={{ width: 5 }} minorTicks={{ interval: 10, height: 3, position: 'Outside' }} majorTicks={{ interval: 20, height: 7, width: 1, position: 'Outside' }} labelStyle={{ position: 'Outside', font: { fontFamily: 'inherit' } }} minimum={0} maximum={100} opposedPosition={true}>
                                <PointersDirective>
                                    <PointerDirective width={0}>
                ...
                <div id='containerGradient' className="col-xs-4 col-sm-4 col-lg-2 col-md-2" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <LinearGaugeComponent load={load.bind(this)} title='Gradient shader' titleStyle={{ fontFamily: 'inherit', fontWeight: '499' }} id='gradientRange' orientation='Vertical' width='150px' height='350px' background='transparent' ref={gradientRangeInstance => gradientRange = gradientRangeInstance}>
                        ...
                        <AxesDirective>
                            <AxisDirective line={{ width: 5 }} minorTicks={{ interval: 10, height: 3, position: 'Outside' }} majorTicks={{ interval: 20, height: 7, width: 1, position: 'Outside' }} labelStyle={{ position: 'Outside', font: { fontFamily: 'inherit' } }} minimum={0} maximum={100} opposedPosition={true}>
                                ...
                                <RangesDirective>
                                    <RangeDirective start={0} end={100} startWidth={50} endWidth={50} offset={5} linearGradient={rangeLinearGradient}></RangeDirective>
                                </RangesDirective>
                            </AxisDirective>
                        </AxesDirective>
                    </LinearGaugeComponent>
                ...
                <div id='containerMultiple' className="col-xs-4 col-sm-4 col-lg-2 col-md-2" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <LinearGaugeComponent load={load.bind(this)} title='Multiple ranges' titleStyle={{ fontFamily: 'inherit', fontWeight: '499' }} id='multipleRange' orientation='Vertical' width='150px' height='350px' background='transparent' ref={multipleRangeInstance => multipleRange = multipleRangeInstance}>
                        <AxesDirective>
                            <AxisDirective line={{ width: 5 }} minorTicks={{ interval: 10, height: 3, position: 'Outside' }} majorTicks={{ interval: 20, height: 7, width: 1, position: 'Outside' }} labelStyle={{ position: 'Outside', font: { fontFamily: 'inherit' } }} minimum={0} maximum={100} opposedPosition={true}>
                                <PointersDirective>
                                    <PointerDirective width={0}>
