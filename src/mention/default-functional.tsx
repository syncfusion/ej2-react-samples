...
const Default = () => {
  ...
  const emailFields: object = { text: 'EmailId' };
  const emailTarget: string = '#emailsMention';
  const commentTarget: string = '#commentsMention';
  const commentFields: Object = { text: 'Name' };
