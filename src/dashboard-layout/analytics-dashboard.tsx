...
export class SEODashboard extends SampleBase<{}, {}> {
    ...
    public visitorsChart(): JSX.Element{
        return(
            <div style={{height:"100%", width:"100%"}}>
    ...
    public pieChart(): JSX.Element{
        return(
            <div style={{height:"100%", width:"100%"}}>
                 <AccumulationChartComponent id='pieChart'
              legendSettings={{ visible: false }}
              enableSmartLabels={true}
              height="100%"
              width="100%"
                  ...
                  <ChartComponent id='colChart' style={{ textAlign: "center" }}
                     ...
                     legendSettings={{ visible: false }}
                        ...
                        <SeriesCollectionDirective>
                            ...
                            } xName='x' yName='y' name='Desktop' type='Column'
                            ...
                            } xName='x' yName='y' name='Tablet' type='Column'
                                marker={{ dataLabel: { visible: false, position: 'Top', font: { fontWeight: '600', color: '#ffffff' } } }}>
                            </SeriesDirective>
                        </SeriesCollectionDirective>
                    </ChartComponent>
