...
function PredefinedLayouts() {
  ...
  const headerCount: number = 1;
  let panels: any = panelData;
      ...
      <div>
        <div className="col-lg-8 control-section" id="predefine_control">
          <div className="content-wrapper" style= {{"maxWidth": "100%"}}>
            <DashboardLayoutComponent created={ onCreate.bind(this) } columns={6} ref={(scope) => { (dashboardObj as any) = scope; }} id="predefine_dashboard" cellSpacing={cellSpacing} >
              <PanelsDirective>
