...
export class Special extends SampleBase {
    constructor() {
        super(...arguments);
        this.dateValue = new Date('1/7/2017');
    }
    ...
    render() {
        return (<div className='control-pane'>
                ...
                <div id='description'>
                    ...
                    <p>More information on the DatePicker customization can be found in the <a href="https://ej2.syncfusion.com/react/documentation/datepicker/customization/" target="_blank"> documentation section</a>.
          </p>
                </div>
            </div>);
    }
