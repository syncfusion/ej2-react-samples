        ...
        return (
            <div className='control-pane'>
                ...
                <div className='control-section'>
                    <Chart3DComponent id='charts' style={{ textAlign: "center" }} axisLabelRender={this.labelRender.bind(this)} legendSettings={{ enableHighlight: true, visible: false }} primaryXAxis={{
                        valueType: 'Category',
                        labelRotation: -45,
                        ...
                        }} load={this.load.bind(this)} enableRotation={true} rotation={7} tilt={10} depth={100} tooltip={{ enable: true, header: "${point.x}", format: 'Sales Count : <b>${point.y}' }} width={Browser.isDevice ? '100%' : '75%'} title='Top Selling Electric Cars in China' loaded={this.onChartLoad.bind(this)} >
