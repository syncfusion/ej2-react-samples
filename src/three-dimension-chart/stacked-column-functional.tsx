        ...
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <Chart3DComponent id='charts' style={{ textAlign: "center" }} legendSettings={{ enableHighlight: true }} primaryXAxis={{
                    ...
                    interval: 10
                }} wallColor='transparent' height="400" width={Browser.isDevice ? '100%' : '75%'} load={load.bind(this)} title='Steel Production by Countries, Grouped by Continent' loaded={onChartLoad.bind(this)} tooltip={{ enable: true, format: '${point.x} : <b>${point.y} Mmt' }} axisLabelRender={axisLabelRender.bind(this)} rotation={7} tilt={10} depth={100} enableRotation={true}>
