        ...
        return (
            <div className='control-pane'>
                ...
                <div id="description">
                    ...
                    <p>
                        More information on the 3D chart can be found in this <a target="_blank" href="http://ej2.syncfusion.com/react/documentation/chart/chart-types/#column-charts" aria-label="Navigate to the documentation for React 3D column chart">documentation section</a>.
                    </p>
                </div>
            </div>
        )
