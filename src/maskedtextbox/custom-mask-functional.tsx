        ...
        <div className='control-pane'>
            <div className='control-section'>
                <div className="content-wrapper sample-mask">
                    <div className="control-label">Time (ex: 10:00 PM, 10:00 AM)</div>
            ...
            <div id="description">
                ...
                <p>
                    You can form the <b><a href="https://ej2.syncfusion.com/react/documentation/api/maskedtextbox/#mask" target="_blank">mask</a></b> with any non-mask elements (literals), and you can configure the behavior of that non-mask element as mask element
                    through the <b><a href="https://ej2.syncfusion.com/react/documentation/api/maskedtextbox/#customcharacters" target="_blank">customCharacters</a></b> property.
                </p>
                ...
                <p>
                    For more information, you can refer to the <b><a href="https://ej2.syncfusion.com/react/documentation/maskedtextbox/mask-configuration/#custom-characters" target="_blank">Custom characters</a></b> and
                    <b><a href="https://ej2.syncfusion.com/react/documentation/maskedtextbox/mask-configuration/#regular-expression" target="_blank">Regular expression</a></b> sections from the documentation.
                </p>
            </div>
        </div>
    )
