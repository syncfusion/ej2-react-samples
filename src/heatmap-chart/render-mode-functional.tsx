...
function RenderMode() {
    ...
    function svg(args: ChangeEventArgs): void {
        heatmap.renderingMode = 'SVG';
        heatmap.dataBind();
    }

    function canvas(args: ChangeEventArgs): void {
                                ...
                                <td style={{ width: '40%' }}>
                                    <div className='row'>
                                        <RadioButtonComponent id='svg' checked={true} label='SVG' name='renderingmode'
                                            value="SVG" change={svg.bind(this)}></RadioButtonComponent>
                                    </div>
                                    <div className='row'>
                                        <RadioButtonComponent id='canvas' label='Canvas' name='renderingmode'
                                            value="Canvas" change={canvas.bind(this)}></RadioButtonComponent>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
