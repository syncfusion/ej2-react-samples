    ...
    return (
        <div>
            <div className='col-md-9 control-section'>
                ...
                {/* custom code end */}
                <HeatMapComponent id='heatmap-container' ref={heatmap} titleSettings={title} xAxis={xAxis} yAxis={yAxis} dataSource={(data as any).legentSampleData} cellSettings={cellSettings} tooltipRender={legendTooltip} paletteSettings={paletteSettings} load={load.bind(this)} legendSettings={legendSettings}>
            ...
            <div id="description">
                <p>
                    ...
                    position of legend to left, right, bottom and top by using the <code>position </code> property in <code> legendSettings</code>.
                </p>
