    ...
    return (
        <main><div>
            <div className='col-md-9 control-section'>
                ...
                {/* custom code end */}
                <HeatMapComponent id='heatmap-container' ref={heatmap} titleSettings={title} tooltipSettings={{ textStyle:{ fontFamily:'inherit' } }} xAxis={xAxis} yAxis={yAxis} dataSource={(data as any).renderModeData} paletteSettings={paletteSettings} renderingMode={renderingMode} cellSettings={cellSettings} load={load.bind(this)} legendSettings={legendSettings}>
