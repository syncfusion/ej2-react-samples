...
import { HeatMapComponent, Tooltip, ILoadedEventArgs, HeatMapTheme, Inject, ITooltipEventArgs, TitleModel, AxisModel, PaletteSettingsModel } from '@syncfusion/ej2-react-heatmap';
    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <HeatMapComponent id='heatmap-container' titleSettings={title} xAxis={xAxis} yAxis={yAxis} paletteSettings={paletteSettings} legendSettings={{ visible: false }} load={load.bind(this)} tooltipRender={tooltipTemplate} dataSource={arrayRowData}>
