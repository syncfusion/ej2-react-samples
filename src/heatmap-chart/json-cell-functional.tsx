    ...
    return (
        <main><div className='control-pane'>
            ...
            <div className='control-section'>
                <HeatMapComponent id='heatmap-container' titleSettings={title} xAxis={xAxis} tooltipSettings={{ textStyle: {fontFamily: 'inherit'}}} legendSettings={{ textStyle: { fontFamily: 'inherit' }}}  yAxis={yAxis} dataSourceSettings={dataSourceSettings} dataSource={jsonCellData} cellSettings={cellSettings} load={load.bind(this)} paletteSettings={paletteSettings}>
