...
function LocalData() {
    ...
    let fields: object = { dataSource: data.hierarchicalData, value: 'code', text: 'name', child: 'countries' };

    // Self-referential list data source for Dropdown Tree component
    let listfields: object = { dataSource: data.localData, value: 'id', parentValue: 'pid', text: 'name', hasChildren: 'hasChild' };
