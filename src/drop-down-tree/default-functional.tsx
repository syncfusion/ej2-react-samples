 ...
 */
 ...
 function Default() {
   ...
   let ddTree: DropDownTreeComponent;
   let fields: object = { dataSource: data.defaultData, value: 'id', text: 'name', child: 'subChild' };
     ...
     <div className='control-pane dropdowntree-default'>
       <div className='control-section'>
         <div className='col-lg-8'>
           <div id="default">
             <DropDownTreeComponent ref={(dropdowntree) => { ddTree = dropdowntree }} fields={fields} change={onChange.bind(this)} changeOnBlur={false} placeholder="Select a folder or file" popupHeight="200px" />
           </div>
         </div>
