...
export class HamburgerMenu extends SampleBase {
    constructor() {
        super();
    ...
    modeChange(args) {
        let container = document.querySelector('#layoutcontainer');
        switch (args.value) {
            case 'Mobile':
            case 'Tablet':
                this.menuObj.close();
                        ...
                        <div id="hamburgerMenu">
                            <div id='layoutcontainer' className="deviceLayout">
                                ...
                                <div className="layout-menu">
                                    <div id="container">
                                    <MenuComponent id="menu" items={this.data.hamburgerData} showItemOnClick={this.state.showItemOnClick} hamburgerMode={this.state.hamburgerMode} ref={(scope) => { this.menuObj = scope; }} created={this.menuCreated.bind(this)}></MenuComponent>
                                    </div>
                                </div>
