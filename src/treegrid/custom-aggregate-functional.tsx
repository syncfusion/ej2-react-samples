    ...
    <div className='control-pane'>
      ...
      <div className='control-section'>
        <TreeGridComponent dataSource={summaryData} treeColumnIndex={1} childMapping='subtasks' height='400'
          ref={treegrid => treegridObj = treegrid} dataBound={dataBound.bind(this)}>
          <ColumnsDirective>
            ...
            <AggregateDirective showChildSummary={false}>
              <AggregateColumnsDirective>
                <AggregateColumnDirective columnName='category' type='Custom'
                  customAggregate={customAggregateFn.bind(this)} footerTemplate={custom}> </AggregateColumnDirective>
              </AggregateColumnsDirective>
            </AggregateDirective>
          </AggregatesDirective>
