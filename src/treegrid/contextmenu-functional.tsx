...
function TreeContextMenu() {
  ...
  const contextMenuItems: any = ['AutoFit', 'AutoFitAll',
    ...
    <div className='control-pane'>
      <div className='control-section'>
        <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' height='350' allowPaging={true}
          editSettings={editSettings} pageSettings={pageSettings} contextMenuItems={contextMenuItems} allowSorting={true}
          ...
          <ColumnsDirective>
            ...
            <ColumnDirective field='taskName' headerText='Task Name' width='190' validationRules={validationRule}></ColumnDirective>
            <ColumnDirective field='startDate' headerText='Start Date' width='130' textAlign='Right'
              editType='datepickeredit' type='date' format='yMd' validationRules={validationRule1} />
