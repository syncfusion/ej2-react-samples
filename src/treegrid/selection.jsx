    ...
    render() {
        ...
        <div className='control-section'>
          <div className='col-md-9'>
            <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' allowPaging='true' allowSelection='true' selectionSettings={{ type: 'Multiple' }} pageSettings={{ pageSize: 10 }} ref={treegrid => this.treegridObj = treegrid}>
            <ColumnsDirective>
            ...
            <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
              <tr>
                ...
                <td style={{ width: '70%', paddingRight: '10px' }}>
                   <div>
                      <DropDownListComponent width="90px" id="type" change={this.typeChange.bind(this)} dataSource={this.types} fields={{ text: 'type', value: 'id' }} value="Multiple" ref={dropdown => this.typeDropdownObj = dropdown}/>
                   </div>
                </td>
              </tr>
              <tr>
                ...
                <td style={{ width: '70%' }}>
                   <div style={{ paddingRight: '10px', paddingBottom: '10px' }}>
                      <DropDownListComponent width="90px" id="mode" change={this.modeChange.bind(this)} dataSource={this.modes} fields={{ text: 'mode', value: 'id' }} value="Row" ref={dropdown => this.modeDropdownObj = dropdown}/>
                   </div>
                </td>
              </tr>
              <tr id='cellselection' style={{ display: 'none' }}>
                ...
                <td style={{ width: '70%' }}>
                   <div style={{ paddingRight: '10px', paddingBottom: '10px' }}>
                      <DropDownListComponent width="90px" id="cellmode" change={this.cellmodeChange.bind(this)} dataSource={this.cellmodes} fields={{ text: 'mode', value: 'id' }} value="Flow"/>
                   </div>
                </td>
              </tr>
            </table>
