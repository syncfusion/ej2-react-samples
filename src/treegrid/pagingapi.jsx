    ...
    render() {
        ...
        <div className='control-section'>
          <div className='col-md-9'>
            <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' allowPaging='true' ref={treegrid => this.treegridObj = treegrid} pageSettings={{ pageCount: 2 }}>
              <ColumnsDirective>
              ...
              <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
                  ...
                  <tr className='con-prop1'>
                    ...
                    <td style={{ width: '50%', paddingTop: '10px 10px 10px 0px' }}>
                      <div id='dropdown'>
                        <DropDownListComponent width="90px" id="sizemode" change={this.change.bind(this)} dataSource={this.type} fields={{ text: 'type', value: 'id' }} value="All" ref={dropdown => this.sizemodeObj = dropdown}/>
                      </div>
                    </td>
                  </tr>
                  <tr className='con-prop2'>
                    ...
                    <td style={{ width: '50%', paddingTop: '10px 10px 10px 0px' }}>
                      <div id='numericbox'>
                        <NumericTextBoxComponent id='pagesize' format='##' min={1} max={200} value={12} width='110px' ref={numeric => this.pageSizeObj = numeric} change={this.changeNum.bind(this)}>
                  ...
                  <tr className='con-prop2'>
                    ...
                    <td style={{ width: '50%', paddingTop: '10px 10px 10px 0px' }}>
                      <div id='numericbox'>
                        <NumericTextBoxComponent id='pagecount' format='##' min={1} max={4} value={2} width='110px' ref={numeric => this.pageCountObj = numeric} change={this.countChange.bind(this)}>
                        </NumericTextBoxComponent>
                      </div>
                    </td>
                  </tr>
                  <tr className='con-prop2'>
                    ...
                    <td style={{ width: '50%', paddingTop: '10px 10px 10px 0px' }}>
                      <div id='numericbox'>
                        <NumericTextBoxComponent id='currentpage' format='##' min={1} max={17} value={1} width='110px' ref={numeric => this.currentPageObj = numeric} change={this.currentPageChange.bind(this)}>
                        </NumericTextBoxComponent>
                      </div>
                    </td>
                  </tr>
