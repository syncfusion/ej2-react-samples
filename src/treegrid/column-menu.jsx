...
import { TreeGridComponent, ColumnsDirective, ColumnDirective, Page, Inject, ColumnMenu, Sort, Resize, Filter } from '@syncfusion/ej2-react-treegrid';
...
export class TreeGridColumnMenu extends SampleBase {
    render() {
        ...
        <div className='control-section'>
          <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' allowPaging='true' pageSettings={{ pageSize: 10 }} allowSorting='true' allowFiltering='true' showColumnMenu='true' filterSettings={{ type: 'Menu' }}>
            <ColumnsDirective>
