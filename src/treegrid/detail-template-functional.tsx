...
function DetailTemplate() {
    ...
    function detailtemplate(props): any {
            ...
            <div>
                ...
                <div style={{ paddingLeft: '10px', display: 'inline-block', width: '66%', fontSize: '13px', fontFamily: 'Segoe UI' }}>
                    <div className="e-description" style={{ marginTop: '5px' }}>
                        <b>{props.Name}</b> was born on {format(props.DOB)}. Now lives at {props.Address}, {props.Country}. {props.Name} holds a position of <b>{props.Designation}</b> in our WA department, (Seattle USA).</div>
                    <div className="e-description" style={{ marginTop: '5px' }}>
    ...
    return (
        <div className='control-pane'>
            <div className='control-section'>
                <TreeGridComponent dataSource={textdata} childMapping='Children' detailTemplate={template.bind(this)} treeColumnIndex={0} height='335' >
                    <ColumnsDirective>
            ...
            <div id="description">
                <p>
                    ...
                    property accepts either string or HTML elements ID value, which will be used as the template for the detail
                    row.
                </p>
