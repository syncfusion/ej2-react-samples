    ...
    return (
        <div className="control-pane">
            ...
            <div id="action-description">
                <p>
                    This sample demonstrates the Tree Grid component with the detail
                    template feature.
                </p>
            </div>
            <div id="description">
                <p>
                    The detail row template provides an additional information about a
                    data row. The
                    <code>
                        <a
                            target="_blank"
                            className="code"
                            href="https://ej2.syncfusion.com/react/documentation/treegrid/row/#detail-template"
                        >
                            detailTemplate
                        </a>
                    </code>
                    property accepts either string or HTML elements ID value, which will
                    be used as the template for the detail row.
                </p>
                <p>
                    In this demo, we have presented Employee Information with image in the
                    detail row.
                </p>
                <p>
                    Injecting Module: Tree Grid features are segregated into individual
                    feature-wise modules. To use detail template feature, we need to
