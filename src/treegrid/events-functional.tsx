      ...
      <div className='control-section'>
        <div className='col-md-9'>
          <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' height='350' allowPaging={true}
            ref={treegrid => treegridObj = treegrid} editSettings={{ allowEditing: true }} allowReordering={true}
            allowSorting={true} pageSettings={{ pageCount: 5 }} load={load.bind(this)} created={created.bind(this)}
            actionBegin={actionBegin.bind(this)} actionComplete={actionComplete.bind(this)}
            dataBound={dataBound.bind(this)} rowSelecting={rowSelecting.bind(this)} rowSelected={rowSelected.bind(this)}
            columnDrag={columnDrag.bind(this)} columnDragStart={columnDragStart.bind(this)}
            columnDrop={columnDrop.bind(this)} beginEdit={beginEdit.bind(this)} collapsing={collapsing.bind(this)}
            collapsed={collapsed.bind(this)} expanded={expanded.bind(this)} expanding={expanding.bind(this)} >
            <ColumnsDirective>
              ...
              <tr>
                <td>
                  <div className='evtbtn' style={{ paddingBottom: '10px' }}>
                    <ButtonComponent onClick={btnClick.bind(this)}> Clear </ButtonComponent>
                  </div>
                </td>
              </tr>
            </table>
