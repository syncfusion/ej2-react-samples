  ...
  return (
    <div className="control-pane">
      ...
      <div id="action-description">
        <p>
          This sample demonstrates the default rendering of the Tree Grid with
      ...
      <div id="description">
        <p>
          ...
          controls. It represents the data from <code>DataManager</code>
          binding data fields to columns or self-referential datasource.
        </p>
        <p>
          In this demo, the Tree Grid is populated with its minimum default
          settings.
        </p>
        <p>
