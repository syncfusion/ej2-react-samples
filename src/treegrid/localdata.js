    ...
    LocalData.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This demo shows the way of binding an array of JavaScript objects (local JSON datasource) to TreeGrid.")),
            React.createElement("div", { id: 'description' },
                React.createElement("p", null,
                    ...
                    "."),
                React.createElement("p", null, "In this demo, the array of JavaScript objects is assigned as the data source to the TreeGrid."),
