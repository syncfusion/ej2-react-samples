  ...
  return (
    <div className="control-pane">
      ...
      <div id="action-description">
        <p>
          This sample demonstrates the row height feature of the Tree Grid. In
          this demo, the rowHeight for all the Tree Grid rows can be changed as
          20px, 40px and 60px through ToolBar button click.
        </p>
      </div>
      <div id="description">
        <p>
          Tree Grid has provide an option to customize the row height by using{" "}
          <code>rowHeight</code> property of Tree Grid.
        </p>
        <p>
