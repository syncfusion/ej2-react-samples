...
export class CellAlign extends SampleBase {
    ...
    change(args) {
        ...
        let alignment = this.treegridObj.getColumnByField(columnName).textAlign;
        this.dropdownObj2.value = alignment;
    }
    change2(args) {
        let alignment = args.value;
              ...
              <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
                  ...
                  <tr style={{ height: '50px' }}>
                     ...
                     <td style={{ width: '50%', padding: '10px 10px 10px 0px' }}>
                        <div>
                        <DropDownListComponent width="120px" id="alignment" change={this.change2.bind(this)} dataSource={this.alignment} fields={{ text: 'name', value: 'id' }} value="Right" popupWidth='100%' ref={dropdown => this.dropdownObj2 = dropdown}/>
                        </div>
                     </td>
                  </tr>
              </table>
