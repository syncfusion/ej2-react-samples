    ...
    render() {
        ...
        <div className='control-section'>
          <div className='col-md-8'>
            <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' allowPaging='true' ref={treegrid => this.treegridObj = treegrid} pageSettings={{ pageSize: 10 }} gridLines='Vertical'>
              <ColumnsDirective>
          ...
          <PropertyPane title='Properties'>
              <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
                  ...
                  <td style={{ width: '60%' }}>
                    ...
                    <td style={{ width: '60%' }}>
                      <div>
                         <DropDownListComponent width="120px" id="selmode" change={this.change.bind(this)} dataSource={this.lines} fields={{ text: 'type', value: 'id' }} value="Vertical"/>
                      </div>
                    </td>
                  </tr>
              </table>
