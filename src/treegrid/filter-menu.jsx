    ...
    render() {
        ...
        <div className='control-section'>
          <div className='col-md-9'>
           <TreeGridComponent dataSource={sampleData} ref={treegrid => this.treegridInstance = treegrid} treeColumnIndex={1} childMapping='subtasks' allowPaging='true' allowFiltering='true' filterSettings={{ type: 'Menu', hierarchyMode: 'Parent' }}>
            <ColumnsDirective>
        ...
        <div className='col-md-3 property-section'>
          <PropertyPane title='Properties'>
              ...
              <tr>
                    ...
                    <td style={{ width: '60%' }}>
                      <div>
                         <DropDownListComponent width="120px" id="seltype" change={this.onChange.bind(this)} dataSource={this.filterType} value="Menu"/>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td style={{ width: '60%' }}>
                      <div>
                         <DropDownListComponent width="120px" id="selmode" change={this.onChange2.bind(this)} dataSource={this.modes} value="Parent"/>
                      </div>
                    </td>
                  </tr>
              </table>
