...
function SortingAPI() {
  ...
  let columnName: DropDownListComponent;
  let sortDirection: DropDownListComponent;
  ...
  function btnClick(): void {
    let columnNam: string = columnName.value as string;
    let sortType: string = sortDirection.value as string;
    treegridObj.sortByColumn(columnNam, sortType as SortDirection, false);
  }
      ...
      <div className='control-section'>
        <div className='col-md-9'>
          <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' height='410'
            ref={treegrid => treegridObj = treegrid} allowSorting={true}>
            <ColumnsDirective>
            ...
            <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
              <tr>
                ...
                <td style={{ width: '80%', paddingRight: '10px' }}>
                  <div>
                    <DropDownListComponent width="120px" id="columns" ref={columnname => columnName = columnname}
              ...
              <tr>
                ...
                <td style={{ width: '80%', paddingRight: '10px' }}>
                  <div>
                    <DropDownListComponent width="120px" id="direction" ref={sortdirection => sortDirection = sortdirection}
                      dataSource={direction} fields={{ text: 'name', value: 'id' }} value="Ascending" />
                  </div>
                </td>
              </tr>
              <tr>
                <td style={{ width: '30%' }}>
                  <div>
                    <ButtonComponent onClick={btnClick.bind(this)}> Sort </ButtonComponent>
                  </div>
                </td>
