...
export class RemoteData extends SampleBase {
    constructor() {
        super(...arguments);
        this.data = new DataManager({ url: 'https://ej2services.syncfusion.com/production/web-services/api/SelfReferenceData',
            adaptor: new WebApiAdaptor });
    }
    render() {
        return (<div className='control-pane'>
        <div className='control-section'>
          <TreeGridComponent dataSource={this.data} ref={treegrid => this.treegridInstance = treegrid} hasChildMapping='isParent' pageSettings={{ pageCount: 3 }} treeColumnIndex={1} allowPaging='true' idMapping='TaskID' parentIdMapping='parentItem'>
            <ColumnsDirective>
