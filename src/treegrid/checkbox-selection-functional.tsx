  ...
  return (
    <div className="control-pane">
      ...
      <div id="action-description">
        <p>
          This sample demonstrates the selection functionality of the Tree Grid
          using checkbox selection, To select and unselect all rows use header
          checkbox. To select/unselect particular row, click the desired row.
        </p>
      </div>
      <div id="description">
        <p>
          ...
          column type as <code>checkbox</code> using{" "}
          <code>columns-&gt;type</code> property.
        </p>
        <p>
          Selection can be persisted on all the operations using{" "}
          <code>selectionSettings-&gt; persistSelection</code> property. For
          persisting selection on the Tree Grid, any one of the column should be
          defined as a primary key using <code> columns-&gt;isPrimaryKey</code>{" "}
          property.
        </p>
        <p>
          In this demo, Tree Grid mutliple selection has been enabled with
