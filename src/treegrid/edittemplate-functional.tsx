...
function EditTemplate() {
  ...
  const editSettings: any = {
    allowEditing: true, allowAdding: true, allowDeleting: true, mode: 'Row',
  ...
  const editTemplate: IEditCell = {
    ...
    write: (args: { rowData: Object, column: Column }) => {
      autoCompleteobj = new AutoComplete({
        dataSource: treegridObj.grid.dataSource as { key: string, value: any }[],
    ...
    <div className='control-pane'>
      <div className='control-section'>
        <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' height='400'
          editSettings={editSettings} toolbar={toolbarOptions} ref={treegrid => treegridObj = treegrid}>
          <ColumnsDirective>
            ...
            <ColumnDirective field='progress' headerText='Progress' width='150' textAlign='Right' editType='numericedit'
              validationRules={durationRule} edit={editparams2} />
            <ColumnDirective field='priority' headerText='Priority' width='130' textAlign='Right' editType='stringedit'
