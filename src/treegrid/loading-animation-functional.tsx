...
function LoadingAnimation() {
    ...
    function indicatorChange(e): void {
        if (indicatorDropDown.value === 'Shimmer') {
            treegridInstance.loadingIndicator.indicatorType = 'Shimmer';
        } else {
            treegridInstance.loadingIndicator.indicatorType = 'Spinner';
        }
        ...
        <div className='control-pane'>
            <div className='control-section'>
                <div className = 'col-md-9'>
                    <TreeGridComponent id="TreeGrid" dataSource={data} ref={treegrid => treegridInstance = treegrid} hasChildMapping='isParent' height='400'
