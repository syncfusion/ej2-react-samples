  ...
  function toolbarClick(args: ClickEventArgs): void {
    switch (args.item.id) {
      case treegridInstance.grid.element.id + '_pdfexport':
        if (treegridInstance.enableRtl === true && treegridInstance.locale === 'ar') {
      ...
      <div className='control-section'>
        <div className='col-md-9'>
          <TreeGridComponent dataSource={sampleData} ref={treegrid => treegridInstance = treegrid} treeColumnIndex={1}
            childMapping='subtasks' toolbar={toolbarOptions} toolbarClick={toolbarClick.bind(this)} height='410'
