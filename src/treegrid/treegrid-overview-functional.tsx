...
function Overview () {
  ...
  function treegridTemplate(props): any {
    return (<div className='statustemp'>
        <span className='statustxt'>{props.gdp} %</span>
    </div>);
  }

  function treeratingTemplate(props): any {
    if (props.rating) {
  ...
  function treeunemployTemplate(props): any {
  ...
  function treelocationTemplate(props): any {
  ...
  function treeareaTemplate(props): any {
    return (<span>{props.area} km<sup>2</sup></span>);
  }

  function treezoneTemplate(props): any {
    let classValue = '';
  ...
  function populationValue(field: string, data: Object) {
    ...
    <div className='control-pane'>
      <div className='control-section'>
        ...
        queryCellInfo={queryCellinfo.bind(this)}>
          <ColumnsDirective>
            <ColumnDirective field='name' headerText='Province' width='195' template={flagtemplate} filter={provinceFilter}></ColumnDirective>
            <ColumnDirective field='population' headerText='Population (Million)' allowFiltering={false} valueAccessor={populationValue} textAlign='Right' width='200'></ColumnDirective>
            <ColumnDirective field='gdp' headerText='GDP Rate %' width='155' template={gdptemplate} />
            <ColumnDirective field='rating' headerText='Credit Rating' width='190' template={ratingtemplate}  />
            <ColumnDirective field='unemployment' headerText='Unemployment Rate' width='200' allowFiltering={false} template={unemploymentTemplate} />
            <ColumnDirective field='coordinates' headerText='Coordinates' allowSorting={false} width='220' template={locationtemplate} />
            <ColumnDirective field='area' headerText='Area' width='140' template={areatemplate} />
            <ColumnDirective field='timezone' headerText='Time Zone' width='150' template={timezonetemplate} />
          </ColumnsDirective>
