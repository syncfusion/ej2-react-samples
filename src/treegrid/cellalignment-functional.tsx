...
function CellAlign() {
  ...
  function change(args: ChangeEventArgs): void {
    ...
    let alignment: any = treegridObj.getColumnByField(columnName).textAlign;
    dropdownObj2.value = alignment;
  }
            ...
            <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
              <tr style={{ height: '50px' }}>
                ...
                <td style={{ width: '70%', paddingRight: '10px' }}>
                  <div>
                    <DropDownListComponent width="95px" id="columns" change={change.bind(this)}
              ...
              <tr style={{ height: '50px' }}>
                ...
                <td style={{ width: '70%', padding: '10px 10px 10px 0px' }}>
                  <div>
                    <DropDownListComponent width="95px" id="alignment" change={change2.bind(this)}
                      dataSource={alignment} fields={{ text: 'name', value: 'id' }} value="Right"
