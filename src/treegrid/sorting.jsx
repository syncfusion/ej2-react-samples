...
export class Sorting extends SampleBase {
    constructor() {
        super(...arguments);
        this.sortingOptions = { columns: [{ field: 'Category', direction: 'Ascending' },
    ...
    render() {
        ...
        <div className='control-section'>
          <div className='col-md-9'>
            <TreeGridComponent dataSource={sortData} treeColumnIndex={0} childMapping='subtasks' allowPaging='true' allowSorting='true' sortSettings={this.sortingOptions} ref={treegrid => this.treegridObj = treegrid} actionComplete={this.sort.bind(this)}>
            <ColumnsDirective>
