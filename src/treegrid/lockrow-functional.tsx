...
function LockRow() {
  ...
  const editSettings: any = { allowEditing: true, mode: 'Row', newRowPosition: 'Child' };
  ...
  function rowDataBound(args: RowDataBoundEventArgs): void {
    ...
    if ((multiselectObj.value as Object[]).indexOf(args.data[key]) !== -1) {
  ...
  function beginEdit(args: BeginEditArgs): void {
    let key: string = 'taskID';
    if ((multiselectObj.value as Object[]).indexOf(args.rowData[key]) !== -1) {
      args.cancel = true;
    }
  }
      ...
      <div className='control-section'>
        <div className='col-md-9'>
          <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' height='350' allowPaging={true}
            ...
            enableHover={false} rowDataBound={rowDataBound.bind(this)} ref={treegrid => treegridObj = treegrid}
            beginEdit={beginEdit.bind(this)}>
            <ColumnsDirective>
              <ColumnDirective field='taskID' headerText='Task ID' width='100' textAlign='Right' validationRules={validationRule}
              ...
              <ColumnDirective field='startDate' headerText='Start Date' width='130' textAlign='Right'
                editType='datepickeredit' format='yMd' validationRules={validationRule2} />
              <ColumnDirective field='duration' headerText='Duration' width='100' editType='numericedit' textAlign='Right'
                validationRules={validationRule3} edit={editparams2} />
            </ColumnsDirective>
