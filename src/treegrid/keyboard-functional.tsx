...
const KeyBoard = () => {
    ...
    const editparams: any = { params: { format: "n" } };
    ...
    return (
        <div className="control-pane">
            ...
            <div id="action-description">
                <p>
                    This demo showcases the keyboard shortcuts applicable on Tree Grid and
                    also lists out in below description, how those applicable shortcuts
                    interacts with Tree Grid actions.
                </p>
            </div>
            <div id="description">
                <p>
                    All the Tree Grid actions can be controlled via keyboard keys and is
                    availed by using <code>allowKeyboardInteraction</code>
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>First cell selection</td>
                        </tr>
                        <tr>
                            <td>
                                <code>End</code>
                            </td>
                            <td>Last cell selection</td>
                        </tr>
                        <tr>
                            <td>
                                <code>Up Arrow</code>
                        ...
                        <tr>
                            <td>
                                <code>Shift + Down/Up</code>
                            </td>
                            <td>Multiple row Selection</td>
                        </tr>
                        <tr>
                            <td style={{ width: "70%" }}>
                                <code>Shift + Right/Left/Down/Up</code>
                            </td>
                            <td>Multiple Cell Selection</td>
                        </tr>
                        <tr>
                            <td>
                                <code>Ctrl + Shift + Up Arrow</code>
                            </td>
                            <td>Collapse selected parent row</td>
                        </tr>
                        <tr>
                            <td>
                                <code>Ctrl + Shift + Down Arrow</code>
                            </td>
                            <td>Expand selected parent row</td>
                        </tr>
                        <tr>
                            <td>
                                <code>Alt + j</code>
                            </td>
                            <td>Focus Tree Grid element</td>
                        </tr>
                        <tr>
                            <td>
                                <code>Tab</code>
                            </td>
                            <td>Go to next cell for editing</td>
                        </tr>
                        <tr>
                            <td>
                                <code>Shift + Tab</code>
                            </td>
                            <td>Go to previous cell for editing</td>
                        </tr>
                        <tr>
                            <td>
                                <code>PageDown</code>
                        ...
                        <tr>
                            <td>
                                <code>Ctrl + Alt + PageUp</code>
                            </td>
                            <td>Go to First page</td>
                        </tr>
                        <tr>
                            <td>
                                <code>Ctrl + Alt + PageDown</code>
                            </td>
