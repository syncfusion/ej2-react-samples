...
function SelectionAPI() {
  ...
  let numericObj: NumericTextBoxComponent;
  let numericObj2: NumericTextBoxComponent;

  function btnClick(): void {
    let startRow: number = numericObj.value;
    let toRow: number = numericObj2.value;
    let rows: number[] = [];
    for (let i: number = startRow > toRow ? toRow : startRow; i <= (startRow > toRow ? startRow : toRow); i++) {
      rows.push(i);
    }
    treegridObj.selectRows(rows);
  }
      ...
      <div className='control-section'>
        <div className='col-md-9'>
          <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' height='350' allowPaging={true}
            allowSelection={true} ref={treegrid => treegridObj = treegrid} pageSettings={{ pageSize: 10 }}
          ...
          <PropertyPane title='Properties'>
            <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
              ...
              <tr>
                ...
                <td style={{ width: '80%', paddingRight: '10px' }}>
                  <div id='numericbox' style={{ minWidth: '95px' }}>
                    <NumericTextBoxComponent id='start' format='##' min={0} max={11} ref={numeric => numericObj = numeric}
                      width='95px'>
              ...
              <tr>
                ...
                <td style={{ width: '80%', paddingRight: '10px' }}>
                  <div id='numericbox' style={{ minWidth: '95px' }}>
                    <NumericTextBoxComponent id='to' format='##' min={0} max={11} ref={numeric => numericObj2 = numeric}
                      width='95px'>
                    </NumericTextBoxComponent>
                  </div>
                </td>
              ...
              <tr>
                <td colSpan={2}>
                  <div className='col-md-6'>
                    <ButtonComponent onClick={btnClick.bind(this)}>Select Row</ButtonComponent>
                  </div>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td colSpan={2}>
                  <div className="col-md-6" style={{ paddingBottom: '10px' }}>
                    <ButtonComponent onClick={btnClick2.bind(this)}>Clear Selection</ButtonComponent>
                  </div>
                </td>
              </tr>
            </table>
