...
function Search() {
  ...
  function onChange(sel: ChangeEventArgs): void {
    ...
    treegridInstance.searchSettings.hierarchyMode = mode;
  }
    ...
    <div className='control-pane'>
      <div className='control-section'>
        <div className='col-md-9'>
          <TreeGridComponent dataSource={sampleData} ref={treegrid => treegridInstance = treegrid} treeColumnIndex={1}
            childMapping='subtasks' height='350' allowPaging={true} toolbar={toolbarOptions}>
            <ColumnsDirective>
          ...
          <PropertyPane title='Properties'>
            <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
              <tr>
                ...
                <td style={{ width: '70%' }}>
                  <div>
                    <DropDownListComponent width="100px" id="selmode" change={onChange.bind(this)}
