...
function Selection() {
  ...
  let typeDropdownObj: DropDownListComponent;
  let modeDropdownObj: DropDownListComponent;
  ...
  function typeChange(args: ChangeEventArgs): void {
    let type: any = args.value as string;
    let mode: any = modeDropdownObj.value as string;
  ...
  function modeChange(args: ChangeEventArgs): void {
    let mode: any = args.value;
    let type: any = typeDropdownObj.value as string;
  ...
  function cellmodeChange(args: ChangeEventArgs): void {
            ...
            <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
              <tr>
                ...
                <td style={{ width: '70%', paddingRight: '10px' }}>
                  <div>
                    <DropDownListComponent width="100px" id="type" change={typeChange.bind(this)}
                      dataSource={types} fields={{ text: 'type', value: 'id' }} value="Multiple"
                      ref={dropdown => typeDropdownObj = dropdown} />
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td style={{ width: '70%' }}>
                  <div style={{ paddingRight: '10px', paddingBottom: '10px' }}>
                    <DropDownListComponent width="100px" id="mode" change={modeChange.bind(this)}
                      dataSource={modes} fields={{ text: 'mode', value: 'id' }} value="Row"
                      ref={dropdown => modeDropdownObj = dropdown} />
                  </div>
                </td>
              </tr>
              <tr id='cellselection' style={{ display: 'none' }}>
                ...
                <td style={{ width: '70%' }}>
                  <div style={{ paddingRight: '10px', paddingBottom: '10px' }}>
                    <DropDownListComponent width="100px" id="cellmode" change={cellmodeChange.bind(this)}
                      dataSource={cellmodes} fields={{ text: 'mode', value: 'id' }} value="Flow"
                    />
                  </div>
                </td>
              </tr>
