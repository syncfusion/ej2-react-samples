    ...
    render() {
        ...
        <div className='control-section'>
          <div className='col-md-9'>
            <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' allowPaging='true' ref={treegrid => this.treegridObj = treegrid} pageSettings={{ pageSize: 10 }}>
              <ColumnsDirective>
              ...
              <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
                  ...
                  <td style={{ width: '30%' }}>
                    ...
                    <td style={{ width: '70%', paddingRight: '10px' }}>
                      <div id='columnddl'>
                         <DropDownListComponent width="120px" id="ddlelement" change={this.change.bind(this)} dataSource={this.columnsName} fields={{ text: 'name', value: 'id' }} value="taskID" ref={dropdown => this.dropdownObj = dropdown}/>
                      </div>
                    </td>
                  </tr>
                  <tr>
                     ...
                     <td style={{ width: '70%' }}>
                        <div>
                          <ButtonComponent id='show' created={this.created.bind(this)} ref={button => this.buttonObj2 = button} onClick={this.showClick.bind(this)}> Show </ButtonComponent>
                        </div>
                     </td>
                  </tr>
                  <tr>
