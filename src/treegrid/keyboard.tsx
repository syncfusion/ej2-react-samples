          ...
          <div className = 'col-md-9'>
            <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' height='900' 
              ...
              <ColumnsDirective>
                ...
                <ColumnDirective field='taskName' headerText='Task Name' width='210'
                ...
                <ColumnDirective field='duration' headerText='Duration' width='100' textAlign='Right' editType='numericedit' 
