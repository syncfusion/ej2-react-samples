              ...
              <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
                <tbody>
                  <tr>
                    ...
                    <td style={{ width: '80%', paddingRight: '10px' }}>
                      <div style={{ paddingLeft: '8px' }}>
                        <DropDownListComponent width="146px" id="columns" ref={columnname => this.columnName = columnname}
                  ...
                  <tr>
                    ...
                    <td style={{ width: '80%', paddingRight: '10px' }}>
                      <div style={{ paddingLeft: '8px' }}>
                        <DropDownListComponent width="146px" id="direction" ref={sortdirection => this.sortDirection = sortdirection}
