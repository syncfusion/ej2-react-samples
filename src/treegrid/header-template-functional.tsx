              ...
              <ColumnDirective
                ...
                headerTemplate={() => {
                  return (
                    <div>
                      <img
                        src="src/treegrid/images/__Task name.png"
                        width="20"
                        height="20"
                        className="taskName"
                        alt="taskName"
              ...
              <ColumnDirective
                ...
                headerTemplate={() => {
                  return (
                    <div>
                      <img
                        src="src/treegrid/images/__Start name.png"
                        width="20"
                        height="20"
                        className="startDate"
                        alt="startDate"
              ...
              <ColumnDirective
                ...
                headerTemplate={() => {
                  return (
                    <div>
                      <img
                        src="src/treegrid/images/__Resources.png"
                        width="20"
                        height="20"
                        className="resources"
                        alt="resources"
              ...
              <ColumnDirective
                ...
                headerTemplate={() => {
                  return (
                    <div>
                      <img
                        src="src/treegrid/images/__Duration.png"
                        width="20"
                        height="20"
                        className="duration"
                        alt="duration"
              ...
              <ColumnDirective
                ...
                headerTemplate={() => {
                  return (
                    <div>
                      <img
                        src="src/treegrid/images/__progress.png"
                        width="20"
                        height="20"
