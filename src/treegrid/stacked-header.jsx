...
export class Stacked extends SampleBase {
    render() {
        ...
        <div className='control-section'>
          <TreeGridComponent dataSource={stackedData} treeColumnIndex={1} childMapping='subtasks' allowPaging='true' pageSettings={{ pageCount: 5 }}>
            <ColumnsDirective>
            ...
            { field: 'orderDate', headerText: 'Order Date', width: 120, textAlign: 'Right', format: 'yMd' }]} headerText='Order Details' textAlign='Center'></ColumnDirective>
            ...
            { field: 'units', headerText: 'Units', width: 90, textAlign: 'Left' },]} headerText='Shipment Details' textAlign='Center'></ColumnDirective>
            <ColumnDirective columns={[{ field: 'unitPrice', headerText: 'Price per unit', format: 'C2', type: 'number', textAlign: 'Right', width: 130 },
            { field: 'price', headerText: 'Total Price', width: 130, format: 'C', type: 'number' }]} headerText='Price Details' textAlign='Center'></ColumnDirective>
            </ColumnsDirective>
