export const BulletChartSampleOrder = [
    {
        'path': 'bullet-chart/default',
        'component' : 'BulletChartDefault',
        'name': 'Default',
        'order': '01',
    ...
    },
    {
        ...
        'component' : 'BulletChartRightToLeft',
        'name': 'RTL',
        'category': 'Bullet Chart',
        'order': '01',
        'description': 'This demo for Essential JS2 Bullet Chart control shows the default rendering of bullet graph with data.'
    },
    {
        ...
        'component' : 'BulletChartBarCustomization',
    ...
    },
    {
        ...
        'component' : 'BulletChartCustomization',
