...
import { RichTextEditorComponent, Toolbar, Inject, Image, Table, Link, HtmlEditor, QuickToolbar, IFrameSettingsModel, Audio, Video, EmojiPicker, PasteCleanup, CodeBlock, ImportExport, ClipBoardCleanup, AutoFormat } from '@syncfusion/ej2-react-richtexteditor';
        ...
        <div className='control-section' id='rteIFrame'>
          <div className="content-wrapper">
            <RichTextEditorComponent id="iframeRTE" ref={(richtexteditor) => { this.rteObj = richtexteditor }}
              ...
              <Inject services={[Toolbar, Image, Link, HtmlEditor, Table, QuickToolbar, FileManager, Audio, Video, EmojiPicker, PasteCleanup, CodeBlock, ImportExport, ClipBoardCleanup, AutoFormat]} />
