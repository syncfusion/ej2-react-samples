import { RichTextEditorComponent, HtmlEditor, Toolbar, FormatPainter, QuickToolbar, Link, Image, Table, Audio, Video, ToolbarSettingsModel, Inject, PasteCleanup, ClipBoardCleanup, AutoFormat } from "@syncfusion/ej2-react-richtexteditor";
                ...
                <div className='control-section' id="rteAPI">
                    <div className='rte-control-section'>
                        <RichTextEditorComponent id="formatPainterRTE" ref={(richtexteditor) => { formatPainterRTE = richtexteditor }}
                            ...
                            <Inject services={[HtmlEditor, Toolbar, FormatPainter, QuickToolbar, Image, Link, Table, PasteCleanup, Audio, Video, ClipBoardCleanup, AutoFormat]} />
