...
import { CircularGaugeComponent, AxesDirective, AxisDirective, Inject, Gradient, IAxisLabelRenderEventArgs, PointersDirective, PointerDirective, RangesDirective, RangeDirective, ILoadedEventArgs, GaugeTheme } from '@syncfusion/ej2-react-circulargauge';
    ...
    return (
        <main><div className='control-pane'>
            ...
            <div className='control-section'>
                <CircularGaugeComponent load={load.bind(this)} animationDuration={2000} axisLabelRender={axisLabelRender.bind(this)} id='custom-labels' background='transparent'>
                    <Inject services={[Gradient]} />
                    <AxesDirective>
                        <AxisDirective startAngle={210} endAngle={150} radius='80%' minimum={0} maximum={8} majorTicks={{ width: 0, interval: 1 }} lineStyle={{ width: 0 }} minorTicks={{ width: 0 }} labelStyle={{ offset: 10, font: { fontFamily: 'inherit' } }}>
                            <PointersDirective>
                                <PointerDirective pointerWidth={10} radius='85%' needleStartWidth={10} needleEndWidth={5} value={6.2} color='#E63B86' cap={{ radius: 0, border: { width: 0 } }} needleTail={{ length: '0%' }} animation={{ enable: false }} linearGradient={pointerLinearGradient} />
                            </PointersDirective>
                            <RangesDirective>
                                <RangeDirective start={0} end={6.2} color='#E63B86' startWidth={22} endWidth={22} linearGradient={rangeLinearGradient} />
                                <RangeDirective start={6.2} end={8} color='#E0E0E0' startWidth={22} endWidth={22} />
                            </RangesDirective>
                        </AxisDirective>
                    </AxesDirective>
