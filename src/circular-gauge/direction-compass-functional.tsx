...
import { CircularGaugeComponent, AxesDirective, AxisDirective, Inject, ILoadedEventArgs, GaugeTheme, PointersDirective, PointerDirective, Gradient, IAxisLabelRenderEventArgs } from '@syncfusion/ej2-react-circulargauge';
...
const Direction = () => {
    ...
    const onLabelRender = (args: IAxisLabelRenderEventArgs): void => {
        ...
        <main><div className='control-pane'>
            ...
            <div className='control-section'>
                <CircularGaugeComponent load={load.bind(this)} id='direction-gauge' background='transparent' axisLabelRender={onLabelRender.bind(this)}>
                    ...
                    <AxesDirective>
                        <AxisDirective radius='80%' startAngle={0} endAngle={360} minimum={0} maximum={8} majorTicks={{ height: 15, interval: 1 }} lineStyle={{ width: 20, color: '#E0E0E0' }} minorTicks={{ height: 10, interval: 0.5 }} labelStyle={{ font: { fontFamily: 'inherit' }, autoAngle: true, offset: 10, hiddenLabel: 'Last' }}>
                            <PointersDirective>
                                <PointerDirective value={7} radius='50%' color='#e20a22' pointerWidth={30} linearGradient={pointerLinearGradient} cap={{ radius: 15, color: '#ffffff', border: { width: 0 } }} animation={{ enable: false }} />
                                <PointerDirective value={3} radius='50%' color='#f7f7f7' pointerWidth={30} cap={{ radius: 15, color: '#ffffff', border: { width: 0 } }} animation={{ enable: false }} />
                            </PointersDirective>
                        </AxisDirective>
                    </AxesDirective>
