                    ...
                    <div className="col-xs-4 col-sm-4 col-lg-2 col-md-2" style={{ marginTop: "3%" }}>
                        <div className="panel">
                            <div className="subgauge" style={{ float: "left", marginTop: "1%" }}>
                                <CircularGaugeComponent load={this.loadRedGauge.bind(this)} id='gaugeTwo' background='transparent' height={"65px"} width={"65px"} >
                                    <Inject services={[Annotations]} />
                                    <AxesDirective>
                                        <AxisDirective startAngle={0} endAngle={360} minimum={0} maximum={100}
                                            lineStyle={{ width: 0 }}
                        ...
                        <div className="panel">
                            <div className="subgauge" style={{ float: "left", marginTop: "1%" }}>
                                <CircularGaugeComponent load={this.loadGreenGauge.bind(this)} id='gaugeThree' background='transparent' height={"65px"} width={"65px"} >
                                    <Inject services={[Annotations]} />
                                    <AxesDirective>
                                        <AxisDirective startAngle={0} endAngle={360} minimum={0} maximum={100}
                                            lineStyle={{ width: 0 }}
                        ...
                        <div className="panel">
                            <div className="subgauge" style={{ float: "left", marginTop: "1%" }}>
                                <CircularGaugeComponent load={this.loadBlueGauge.bind(this)} id='gaugeFour' background='transparent' height={"65px"} width={"65px"} >
                                    <Inject services={[Annotations]} />
                                    <AxesDirective>
                                        <AxisDirective startAngle={0} endAngle={360} minimum={0} maximum={100}
                                            lineStyle={{ width: 0 }}
