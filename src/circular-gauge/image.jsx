        ...
        return (<div className='control-pane'>
                ...
                <div className='control-section row'>
                    <div className='col-lg-12'>
                        <CircularGaugeComponent load={this.load.bind(this)} title='Short Put Distance' loaded={this.onChartLoad.bind(this)} id='image-container' ref={gauge => this.gauge = gauge} enablePointerDrag={true} titleStyle={{ size: '18px' }} centerY="57%'">
                            <Inject services={[Annotations]}/>
                            <AxesDirective>
                                <AxisDirective startAngle={200} endAngle={130} radius='90%' minimum={0} maximum={14} lineStyle={{
            ...
            font: {
                size: '0px'
                                    ...
                                    <PointersDirective>
                                        ...
                                        <PointerDirective type="Marker" value={0.1} markerShape="Image" imageUrl="src/circular-gauge/images/girl-1.png" radius='108%' markerWidth={28} markerHeight={28} animation={{ duration: 1500 }}/>
                                        <PointerDirective type="Marker" value={0.1} markerShape="Image" imageUrl="src/circular-gauge/images/man-1.png" radius='78%' markerWidth={28} markerHeight={28} animation={{ duration: 1500 }}/>
                                        <PointerDirective type="Marker" value={0.1} markerShape="Image" imageUrl="src/circular-gauge/images/man-2.png" radius='48%' markerWidth={28} markerHeight={28} animation={{ duration: 1500 }}/>
                                    </PointersDirective>
                                    <RangesDirective>
