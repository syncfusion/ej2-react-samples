...
function Clock() {
    ...
    let annotationGaugeOne: CircularGauge;
    let annotationGaugeTwo: CircularGauge;
    ...
    function onChartLoad(args: ILoadedEventArgs): void {
        annotationGaugeOne = new CircularGauge({
        ...
        annotationGaugeTwo = new CircularGauge({
            width: args.gauge.availableSize.width < 400 ? '75px' : '150px',
            height: args.gauge.availableSize.width < 400 ? '75px' : '150px',
            background: 'transparent',
            axes: [{
        ...
        pointerInterval = setInterval(
            (): void => {
                if (document.getElementById('axis-background')) {
                    if (NeedlePointer <= 12) {
                        NeedlePointer += 0.2;
                        gauge.setPointerValue(0, 2, NeedlePointer);
                    } else {
                        NeedlePointer = 0.2;
                    }
                } else {
    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <CircularGaugeComponent loaded={onChartLoad.bind(this)} resized={onResized.bind(this)} load={load.bind(this)} id='axis-background' background='transparent' ref={g => gauge = g}>
