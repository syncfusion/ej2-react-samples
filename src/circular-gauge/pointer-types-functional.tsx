...
function Pointers() {
    ...
    let needlePointerGauge: CircularGaugeComponent;
    let liveUpdateGauge: CircularGaugeComponent;
            ...
            needleInterval = setInterval(
                (): void => {
                    ...
                    if (document.getElementById('needle-pointer-container')) {
                        needlePointerGauge.setPointerValue(0, 0, newVal);
                    } else {
            ...
            liveUpdateInterval = setInterval(
                (): void => {
                    ...
                    if (document.getElementById('live-update-container') && liveUpdateGauge != null) {
                        liveUpdateGauge.setPointerValue(0, 0, newVal);
                        liveUpdateGauge.setPointerValue(0, 1, newVal);
                    } else {
                        clearInterval(+needleInterval);
                    }
                },
                ...
                <div className="row" style={{ margin: '0px' }}>
                    <div className="col-sm-12" style={{ padding: '0px' }}>
                        <div className="row" style={{ margin: '0px' }}>
                            ...
                            <div className="col-sm-4">
                                <CircularGaugeComponent load={load.bind(this)} style={{ height: "250px" }} centerY='40%' background='transparent' ref={gauge => needlePointerGauge = gauge} loaded={onChartLoad.bind(this)} id='needle-pointer-container'>
                                    <Inject services={[Annotations]} />
                                    <AxesDirective>
                                        <AxisDirective startAngle={270} endAngle={90} radius='90%' minimum={0} maximum={100}
                                            lineStyle={{
                ...
                <div className="row" style={{ margin: '0px' }}>
                    <div className="col-sm-12" style={{ padding: '0px' }}>
                        <div className="row" style={{ margin: '0px' }}>
                            ...
                            <div className="col-sm-4">
                                <CircularGaugeComponent load={load.bind(this)} style={{ height: "250px" }} background='transparent' ref={gauge => liveUpdateGauge = gauge} centerY='40%' loaded={onChartLoad.bind(this)} id='live-update-container'>
                                    <Inject services={[Annotations]} />
                                    <AxesDirective>
                                        <AxisDirective startAngle={270} endAngle={90} radius='90%' minimum={0} maximum={100}
                                            lineStyle={{
