                    ...
                    <AxesDirective>
                        <AxisDirective startAngle={270} endAngle={90} radius='120%' minimum={0} maximum={120} rangeGap={3}
                            ...
                            <PointersDirective>
                                ...
                                <PointerDirective radius='85%' type='Marker' value={60} text='Average' markerShape='Text'
                                    animation={{ enable: false }} textStyle={{ size: '18px', fontFamily: 'inherit' }}
                                >
                                </PointerDirective>
                                <PointerDirective radius='85%' type='Marker' value={100} text='Good' markerShape='Text'
                                    animation={{ enable: false }} textStyle={{ size: '18px', fontFamily: 'inherit' }}
                                >
                                </PointerDirective>
                            </PointersDirective>
