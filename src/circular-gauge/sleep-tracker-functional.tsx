    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <CircularGaugeComponent load={load.bind(this)} axisLabelRender={axisLabelRender.bind(this)} id='custom-labels' ref={g => gauge = g} background='transparent'>
