...
function ProgressBarSemiCircular() {
    ...
    let annotationColors: string[] = ['#e91e63', '#0078D6', '#317ab9', '#007bff', '#4F46E5', '#FFD939', '#9A9A9A', '#22D3EE', '#0D6EFD'];
    let content1: string = '<div id="point1" style="font-size:24px;font-weight:bold;color:#0078D6;fill:#0078D6"><span>100%</span></div>';
    let content2: string = '<div id="point1" style="font-size:24px;font-weight:bold;color:#0078D6;fill:#0078D6"><span>100%</span></div>';
    let content3: string = '<div id="point1" style="font-size:24px;font-weight:bold;color:#0078D6;fill:#0078D6"><span>100%</span></div>';
    let content4: string = '<div id="point1" style="font-size:24px;font-weight:bold;color:#0078D6;fill:#0078D6"><span>100%</span></div>';
    let thickness: number = 5;
                ...
                <div className="row">
                    <div className="col-lg-3 col-md-3 col-3 progress-container">
                        <div className="progress-container-align">
                            <ProgressBarComponent id="angle-container" ref={progress1 => inverseSemiProgress = progress1}
                                type='Circular'
                                startAngle={240}
                                endAngle={120}
                                width='160px'
                    ...
                    <div className="col-lg-3 col-md-3 col-3 progress-container">
                        <div className="progress-container-align">
                            <ProgressBarComponent id="vertical-container" ref={progress2 => verticalProgress = progress2}
                                type='Circular'
                                startAngle={180}
                                endAngle={0}
                                width='160px'
                    ...
                    <div className="col-lg-3 col-md-3 col-3 progress-container">
                        <div className="progress-container-align">
                            <ProgressBarComponent id="vsemi-container" ref={progress3 => verticalOppose = progress3}
                                type='Circular'
                                startAngle={0}
                                endAngle={180}
                                width='160px'
                    ...
                    <div className="col-lg-3 col-md-3 col-3 progress-container">
                        <div className="progress-container-align">
                            <ProgressBarComponent id="semi-container" ref={progress4 => semiProgress = progress4}
                                type='Circular'
                                startAngle={270}
                                endAngle={90}
                                width='160px'
