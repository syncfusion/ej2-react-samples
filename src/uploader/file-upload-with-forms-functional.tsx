      ...
      <div className = 'control-pane'>
			<div className='control-section col-lg-12 uploadpreview'>
                <h4 className="form-title">Photo Contest</h4>
                    <div className="control_wrapper uploader-form" id="control_wrapper">
                        <form id="formTemp"  method="post">
                            ...
                            <div className="form-group" >
                                ...
                                allowedExtensions= {allowedExtensions} multiple = {multiple}></UploaderComponent>
                            </div>
                            <div className="form-group" >
                                <div className="e-float-input">
                    ...
                    <DialogComponent id="defaultdialog" isModal={true} header='Success' showCloseIcon={true} visible ={false} content = 'Your details have been updated successfully, Thank you.' animationSettings={animationSettings} width={'50%'}  ref={dialog => dialogInstance = dialog}
