...
function formSelectedData (file : FileInfo, proxy: any): void {
    ...
    liEle.appendChild(createElement('div', {className: 'file-size', innerHTML: uploadObj.bytesToSize(file.size) }));
    ...
    readURL(liEle, file); document.querySelector('.e-upload-files').appendChild(liEle);
    filesList.push(liEle);
}

function uploadFile(args: any): void {
    uploadObj.upload([filesDetails[filesList.indexOf(args.currentTarget.parentElement)]], true);
}
            ...
            <div className= 'col-lg-9'>
                <div className='imagepreview'>
                    <div id='dropArea' ref={dropAreaRef} className='dropTarget'>
                        ...
                        <UploaderComponent id='previewfileupload' type = 'file' ref={upload => uploadObj = upload}
