...
function ChunkUpload() {
    ...
    function onChange(args: ChangeEventArgs): void {
        uploadObj.asyncSettings.chunkSize = parseInt(args.itemData.value, 10);
    }
    ...
    return (
      <div className = 'control-pane'>
        <div className='control-section row uploadpreview'>
         <div className='col-lg-8'>
          <div className='upload_wrapper'>
            {/* Render Uploader */}
            <UploaderComponent id='chunkUpload' type='file' ref = {(scope) => {uploadObj = scope}}
             asyncSettings = {asyncSettings} autoUpload = {autoUpload}
            removing= {onRemoveFile.bind(this)} pausing= {onPausing.bind(this)} resuming= {onResuming.bind(this)} chunkFailure= {onBeforeFailure.bind(this)}
            ></UploaderComponent>
        </div>
        </div>
            ...
            <PropertyPane title='Properties'>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <DropDownListComponent id="chunksize" index = {value}  dataSource={ddlDatas} ref={(dropdownlist) => {listObj = dropdownlist }} fields={fields} change={onChange.bind(this)} placeholder="Select chunk size" />
                  </td>
                </tr>
                </tbody>
              </table>
        ...
        <p>This <a href="https://www.syncfusion.com/react-ui-components/react-file-upload"
            target="_blank">&nbsp;React File Upload</a> example demonstrates the chunk upload functionalities of the Uploader component.
