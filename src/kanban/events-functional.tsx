        ...
        <div className='kanban-control-section'>
            <div className='col-lg-8 control-section'>
                <div className='control-wrapper'>
                    <KanbanComponent id="kanban" keyField="Status" dataSource={data} swimlaneSettings={{ keyField: "Assignee" }}
                        cardSettings={{ contentField: "Summary", headerField: "Id" }} created={OnCreate.bind(this)} actionBegin={OnActionBegin.bind(this)}
                        actionComplete={OnActionComplete.bind(this)} actionFailure={OnActionFailure.bind(this)} dataBinding={OnDataBinding.bind(this)} dataBound={OnDataBound.bind(this)}
                        cardRendered={OnCardRendered.bind(this)} queryCellInfo={OnQueryCellInfo.bind(this)} cardClick={OnCardClick.bind(this)} cardDoubleClick={OnCardDoubleClick.bind(this)}
