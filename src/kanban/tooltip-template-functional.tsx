...
function TooltipTemplate () {
    ...
    function onToolTipTemplateChange(args: ChangeEventArgs): void {
        (kanbanObj as any).tooltipTemplate = args.checked ? template : null;
    }
        ...
        <div className='kanban-control-section'>
            <div className='col-lg-9 control-section'>
                <div className='control-wrapper'>
                    <KanbanComponent id="kanban" cssClass="kanban-tooltip" keyField="Status" dataSource={data} ref={(kanban) => { kanbanObj = kanban }}
                        cardSettings={{ contentField: "Summary", headerField: "Id" }} enableTooltip={true} tooltipTemplate={template.bind(this)} >
                        <ColumnsDirective>
