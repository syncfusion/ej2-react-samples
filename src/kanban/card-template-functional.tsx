                                            ...
                                            >
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        {props.Category == "Menu" && (
                                                            <td className="card-content">
                                                                <div className="e-size e-tooltip-text">
                                                                    {props.Size}
                                                                </div>
                                                                <div className="e-price e-tooltip-text">
                                                                    {props.Price}
                                                                </div>
                                                            </td>
                                                        )}
                                                        {props.Category != "Menu" && (
                                                            <td className="card-content">
                                                                {props.Category == "Order" && (
                                                                    <div className="e-preparingText e-tooltip-text">
                                                                        Preparing
                                                                    </div>
                                                                )}
                                                                {props.Category === "Ready to Serve" && (
                                                                    <div className="e-readyText e-tooltip-text">
                                                                        Ready to Serve
                                                                    </div>
                                                                )}
                                                                {(props.Category == "Delivered") && (
