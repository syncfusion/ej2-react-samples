...
function Swimlane () {
    ...
    function changeSortOrder(args: DropDownChangeArgs): void {
        kanbanObj.swimlaneSettings.sortDirection = args.itemData.value as SortDirection;
    };
    function onChange(args: ChangeEventArgs): void {
        kanbanObj.swimlaneSettings.allowDragAndDrop = args.checked;
    };
    function changeRow(args: ChangeEventArgs): void {
        kanbanObj.swimlaneSettings.showEmptyRow = args.checked;
    };
    function changeCount(args: ChangeEventArgs): void {
        kanbanObj.swimlaneSettings.showItemCount = args.checked;
    }
    function changeFrozen(args: ChangeEventArgs): void {
        ...
        <div className='kanban-control-section'>
            <div className='col-lg-8 control-section'>
                <div className='control-wrapper'>
                    <KanbanComponent id="kanban" cssClass="kanban-swimlane" ref={(kanban) => { kanbanObj = kanban }} keyField="Status" dataSource={data}
            ...
            <div className='col-lg-4 property-section'>
                ...
                <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
                    <tr>
                        ...
                        <td>
                            <div>
                                <DropDownListComponent id='sort' dataSource={sortData} change={changeSortOrder.bind(this)} value={value} ></DropDownListComponent>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <CheckBoxComponent checked={false} change={changeRow.bind(this)}></CheckBoxComponent>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <CheckBoxComponent checked={true} change={changeCount.bind(this)}></CheckBoxComponent>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <CheckBoxComponent change={changeFrozen.bind(this)}></CheckBoxComponent>
                        </td>
                    </tr>
                    </table>
                </PropertyPane>
