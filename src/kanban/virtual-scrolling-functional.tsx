    ...
    return (
        <div className="kanban-control-section">
            ...
            <div id="action-description">
                <p>
                    This sample demonstrates the Kanban board with the virtual scrolling
                    feature. It configures a large dataset as the data source, allowing
                    smooth navigation and rendering of a significant amount of data while
                    scrolling through Kanban columns.
                </p>
            </div>
            <div id="description">
                <p>
                    ...
                    <code>enableVirtualization</code> property to true.
                </p>
                <p>
                    In this demo, a dataset of 100K items has been configured for the
                    dataSource property. Despite the large dataset, the Kanban board
                    efficiently handles the rendering and interaction, ensuring a smooth
                    user experience. Users can seamlessly navigate and interact with the
                    Kanban board, even with such a significant amount of data.
                </p>
            </div>
        </div>
    );
