...
function DialogEditing () {
    ...
    let data: Object[] = extend([], (dataSource as { [key: string]: Object }).kanbanData, true) as Object[];
    let kanbanObj: KanbanComponent;

    function addClick(): void {
        const cardIds = kanbanObj.kanbanData.map((obj: any) => parseInt(obj.Id.replace('Task ', ''), 10));
            ...
            <div className="col-lg-3 property-section">
                <PropertyPane title='Properties'>
                    <table id="property" title="Properties">
                        <tr>
                            <td>
                                <ButtonComponent id='addNew' className="e-btn e-dialog-add" onClick={addClick.bind(this)}>Add New Card</ButtonComponent>
                            </td>
                        </tr>
                    </table>
                </PropertyPane>
