...
function Workflow () {
    ...
    let data: Object[] = extend([], (dataSource as { [key: string]: Object }).kanbanPizzaData, null, true) as Object[];
            ...
            <div className='kanban-control-section'>
                <div className='col-lg-12 control-section'>
                    <div className='control-wrapper'>
                        <KanbanComponent cssClass="kanban-workflow" id="kanban" keyField="Category" dataSource={data} 
                            cardSettings={{ headerField: "Id", contentField: "Description", template: cardTemplate.bind(this) }}>
                            <ColumnsDirective>
