...
const Drilldown = () => {
    ...
    const breadCrumbChange = (args: ChangeEventArgs) => {
        let value: boolean = args.checked;
    ...
    const drillStart = (args: IDrillStartEventArgs): void => {
        ...
        <main><div className="control-pane">
            ...
            <div className="control-section">
                <div className="col-md-9">
                    <TreeMapComponent
                        drillStart={drillStart.bind(this)}
                                ...
                                <td>
                                    <div className="drilldown-checkbox drilldownCheckbox" style={{ paddingTop: "0px"}}>
                                        <CheckBoxComponent
                                            id="drillView"
                                            checked={false}
                                            change={drillViewChange.bind(this)}
                                        />
                                    </div>
                                </td>
                            </tr>
                                ...
                                <td>
                                    <div className="drilldown-checkbox drilldownCheckbox" style={{ paddingTop: "0px" }}>
                                        <CheckBoxComponent
                                            id="breadCrumb"
                                            checked={false}
                                            change={breadCrumbChange.bind(this)}
                                        />
                                    </div>
                                </td>
                            </tr>
                                ...
                                <td>
                                    <div>
                                        <DropDownListComponent
                                            ...
                                            width="100%"
                                            index={0}
                                            dataSource={headerAlign}
                                            fields={{ text: "text", value: "value" }}
                                            change={headerChange.bind(this)}
                                            ref={headerElement}
                                        />
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div>
                                        <DropDownListComponent
                                            ...
                                            width="100%"
                                            index={0}
                                            dataSource={labelAlign}
                                            fields={{ text: "text", value: "value" }}
                                            change={labelChange.bind(this)}
                                            ref={labelElement}
                                        />
                                    </div>
                                </td>
