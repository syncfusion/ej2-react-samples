...
import { TreeMapComponent, LevelsDirective, LevelDirective, Inject, TreeMapLegend, TreeMapTooltip, ILoadedEventArgs, IItemMoveEventArgs, TreeMapTheme } from '@syncfusion/ej2-react-treemap';
...
const Default = () => {
    ...
    const itemMove = (args: IItemMoveEventArgs): void => {
    ...
    return (
        <main><div className="control-pane">
            ...
            <div style={{ float: "right", marginRight: "10px" }}>
                Source:
                <a
                    href="https://www.factorywarrantylist.com/car-sales-by-country.html/"
                    target="_blank"
                >
