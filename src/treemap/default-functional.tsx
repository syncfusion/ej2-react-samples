...
function Default() {
    ...
    function itemMove(args: IItemMoveEventArgs): void {
    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <TreeMapComponent itemClick={itemMove.bind(this)} itemMove={itemMove.bind(this)} load={load.bind(this)} id='treemap-container'
