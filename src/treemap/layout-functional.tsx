...
function Layout() {
    ...
    let layoutElement: DropDownListComponent;
    let renderDirectionElement: DropDownListComponent;
    ...
    function layoutChange(): void {
        treemapInstance.layoutType = layoutElement.value as LayoutMode;
        treemapInstance.refresh();
    }
    function renderDirectionChange() {
        treemapInstance.renderDirection = renderDirectionElement.value as RenderingMode;
        treemapInstance.refresh();
    }
                    ...
                    <PropertyPane title='Properties'>
                        <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%', marginBottom: '20px' }}>
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <DropDownListComponent id="layoutMode" width="100%" index={0} change={layoutChange.bind(this)} ref={d => layoutElement = d} dataSource={droplist} fields={{ text: 'text', value: 'value' }} />
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <DropDownListComponent id="highlightMode" width="100%" index={0} dataSource={dropList} fields={{ text: 'text', value: 'value' }} change={renderDirectionChange.bind(this)} ref={d => renderDirectionElement = d} />
                                    </div>
                                </td>
                            </tr>
                        </table>
