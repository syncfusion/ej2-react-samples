...
import { TreeMapComponent, Inject, TreeMapTooltip, TreeMapTheme, ILoadedEventArgs } from '@syncfusion/ej2-react-treemap';
    ...
    return (
        <main><div className="control-pane">
            ...
            <div style={{ float: "right", marginRight: "10px" }}>
                Source:
                <a
                    href=" https://en.wikipedia.org/wiki/United_States_at_the_2016_Summer_Olympics"
                    target="_blank"
                >
                    {" "}
                    en.wikipedia.org
