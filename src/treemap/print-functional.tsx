...
function PrintExport() {
    ...
    function onClick1(e: Event): void {
        ...
        treemapInstance.export((mode.value as ExportType), fileName);
    }
        ...
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <div className='col-md-9'>
                    <TreeMapComponent load={load.bind(this)} id='treemap-container' allowPrint={true} allowPdfExport={true} allowImageExport={true} ref={m => treemapInstance = m}
                    ...
                    <PropertyPane title='Properties'>
                        <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%', marginBottom: '20px', overflow: 'hidden' }}>
                            <tr>
                                ...
                                <td>
                                    <div style={{ paddingLeft: '0px' }}>
                                        <DropDownListComponent id="mode" width="100%" index={0} placeholder="JPEG" ref={d => mode = d} dataSource={droplist} fields={{ text: 'text', value: 'value' }} />
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div className="e-float-input" style={{ marginTop: '0px', paddingLeft: '0px' }}>
                                        <input id="fileName" ref={d => nameElement = d} type="text" defaultValue="TreeMap" style={{ padding: '0px', paddingLeft: '5px' }} />
                                    </div>
                                </td>
                            </tr>
                            <tr style={{ height: "60px" }}>
                                <td>
                                    <div id="btn-control">
                                        <ButtonComponent onClick={onClick1.bind(this)} style={{ width: '80px' }} cssClass='e-info' isPrimary={true}>Export</ButtonComponent>
                                    </div>
                                </td>
                                {/* </tr>
                                 <tr> */}
                                <td>
                                    <div id="btn-control">
                                        <ButtonComponent onClick={onClick2.bind(this)} style={{ width: '80px' }} cssClass='e-info' isPrimary={true}>Print</ButtonComponent>
                                    </div>
                                </td>
                            </tr>
                        </table>
