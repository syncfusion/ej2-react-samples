...
function Datalabel() {
    ...
    function labelChange(): void {
        treemapInstance.leafItemSettings.interSectAction = labelElement.value as LabelAlignment;
                    ...
                    <PropertyPane title='Properties'>
                        <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%', marginBottom: '20px' }}>
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <DropDownListComponent id="labels" width="100%" index={0} change={labelChange.bind(this)} ref={d => labelElement = d} dataSource={droplist} fields={{ text: 'text', value: 'value' }} />
                                    </div>
                                </td>
                            </tr>
                        </table>
