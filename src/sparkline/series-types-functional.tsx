                    ...
                    <div className="cols-sample-area" style={{ "marginTop": "8%" }}>
                        ...
                        <div className="col-lg-2 col-md-5 col-sm-5 sparent">
                            <div className="spark" id='winloss'>
                                <SparklineComponent load={load.bind(this)} id='spark4-container'
                        ...
                        <div className="col-lg-2 col-md-5 col-sm-10 sparent">
                            <div className="spark" style={{ "height": "87px" }}>
                                <SparklineComponent load={load.bind(this)} className="sparkpie" id="pie1" style={{ "height": "40px", "width": "29%" }}
                                ...
                                <SparklineComponent load={load.bind(this)} className="sparkpie" id="pie2" style={{ "height": "40px", "width": "29%" }}
                                    height='40px' width='100%' lineWidth={1} type='Pie' valueType='Category'
                                    tooltipSettings={{
                                        visible: true,
                                        format: '${x} : ${y}',
                                ...
                                <SparklineComponent load={load.bind(this)} className="sparkpie" id="pie3" style={{ "height": "40px", "width": "29%" }}
                                    height='40px' width='100%' lineWidth={1} type='Pie' valueType='Category'
                                    tooltipSettings={{
                                        visible: true,
                                        format: '${x} : ${y}'
