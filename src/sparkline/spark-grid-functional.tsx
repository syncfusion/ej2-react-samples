 ...
 */
 ...
 function SparkGrid() {
    React.useEffect(() => {
     ...
     let getSparkData: Function = (type: string, count: number) => {
         if (type === 'line') {
         ...
         return (
             <div className='control-pane'>
                 ...
                 <div className='control-section'>
                     <GridComponent dataSource={orderdata} resizing={renderSparkline.bind(this)} load={renderSparkline.bind(this)}
