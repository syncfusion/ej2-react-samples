                ...
                <div className='control-section'>
                    <div id="speed-dial-wrapper">
                        <div id="speeddialtarget" className="speeddial-modal-target  custom-index">
                            <SpeedDialComponent title="Menu" openIconCss='speeddial-icons speeddial-icon-menu' closeIconCss='speeddial-icons speeddial-icon-close' target='#speeddialtarget' position='BottomCenter' modal={true} items={this.items}></SpeedDialComponent>
                        </div>
                    </div>
                </div>
