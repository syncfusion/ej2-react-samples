...
export class Horizontal extends SampleBase<{}, {}> {
        ...
        return (
            <div className='control-pane'>
                ...
                <div id="action-description">
                    <p>
                        This sample demonstrates <code>card</code> rendering with horizontal layout. Based on the horizontal structure, product card is shown
        with detailed information.
    </p>
                </div>
                <div id="description">
                    <p>
                        By default, card elements are stacked one after another vertically. You can customize the card with specific direction by
        adding
        <b>e-card-horizontal</b> to align elements horizontally. Using
        <b>e-card-stacked</b> class, you can split the horizontal layout with a stacked element on left or right of the card.
