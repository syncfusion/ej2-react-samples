...
export class Reveal extends SampleBase {
    rendereComplete() {
        /* On click event for Revealing hidden card elements*/
        document.getElementById('showcarddata').onclick = () => {
            let cEle = document.getElementById('card_revealed');
            let cardEle = cEle.parentNode.parentNode;
            let revealEle = cardEle.querySelector('#card_reveal');
            revealEle.classList.add('e-reveal-show');
            revealEle.classList.remove('e-reveal-hide');
            let revealedEle = cardEle.querySelector('#card_revealed');
        ...
        document.getElementById('card-reveal_collapse').onclick = (e) => {
            let cardEle = e.currentTarget.parentNode.parentNode.parentElement;
            let revealEle = cardEle.querySelector('#card_reveal');
