...
import { Inject, PivotViewComponent, FieldList, CalculatedField, Toolbar, ConditionalFormatting, NumberFormatting, IDataOptions, IDataSet } from '@syncfusion/ej2-react-pivotview';
...
function smartPivotTable() {
    useEffect(() => {
        if (!chip) {
            dialogContentDiv = document.getElementById('dialogContent') as HTMLElement;
            createDialogContent(dialogContentDiv);
        }
    }, []);
    let chip: ChipList;
    let pivotObj: PivotViewComponent;
    let dialogContentDiv!: HTMLElement;
    ...
    const getCellContent = function (e: any) {
        let template: string;
    ...
    function updateContentBasedOnSelection(selectedChipIndex: number) {
        ...
        if (selectedChipIndex === 0) {
            ...
            inlineDiv.appendChild(textSpan);
            let fieldsMultiSelect!: MultiSelect;
        ...
        <>
            <div>
                ...
                <PivotViewComponent
                    ...
                    width="100%"
                    height={500}
                    cellTemplate={getCellContent}
                    toolbarRender={(args) => {
                        (args.customToolbar as any[]).splice(5, 0, {
                            type: 'Separator'
                        });
                        (args.customToolbar as any[]).splice(6, 0, {
                ...
                <DialogComponent
                    ...
                    visible={false}
                    header="AI Assist"
                    content={document.getElementById('dialogContent') as HTMLElement}
                    buttons={[{
                        click: onSubmit,
