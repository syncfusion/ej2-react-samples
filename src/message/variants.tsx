...
export class Variants extends SampleBase<{}, {}> {
    render() {
        return (
            <div className='control-pane'>
                ...
                <div id="description">
                    ...
                    <p>More information about Message variants can be found in this <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/message/variants">documentation</a> section.</p>
                </div>
            </div>
        )
    }
