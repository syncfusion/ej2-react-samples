            ...
            <div className='control-pane'>
                <div className="col-lg-12 control-section msg-default-section">
                    <div className="content-section">
                        ...
                        <MessageComponent id="msg_error" content="A problem has been occurred while submitting your data" severity="Error"></MessageComponent>
                    </div>
                </div>
                ...
                <div id="description">
                    ...
                    <p>In this sample, messages are displayed with a distinct icon and a color based on the <code>content</code> and <code>severity</code> properties.</p>
                </div>
            </div>
        )
    }
