            ...
            <div className='col-lg-12 control-section'>
                <div className='control-wrapper'>
                    <ScheduleComponent cssClass='virtual-scrolling' width='100%'
                        ...
                        < ViewsDirective >
                            <ViewDirective option='TimelineMonth' isSelected={true} eventTemplate={timelineEventTemplate.bind(this)} allowVirtualScrolling={true} />
                            <ViewDirective option='Month' eventTemplate={timelineEventTemplate.bind(this)} allowVirtualScrolling={true} />
                        </ViewsDirective>
