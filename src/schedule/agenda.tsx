...
import { ScheduleComponent, ViewsDirective, ViewsModelDirective, Agenda, Inject } from '@syncfusion/ej2-react-schedule';
...
export class AgendaView extends SampleBase<{}, {}> {
  ...
  public rendereComplete(): void {
    ...
    let hideEmptyDaysDropDown: DropDownList = new DropDownList({
      change: (args: DropDownChangeArgs) => {
        this.scheduleObj.hideEmptyAgendaDays = (args.value === 'true') ? true : false;
        this.scheduleObj.dataBind();
      }
    });
    hideEmptyDaysDropDown.appendTo('#hideemptydays');
  }
  /*Apply day count to the agenda view*/
        ...
        <div className='col-lg-9 control-section'>
          <div className='control-wrapper'>
            <ScheduleComponent width='100%' height='550px' ref={schedule => this.scheduleObj = schedule}
              ...
              <ViewsDirective>
                <ViewsModelDirective option='Agenda' allowVirtualScrolling={false} />
              </ViewsDirective>
            ...
            <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
              <tbody>
                <tr id='' style={{ height: '50px' }}>
                  ...
                  <td style={{ width: '70%' }}>
                    <div>
                      <select id='virtualscroll' name='virtualscroll' style={{ padding: '6px' }} defaultValue='false'>
                ...
                <tr id='' style={{ height: '50px' }}>
                  ...
                  <td style={{ width: '70%' }}>
                    <div>
                      <select id='hideemptydays' name='ddl' style={{ padding: '6px' }} defaultValue='true'>
                        <option value='true'>True</option>
                        <option value='false'>False</option>
                      </select>
                    </div>
                ...
                <tr id='' style={{ height: '50px' }}>
                  ...
                  <td style={{ width: '70%' }}>
                    <div>
                      <NumericTextBoxComponent width='100px' id='agendadayscount' format='n0' value={7} min={1} max={15}
