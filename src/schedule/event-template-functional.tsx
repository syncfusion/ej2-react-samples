...
function EventTemplate() {
  ...
  function timelineEventTemplate(props): JSX.Element {
      ...
      <div className='col-lg-12 control-section'>
        <div className='control-wrapper'>
          <ScheduleComponent cssClass='event-template' width='100%' height='550px' selectedDate={new Date(2021, 1, 15)} readonly={true}
            startHour='08:00' endHour='18:00' workHours={{ start: '08:00' }} eventSettings={{ dataSource: data }}>
            <ViewsDirective>
              <ViewDirective option={Browser.isDevice ? 'Day' : 'Week'} eventTemplate={eventTemplate.bind(this)} />
              <ViewDirective option={Browser.isDevice ? 'TimelineDay' : 'TimelineWeek'} eventTemplate={timelineEventTemplate.bind(this)} />
            </ViewsDirective>
