...
export class GroupByChild extends SampleBase {
    constructor() {
        super(...arguments);
        this.data = extend([], dataSource.resourceTeamData, null, true);
        this.projectData = [
    ...
    render() {
        ...
        <div className='col-lg-12 control-section'>
          <div className='control-wrapper'>
            <ScheduleComponent cssClass='group-bychild' width='100%' height='650px' selectedDate={new Date(2018, 5, 5)} currentView='WorkWeek' startHour='09:00' endHour='19:00' eventSettings={{
            dataSource: this.data, fields: {
              ...
              <ResourcesDirective>
                ...
                <ResourceDirective field='CategoryId' title='Category' name='Categories' allowMultiple={true} dataSource={this.categoryData} textField='text' idField='id' colorField='color'>
                </ResourceDirective>
              </ResourcesDirective>
              <ViewsDirective>
