...
export class TimeZone extends SampleBase {
    constructor() {
        super(...arguments);
        this.fifaEvents = extend([], (dataSource.fifaEventsData), null, true);
    ...
    onCreate() {
        for (let fifaEvent of this.fifaEvents) {
            let event = fifaEvent;
            event.StartTime = this.timezone.removeLocalOffset(new Date(event.StartTime));
            event.EndTime = this.timezone.removeLocalOffset(new Date(event.EndTime));
        }
    }
    ...
    render() {
        ...
        <div className='col-lg-9 control-section'>
          <div className='control-wrapper'>
            <ScheduleComponent width='100%' height='650px' ref={schedule => this.scheduleObj = schedule} selectedDate={new Date(2018, 5, 20)} timezone='UTC' workHours={{ start: '11:00' }} eventSettings={{ dataSource: this.fifaEvents }} created={this.onCreate.bind(this)} eventRendered={this.onEventRendered.bind(this)}>
            ...
            <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
              <tbody>
                <tr style={{ height: '50px' }}>
                  ...
                  <td style={{ width: '70%' }}>
                    <div>
                      <DropDownListComponent style={{ padding: '6px' }} value={'UTC'} popupWidth='250px' fields={this.fields} dataSource={this.timeZoneOptions} change={this.onTimeZoneChange.bind(this)}>
