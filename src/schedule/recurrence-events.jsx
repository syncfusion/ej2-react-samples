    ...
    render() {
        ...
        <div className='col-lg-9 control-section'>
          <div className='control-wrapper'>
            <ScheduleComponent width='100%' height='650px' selectedDate={new Date(2018, 1, 20)} ref={t => this.scheduleObj = t} eventSettings={{ dataSource: this.data }} eventRendered={this.onEventRendered.bind(this)}>
              <ViewsDirective>
            ...
            <table id='property' title='Properties' style={{ width: '100%' }}>
              <tbody>
                <tr style={{ height: '50px' }}>
                  <td style={{ width: '100%' }}>
                    <CheckBoxComponent id='editFollowingEvents' checked={false} label='Enable Following Events' change={this.onChange.bind(this)}></CheckBoxComponent>
                  </td>
                </tr>
              </tbody>
            </table>
