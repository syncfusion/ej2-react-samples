...
export class ReadonlyEvents extends SampleBase {
    constructor() {
        super(...arguments);
        this.data = getReadOnlyEventsData();
    }
    onPopupOpen(args) {
    ...
    render() {
        ...
        <div className='col-lg-12 control-section'>
          <div className='control-wrapper'>
            <ScheduleComponent width='100%' height='650px' eventSettings={{ dataSource: this.data }} popupOpen={this.onPopupOpen.bind(this)} actionBegin={this.onActionBegin.bind(this)} dragStop={this.onDragStop.bind(this)} resizeStop={this.onResizeStop.bind(this)}>
              <ViewsDirective>
