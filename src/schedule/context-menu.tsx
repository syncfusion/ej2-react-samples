...
export class ContextMenu extends SampleBase<{}, {}> {
  ...
  private onMenuItemSelect(args: MenuEventArgs): void {
    ...
    switch (selectedMenuItem) {
      ...
      case 'Add':
      case 'AddRecurrence':
        let activeCellsData: CellClickEventArgs = this.scheduleObj.getCellDetails(this.selectedTarget);
      ...
      <div className='schedule-control-section'>
        <div className='control-section'>
          <div className='control-wrapper'>
            <ScheduleComponent height='650px' ref={t => this.scheduleObj = t} selectedDate={new Date(2018, 1, 15)} eventSettings={{ dataSource: this.data }}>
              <ViewsDirective>
