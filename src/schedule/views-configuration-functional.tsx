  ...
  const agendaTemplate = (props) => {
    return (
      <div>
        ...
        {(props.Description !== null && props.Description !== undefined && props.Description !== "") ? <div className="group">{props.Description}</div> : ""}
        <div className="location">{getTimeString(props.StartTime)}{(props.City !== null && props.City !== undefined && props.City !== "") ? ", " + props.City : ""}</div>
      </div>
    );
  }
    ...
    <div className='schedule-control-section'>
      <div className='col-lg-12 control-section'>
        <div className='control-wrapper'>
          <ScheduleComponent cssClass='schedule-views-config' width='100%' height='650px' currentView='Month' selectedDate={new Date(2021, 5, 20)} eventSettings={{ dataSource: data, fields: { location: { name: 'City' } } }}>
            <ResourcesDirective>
