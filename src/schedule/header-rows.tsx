...
export class HeaderRows extends SampleBase<{}, {}> {
    private data: Record<string, any>[] = extend([], (dataSource as Record<string, any>).headerRowData, null, true) as Record<string, any>[];
            ...
            <div className='schedule-control-section'>
                <div className='col-lg-12 control-section'>
                    <div className='control-wrapper'>
                        <ScheduleComponent ref={schedule => this.scheduleObj = schedule} width='100%' height='650px' selectedDate={new Date(2021, 0, 1)}
