...
import {
    ...
    Day, Week, WorkWeek, Month, Agenda, Inject, Resize, DragAndDrop} from '@syncfusion/ej2-react-schedule';
...
export class OverlapEvents extends SampleBase<{}, {}> {
    private data: Record<string, any>[] = extend([], (dataSource as Record<string, any>).scheduleOverlapData, null, true) as Record<string, any>[];
            ...
            <div className='schedule-control-section'>
                <div className='col-lg-12 control-section'>
                    <div className='content-wrapper'>
                        <ScheduleComponent width='100%' height='550px' selectedDate={new Date(2025, 1, 12)} eventSettings={{ dataSource: this.data }} allowOverlap={false} >
                            <ViewsDirective>
