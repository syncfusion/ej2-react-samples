    ...
    render() {
        return (<div className='schedule-control-section'>
                <div className='col-lg-9 control-section'>
                    ...
                    <ScheduleComponent cssClass='adaptive-rows' ref={schedule => this.scheduleObj = schedule} width='100%' height='650px' selectedDate={new Date(2018, 7, 1)} rowAutoHeight={true} eventSettings={{
                        ...
                        <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
                            <tbody>
                                <tr style={{ height: '50px' }}>
                                    <td style={{ width: '100%' }}>
                                        <CheckBoxComponent id='adaptive-rows' checked={true} label='Row Auto Height' change={this.onChange.bind(this)}></CheckBoxComponent>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
