...
function PopulateRule() {
  ...
  function onChange(e: ChangeEventArgs): void {
    recObject.setRecurrenceRule(e.value as string);
  }
  return (
      ...
      <div className='control-section'>
        <div className='recurrence-editor-wrap'>
          <div style={{ paddingBottom: '15px' }}>
            Select Rule
            <DropDownListComponent id='RecurrenceList' dataSource={datas} index={2} fields={fields}
              change={onChange.bind(this)} popupHeight='200px' />
          </div>
          <div className='RecurrenceEditor'>
            <RecurrenceEditorComponent id='RecurrenceEditor' ref={t => recObject = t} value={datas[2].rule}></RecurrenceEditorComponent>
          </div>
        </div>
      </div>
