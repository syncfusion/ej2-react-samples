          ...
          <stop offset="1"></stop>
                ...
                <div className='control-section'>
                    <StockChartComponent id='stockchartsplinearea'
                        ...
                        crosshair={{ enable: true, lineType: 'Both' , snapToData: true, dashArray: '5, 5'}}
                        title= 'Google Stock Price'
                    >
                        <Inject services={[DateTime,Tooltip,RangeTooltip, SplineAreaSeries, Crosshair,LineSeries, SplineSeries, CandleSeries, HiloOpenCloseSeries, HiloSeries, RangeAreaSeries, Trendlines,
