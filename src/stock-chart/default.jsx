...
export class Default extends SampleBase {
    render() {
        ...
        }} chartArea={{ border: { width: 0 } }} tooltip={{ enable: true, shared: true }} tooltipRender={tooltipRender} crosshair={{ enable: true }} load={this.load.bind(this)} title='AAPL Stock Price' titleStyle={{
