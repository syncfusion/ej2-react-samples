...
for (var i = 0; i < exports.stockData1.length; i++) {
    ...
    if (exports.stockData1[i]['x'].getDate() !== date1.getDate()) {
        exports.stockData1.splice(i, 0, {
            ...
            // tslint:disable-next-line:no-string-literal
            open: exports.stockData1[i]['high'], low: exports.stockData1[i]['open'],
            // tslint:disable-next-line:no-string-literal
            close: exports.stockData1[i]['close'], high: exports.stockData1[i]['low'],
            // tslint:disable-next-line:no-string-literal
...
var stockData2 = [{ x: new Date('2012-04-02'), close: 321.369812 },
...
for (var i = 0; i < stockData2.length; i++) {
    // tslint:disable-next-line:no-string-literal
