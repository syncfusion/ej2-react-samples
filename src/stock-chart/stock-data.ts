...
for (let i: number = 0; i < stockData.length; i++) {
  ...
  if (stockData[i]['x'].getDate() !== date.getDate()) {
      let randomLow : number = Math.random() * 5 + stockData[i]['low'] - 5;
      let randomHigh :number = Math.random() * 5 + stockData[i]['high'];
...
for (let i: number = 0; i < stockData1.length; i++) {
  ...
  if (stockData1[i]['x'].getDate() !== date1.getDate()) {
      let randomLow1 : number = Math.random() * 5 + stockData1[i]['low'] - 5;
      let randomHigh1 :number = Math.random() * 5 + stockData1[i]['high'];
      stockData1.splice(i, 0, {
          x: new Date(date1.getTime()),
          // tslint:disable-next-line:no-string-literal
          open: stockData1[i]['close'], low: randomLow1,
          // tslint:disable-next-line:no-string-literal
          close: stockData1[i]['open'], high: randomHigh1,
          // tslint:disable-next-line:no-string-literal
