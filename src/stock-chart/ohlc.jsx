    ...
    render() {
        return (<div className='control-pane'>
                ...
                <div className='control-section'>
                    <StockChartComponent id='stockchartohlc' primaryXAxis={{
            valueType: 'DateTime',
        ...
        }} load={this.load.bind(this)} chartArea={{ border: { width: 0 } }} tooltip={{ enable: true, shared: true }} tooltipRender={tooltipRender} crosshair={{ enable: true }} title='AAPL Stock Price' titleStyle={{
