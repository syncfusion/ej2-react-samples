...
function Orientation() {
    ...
    let ticks: any; let tooltip: any;
    // Checkbox Instance
    let checkbox: CheckBoxComponent;
    // Checkbox change handlers
    function enableDisableTicks(args: ChangeEventArgs): void {
        ticks = { placement: args.checked ? 'Before' : 'None', largeStep: 20, smallStep: 5, showSmallTicks: true };
        for (let slider of [defaultObj, minRangeObj, rangeObj]) {
            // Assigning ticks values to each slider
            slider.ticks = ticks;
        }
    }
    function enableDisableTooltip(args: ChangeEventArgs): void {
        tooltip = { isVisible: args.checked, placement: 'Before' };
        for (let slider of [defaultObj, minRangeObj, rangeObj]) {
    ...
    function refreshTooltip(e: any): void {
        if (defaultObj && rangeObj && minRangeObj) {
                            ...
                            <tbody><tr>
                                <td>
                                    <div className="sliderwrap">
                                        ...
                                        <SliderComponent id={"slider01"} value={30} orientation='Vertical' ref={(slider) => { defaultObj = slider }} />
                                    </div>
                                </td>
                                <td>
                                    <div className="sliderwrap">
                                        {/* Initialize  Slider component with type MinRange and Vertical orientation */}
                                        <SliderComponent id={"slider02"} value={30} type='MinRange' orientation='Vertical' ref={(slider) => { minRangeObj = slider }} />
                                    </div>
                                </td>
                                <td>
                                    <div className="sliderwrap">
                                        {/* Initialize Range Slider component with type Range and Vertical orientation */}
                                        <SliderComponent id={"slider03"} value={[30, 70]} type='Range' orientation='Vertical' ref={(slider) => { rangeObj = slider }} />
                                    </div>
                                </td>
                            </tr>
                            </tbody></table>
                                ...
                                <tr>
                                    ...
                                    <td style={{ width: '50%', paddingRight: '10px' }}>
                                        <div>
                                            ...
                                            <CheckBoxComponent checked={false} change={enableDisableTicks.bind(this)} />
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style={{ width: '50%', paddingRight: '10px' }}>
                                        <div style={{ paddingLeft: 0, paddingTop: 0 }}>
                                            {/* Initialize Range CheckBox component */}
                                            <CheckBoxComponent checked={false} change={enableDisableTooltip.bind(this)} />
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
