...
export class Range extends SampleBase {
    constructor() {
        super(...arguments);
        this.minDate = new Date(new Date().getFullYear(), new Date().getMonth(), 7, 10);
        this.maxDate = new Date(new Date().getFullYear(), new Date().getMonth(), 27, 22, 30);
        this.dateValue = new Date(new Date().getFullYear(), new Date().getMonth(), 14, 10, 30);
    }
    render() {
