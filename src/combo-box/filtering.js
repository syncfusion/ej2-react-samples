        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement("div", { id: 'filtering' },
                    React.createElement(ej2_react_dropdowns_1.ComboBoxComponent, { id: "country", ref: function (ComboBox) { _this.listObj = ComboBox; }, dataSource: this.searchData, filtering: this.onFiltering.bind(this), allowFiltering: true, fields: this.fields, placeholder: "Select a country", popupHeight: "270px" }))),
