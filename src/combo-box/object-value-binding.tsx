        ...
        <div className="col-lg-8 control-section">
          <div className="control-wrapper">
            <div id="default" style={{ paddingTop: '75px' }}>
              <ComboBoxComponent id="games" dataSource={this.records} ref={(combobox) => { this.listObj = combobox }} fields={this.fields} change={this.onChange.bind(this)} placeholder="Select a Item" allowObjectBinding={true} popupHeight="220px" />
            </div>
          </div>
        </div>
