    ...
    return (
        <div className='control-pane'>
            <div className='control-section'>
                <div id='filtering'>
                    <ComboBoxComponent id="country" ref={(ComboBox) => {listObj = ComboBox }} dataSource={searchData} filtering={onFiltering.bind(this)} allowFiltering={true} fields={fields} placeholder="Select a country" popupHeight="270px" />
                </div>
            </div>
