    ...
    Grouping.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section', id: 'comboIcon' },
                React.createElement("div", { className: 'col-lg-6' },
                    React.createElement("div", { id: "group" },
                        ...
                        React.createElement(ej2_react_dropdowns_1.ComboBoxComponent, { id: "grouping", dataSource: this.vegetableData, fields: this.groupFields, placeholder: "Select a vegetable", popupHeight: "220px" }))),
                React.createElement("div", { className: 'col-lg-6' },
                    React.createElement("div", { id: "icon" },
                        React.createElement("h4", null, " Icons"),
                        React.createElement(ej2_react_dropdowns_1.ComboBoxComponent, { id: "icons", dataSource: this.socialMediaData, fields: this.iconFields, placeholder: "Select a social media", popupHeight: "220px" })))),
            ...
            React.createElement("div", { id: "description" },
                ...
                React.createElement("p", null,
                    "The 2nd ComboBox is populated with icons that is rendered by mapping the ",
