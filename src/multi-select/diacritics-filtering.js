        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement("div", { id: 'multifilter', className: "control-styles" },
                    React.createElement("h4", null, "Diacritics Filtering"),
                    React.createElement(ej2_react_dropdowns_1.MultiSelectComponent, { id: "diacritics", ignoreAccent: true, allowFiltering: true, dataSource: this.diacriticsData, placeholder: "e.g: gul" }))),
