    ...
    render() {
        return (<div className='control-pane'>
                ...
                <div id="description">
                    ...
                    <p>
                        In this sample, Credit/Debit Card option is checked by default, and it can be achieved by using the <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/radio-button/#checked"><code>checked
                        </code></a> property.
                    </p>
                    <p>
                        More information about RadioButton can be found in this <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/radio-button/getting-started">
