...
export class Default extends SampleBase {
    ...
    render() {
            ...
            <div id='button-control'>
                <div className='row'>
                    ...
                    <div className="col-xs-6 col-sm-6 col-lg-6 col-md-6">
                        ...
                        <div className="col-xs-12 col-sm-12 col-lg-6 col-md-6">
                            <ButtonComponent cssClass='e-flat e-primary' ref={(scope) => { this.btnobj = scope; }} iconCss='e-btn-sb-icons e-play-icon' isToggle onClick={this.btnClick.bind(this)}>Play</ButtonComponent>
                        </div>
                    </div>
        ...
        <div id="description">
            ...
            <p>
                In this sample, Play button is a toggle button and it can be enabled by using the <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/button/#istoggle"><code>isToggle
                </code></a> property. To change the text and icon you should handle click event.
            </p>
            <p> 
                More information about Button can be found in this <a target='_blank' href='https://ej2.syncfusion.com/react/documentation/button/getting-started'>documentation section</a>.
            </p>
        </div>
      </div>);
    }
