                ...
                <tbody>
                    <tr>
                        ...
                        <td style={{ width: '50%', paddingRight: '10px' }}>
                            <div>
                                <CheckBoxComponent id="toolbar" checked={true} change={toolCheck.bind(this)}></CheckBoxComponent>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style={{ width: '50%', paddingRight: '10px' }}>
                            <div>
                                <CheckBoxComponent id="multiSelect" checked={true} change={toolCheck.bind(this)}></CheckBoxComponent>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style={{ width: '50%', paddingRight: '10px' }}>
                            <div>
                                <CheckBoxComponent id="fileExtension" checked={true} change={toolCheck.bind(this)}></CheckBoxComponent>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style={{ width: '50%', paddingRight: '10px' }}>
                            <div>
                                <CheckBoxComponent id="thumbnail" checked={true} change={toolCheck.bind(this)}></CheckBoxComponent>
                            </div>
                        </td>
                    </tr>
                    <tr>
