export const FileManagerSampleOrder = [
    ...
    { 'path': 'file-manager/FTP-file-provider', 'component': 'FTPFileProvider', 'name': 'FTP File Provider', 'description': 'This example demonstrates how to configure and use the File Transfer Protocol in a React File Manager.', 'order': '03', 'category': 'Cloud Service Providers', 'type': 'new', 'api': '{"FileManager":["ajaxSettings", "view"] }' }
];
