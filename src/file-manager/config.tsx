export const FileManagerSampleOrder: Object = [
    ...
    { 'path': 'file-manager/access-control', 'component': 'AccessControl', 'name': 'Access Control', 'type': 'new', 'description': 'This example of FileManager demonstrates how to restrict the file operations in the File Manager component.', 'order': '02', 'category': 'Use Case', 'api': '{"FileManager":["ajaxSettings"] }'},
