export const FileManagerSampleOrder: Object = [
    ...
    { 'path': 'file-manager/directory-upload', 'component': 'DirectoryUpload', 'name': 'Directory upload', 'description': 'This example demonstrates how to upload the folder (directory) by using custom toolbar item with in a React File Manager.', 'order': '01', 'category': 'File Manager', 'api': '{"FileManager":["ajaxSettings"] }'},
