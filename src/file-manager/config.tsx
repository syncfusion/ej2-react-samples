export const FileManagerSampleOrder: Object = [
    ...
    { 'path': 'file-manager/drag-drop', 'component': 'DragAndDrop', 'name': 'Drag and Drop', 'description': 'This example demonstrates the how to drag and drop the files from one location to another location in a React File Manager.', 'order': '01', 'category': 'File Manager', 'type':'new', 'api': '{"FileManager":["ajaxSettings"] }'},
    { 'path': 'file-manager/file-upload', 'component': 'FileUpload', 'name': 'File Upload', 'description': 'This example demonstrates how to render the File Manager component inside the Dialog component in a React File Manager.', 'order': '02', 'category': 'Use Case', 'type':'new', 'api': '{"FileManager":["ajaxSettings"] }',
    'sourceFiles': [
    ...
    { 'path': 'file-manager/azure-service', 'component': 'Azure', 'name': 'Azure Blob Provider', 'description': 'This example demonstrates the how to configure and use the azure cloud service in a React File Manager.', 'order': '03', 'category': 'Cloud Service Providers', 'type':'new', 'api': '{"FileManager":["ajaxSettings"] }'},
