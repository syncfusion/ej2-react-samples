export const FileManagerSampleOrder: Object = [
    ...
    { 'path': 'file-manager/directory-upload', 'component': 'DirectoryUpload', 'name': 'Directory upload', 'type': 'update', 'description': 'This example demonstrates how to upload the folder (directory) by using custom toolbar item with in a React File Manager.', 'order': '01', 'category': 'File Manager', 'api': '{"FileManager":["ajaxSettings"] }'},
    { 'path': 'file-manager/virtualization', 'component': 'VirtualizationSample', 'name': 'Virtualization', 'description': 'This example demonstrates on how to enable the virtual scrolling feature in the React File Manager component.', 'order': '01', 'category': 'File Manager', 'api': '{"FileManager":["ajaxSettings"] }'},
