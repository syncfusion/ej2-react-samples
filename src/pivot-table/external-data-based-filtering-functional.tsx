...
function ExternalDataBasedFiltering () {
    ...
    function setStartDate(args): void {
        startDate = args.value;
    }

    function setEndDate(args): void {
        endDate = args.value;
    }
    ...
    function applyDateFilter(): void {
        if (startDate && endDate) {
            ...
            .then((e: any) => {
                setDataSourceSettings(prevSettings => ({
                        ...prevSettings,
                        dataSource: e.result,
                    }));
            });
...
export default ExternalDataBasedFiltering;