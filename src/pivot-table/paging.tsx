...
export class Paging extends SampleBase<{}, {}> {
    ...
    private pagerPositions: string[] = ['Top', 'Bottom'];
    private pageSizes: string[] = ['Row', 'Column', 'Both', 'None'];
    ...
    compactCheckBoxChange(args: Args): void {
        this.pivotObj.pagerSettings.enableCompactView = args.checked;
    };

    inverseCheckBoxChange(args: Args): void {
