  ...
  <soap:Body>
    ...
    const applyOlapBinding = async (opts?: { url?: string; catalog?: string; cube?: string }) => {
        ...
        const olapDataSourceSettings: IDataOptions = {
            url, catalog, providerType: 'SSAS', cube, localeIdentifier: 1033, rows: [], columns: [], values: []
        } as IDataOptions;
        (pivot as any).engineModule = null;
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                            ...
                            <div className="olap-row">
                                ...
                                <DropDownListComponent value={selectedDataSource} dataSource={olapDataSources} fields={{ text: 'value', value: 'value' }}
                                    placeholder={loadingSources ? 'Loading…' : 'Select data source'} enabled={olapConnected || loadingSources}
                                    change={async (e) => {
                            ...
                            <div className="olap-row">
                                ...
                                <DropDownListComponent value={selectedCatalog} dataSource={olapCatalogs} fields={{ text: 'value', value: 'value' }}
                                    placeholder={loadingCatalogs ? 'Loading…' : 'Select catalog'} enabled={!!selectedDataSource || loadingCatalogs}
                                    change={async (e) => {
...
class DynamicBinding extends SampleBase<{}, {}> {
    render() {
        return <DynamicBindingComponent />;
    }
}
