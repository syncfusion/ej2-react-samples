...
function PivotTableExporting () {
    ...
    let pivotObj: any;
    let toolbarOptions: any = ['Chart', 'FieldList'];
    React.useEffect(() => {
        updateSampleSection();
    }, []);

    function toolbarRender(args): void {
    ...
    return (
        <div className='control-pane'>
            <div className='control-section'>
                <PivotViewComponent id='PivotView' ref={d => pivotObj = d} dataSourceSettings={dataSourceSettings} width={'100%'} height={'450'} showToolbar={true} allowPdfExport={true}
