...
function HyperLink () {
    ...
    function onCellClick(args: HyperCellClickEventArgs): void {
        let cell: string = '';
    ...
    function onOptionChange(args: ChangeEventArgs): void {
            ...
            <div className='control-section' style={{ overflow: 'auto' }}>
                <div className='col-lg-8 adaptive'>
                    <PivotViewComponent id='PivotView' ref={(pivotview) => { pivotObj = pivotview }} showTooltip={false} dataSourceSettings={dataSourceSettings}
                        width={'100%'} height={'600'} gridSettings={{ columnWidth: 140 }} hyperlinkSettings={hyperlinkSettings} hyperlinkCellClick={onCellClick.bind(this)}></PivotViewComponent>
                </div>
