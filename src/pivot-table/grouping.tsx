        ...
        return (
            <div className='control-pane'>
                <div className='col-lg-8 control-section' id='pivot-table-section' style={{ overflow: 'initial' }}>
                    <PivotViewComponent id='PivotView' ref={(scope) => { this.pivotObj = scope; }} load={this.onLoad} dataSourceSettings={dataSourceSettings} width={'100%'} height={'450'} showGroupingBar={true} gridSettings={{ columnWidth: 140, columnRender: this.beforeColumnsRender }}>
                                ...
                                <tr className="input2cls" style={{ height: '50px' }}>
                                    ...
                                    <td style={{ paddingBottom: '16px' }}>
                                        <div className="numbercls">
                                            <NumericTextBoxComponent id="numbergroup" ref={(scope) => { this.numberGroup = scope; }} value={4} width={'150'} placeholder={'Example: 4'}
                                                format={'###'} min={1} max={10}>
