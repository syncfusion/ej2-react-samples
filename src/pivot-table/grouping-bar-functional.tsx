...
function GroupingBarSample () {
    ...
    function onFilter(args: any): void {
        pivotObj.groupingBarSettings.showFilterIcon = args.checked;
    }
    function onSort(args: any): void {
    ...
    function onValueType(args: any): void {
    ...
    return (
        <div className='control-pane'>
            <div className='col-lg-9 control-section' id='pivot-table-section' style={{ overflow: 'initial' }}>
                <PivotViewComponent id='PivotView' ref={(scope) => { pivotObj = scope; }} dataSourceSettings={dataSourceSettings} width={'100%'} height={'450'} showGroupingBar={true} groupingBarSettings={{showFieldsPanel: true}} gridSettings={{columnWidth: 140}} showValuesButton={true}>
                    ...
                    <table id="property" title="Properties" style={{ width: '100%', height:'100%'}}>
                        <tbody>
                            <tr style={{height:'50px'}}>
                                <td>
                                    <div>
                                        <CheckBoxComponent id='sort' checked={true} label='Show Sort Icon' change={onSort.bind(this)} ></CheckBoxComponent>
                                    </div>
                                </td>
                            </tr>
                            <tr style={{height:'50px'}}>
                                <td>
                                    <div>
                                        <CheckBoxComponent id='filter' checked={true} label='Show Filter Icon' change={onFilter.bind(this)} ></CheckBoxComponent>
                                    </div>
                                </td>
                            </tr>
                            <tr style={{height:'50px'}}>
                                <td>
                                    <div>
                                        <CheckBoxComponent id='summary' checked={true} label='Show Value Type Icon' change={onValueType.bind(this)} ></CheckBoxComponent>
                                    </div>
                                </td>
                            </tr>
                            <tr style={{height:'50px'}}>
                                <td>
                                    <div>
                                        <CheckBoxComponent id='remove' checked={true} label='Show Remove Icon' change={onRemove.bind(this)} ></CheckBoxComponent>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
...
export default GroupingBarSample;