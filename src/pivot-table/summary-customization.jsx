...
let field = { text: 'Name' };
let placeholder = "Select fields to hide its sub-totals";
export class SummaryCustomization extends SampleBase {
    ...
    select(args) {
        for (let i = 0; i < this.pivotObj.dataSourceSettings.columns.length; i++) {
        ...
        for (let i = 0; i < this.pivotObj.dataSourceSettings.rows.length; i++) {
                    ...
                    <PropertyPane title='Properties'>
                        <table id="property" title="Properties" style={{ width: '100%', height: '100%' }}>
                            <tbody>
                                ...
                                <tr style={{ height: '50px' }}>
                                    <MultiSelectComponent id="checkbox" dataSource={values} fields={field} mode="CheckBox" showClearButton={true} enableSelectionOrder={false} showDropDownIcon={true} placeholder={placeholder} select={this.select.bind(this)} removed={this.removed.bind(this)} open={this.open.bind(this)}>
