...
export class SparkLine extends SampleBase<{}, {}> {
        ...
        return (
            <div className='control-pane'>
                <div className='control-section' id='pivot-table-section'>
                    <PivotViewComponent id='PivotView_sparkline' ref={(pivotview) => { this.pivotObj = pivotview }} dataSourceSettings={dataSourceSettings} width={'100%'} height={'450'} gridSettings={this.gridSettings}
                        showTooltip={false} dataBound={this.onDataBound}>
                    </PivotViewComponent>
                </div>
