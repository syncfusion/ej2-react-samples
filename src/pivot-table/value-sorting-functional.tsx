    ...
    return (
        <div className='control-pane'>
            <div className='control-section'>
                <PivotViewComponent id='PivotView' dataSourceSettings={dataSourceSettings} width={'100%'} height={'300'} showFieldList={true} showValuesButton={true} enableValueSorting={true} gridSettings={{columnWidth: 140}}>
