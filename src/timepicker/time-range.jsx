    ...
    render() {
        return (<div className='control-pane range'>
              ...
              will be able to select the end time or else, need to select the entire business hours 9:00 to 18:00 from the <code>Business Hours</code> option. Once the options are checked, both the TimePicker components goes to readonly state.
                    ...
                    <p>More information about time range restriction can be found in the  <a target='_blank' href='https://ej2.syncfusion.com/react/documentation/timepicker/time-range/'>documentation</a>  section.</p>
                </div>
            </div>);
    }
}
