                ...
                <div className="row">
                  <div className="col-md-12">
                    <AppBarComponent colorMode={props.colorMode}>
                      <ButtonComponent created={btnCreated} cssClass='e-inherit menu' iconCss='e-icons e-menu'></ButtonComponent>
                      ...
                      <MenuComponent cssClass={'e-inherit e-appbar-icon-menu ' + props.colorClass} items={verticalMenuItems} beforeItemRender={beforeItemRender}></MenuComponent>
                    </AppBarComponent>
                  </div>
                </div>
                <br />
