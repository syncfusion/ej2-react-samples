...
export class Default extends SampleBase<{}, {}> {
  public regularBtn: ButtonComponent;
  public primaryBtn: ButtonComponent;
  public denseBtn: ButtonComponent;
  public regularBtnCreated(): void {
    (this.regularBtn.element as HTMLElement).setAttribute('aria-label', 'menu');
  }
  public primaryBtnCreated(): void {
    (this.primaryBtn.element as HTMLElement).setAttribute('aria-label', 'menu');
  }
  public denseBtnCreated(): void {
    (this.denseBtn.element as HTMLElement).setAttribute('aria-label', 'menu');
  }
  render() {
    return (
              ...
              <div className="row">
                <div className="col-md-12">
                  <AppBarComponent mode="Prominent" cssClass='prominent-appbar' colorMode="Primary">
                    <ButtonComponent ref={primaryBtn => (this.primaryBtn = primaryBtn)} created={this.primaryBtnCreated.bind(this)} cssClass='e-inherit menu' iconCss='e-icons e-menu'></ButtonComponent>
              ...
              <div className="row">
                <div className="col-md-12">
                  <AppBarComponent mode="Dense" colorMode="Primary">
                    <ButtonComponent ref={denseBtn => (this.denseBtn = denseBtn)} created={this.denseBtnCreated.bind(this)} cssClass='e-inherit menu' iconCss='e-icons e-menu'></ButtonComponent>
