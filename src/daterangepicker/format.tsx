    ...
    return (
      <div className='control-pane'>
        ...
        <div id='description'>
          ...
          <p> More information on the date format configuration can be found in the <a href="http://ej2.syncfusion.com/react/documentation/daterangepicker/globalization.html" target="_blank"> documentation section</a>.</p>
        </div>
      </div>
    )
  }
