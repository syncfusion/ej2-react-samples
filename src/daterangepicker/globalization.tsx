        ...
        return (
            <div className='control-pane'>
                ...
                <div id="action-description">
                    <p>
                        In this sample, the DateRangePicker has been configured with <code>German</code> culture. To change this current culture, go to the properties panel at the right side and select a culture from the dropdown options.</p>    
                </div>
                <div id='description'>
                    <p>
