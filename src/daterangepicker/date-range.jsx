...
export class DateRange extends SampleBase {
    constructor() {
        super(...arguments);
        this.minDate = new Date('1/15/2017');
        this.maxDate = new Date('12/20/2017');
    }
    render() {
        return (<div className='control-pane'>
            ...
            <a href="https://ej2.syncfusion.com/react/documentation/daterangepicker/range-selection/#restrict-the-range-within-a-range" target="_blank"> documentation section</a>.
          </p>
                </div>
            </div>);
    }
