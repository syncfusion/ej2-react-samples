...
const Format = () => {
    ...
    const dateRangePickerRef = useRef<DateRangePickerComponent>(null);
    ...
    const onChange = (args: ChangeEventArgs): void => {
        const selectedFormat = args.value as string;
