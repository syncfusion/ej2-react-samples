...
function Format() {
    ...
    let daterangepickerInstance: DateRangePickerComponent;
    ...
    function onChange(): void {
        ...
        daterangepickerInstance.format = format;
        daterangepickerInstance.separator = (listObj.text === 'yyyy/MM/dd HH:mm') ? 'to' : '-';
    }
    return (
            ...
            <div className='control-section row'>
                <div className='col-lg-8'>
                    <div className='daterangepicker-control-section format'>
                        <DateRangePickerComponent format='dd/MMM/yy hh:mm a' ref={calendar => daterangepickerInstance = calendar} startDate={startValue} endDate={endValue} ></DateRangePickerComponent>
                    </div>
                </div>
