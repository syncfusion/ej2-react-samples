...
export class Format extends SampleBase<{}, {}> {
  ...
  public onChangeInputFormat = (args: any) => {
    ...
    if (this.daterangepickerInstance) {
      this.daterangepickerInstance.inputFormats = this.inputFormats;
    }
  }
          ...
          <div id="format" className='col-lg-4 property-section'>
            <div>
              ...
              <MultiSelectComponent 
                id="inputFormatsDatePicker" 
                ref={multiselect => this.inputFormatInstance = multiselect} 
                dataSource={this.inputFormatData}
                fields={this.checkFields} 
                allowFiltering={false} 
                placeholder="e.g. MM/dd/yyyy" 
                value={this.inputFormats} 
                mode="CheckBox" 
                showSelectAll={true} 
                showDropDownIcon={true}
                enableSelectionOrder={false} 
                change={this.onChangeInputFormat}
              >
