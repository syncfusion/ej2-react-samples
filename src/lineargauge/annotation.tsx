                ...
                <div className='control-section'>
                    <LinearGaugeComponent id='gauge' rangePalettes={range} orientation='Horizontal'>
                        ...
                        <AnnotationsDirective>
                            ...
                            <AnnotationDirective content='<div id="low"><img style="height:25px;width:25px;" src="src/lineargauge/images/Low.png"/></div>'
                                axisIndex={0}
                                axisValue={15}
                                y={-25}
                                zIndex='1'>
                            </AnnotationDirective>
                            <AnnotationDirective content='<div id="moderate"><img style="height:25px;width:25px;" src="src/lineargauge/images/Moderate.png"/></div>'
                                axisIndex={0}
                                axisValue={45}
                                y={-25}
                                zIndex='1'>
                            </AnnotationDirective>
                            <AnnotationDirective content='<div id="high"><img style="height:25px;width:25px;" src="src/lineargauge/images/High.png"/></div>'
                                axisIndex={0}
                                axisValue={75}
                                y={-25}
                                zIndex='1'>
