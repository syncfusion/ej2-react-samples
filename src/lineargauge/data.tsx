                ...
                <div className='control-section'>
                    <div className="row">
                        <LinearGaugeComponent style={{ height: "300px" }} id='gauge1' orientation='Horizontal' container={{ width: 30, backgroundColor: '#e0e0e0', border: { width: 0 }, offset: 30 }}>
                            ...
                            <AnnotationsDirective>
                                <AnnotationDirective content='<div id="title" style="width:300px;"> <img style="float:left" src="src/lineargauge/images/Exercise Tracking.svg"/><p style="font-size:18px;color:#4285F4;float:left;margin-left:12px;margin-top:4px">Exercise Tracking </p></div>'
                                    axisIndex={0}
                                    axisValue={0}
                                    x={150}
                                    zIndex= '1'
                                ...
                                <AnnotationDirective content='<div id="running" style="width:100px;"><img style="height:25px;width:25px;float:left" src="src/lineargauge/images/Running.svg" /></span><p style="float:left;margin-left:10px;">Running</p></div>'
                                    axisIndex={0}
                                    axisValue={0}
                                    zIndex= '1'
                                    x={50}
                    ...
                    <div className="row">
                        <LinearGaugeComponent style={{ height: "250px" }} id='gauge2' orientation='Horizontal' container={{ width: 30, backgroundColor: '#e0e0e0', border: { width: 0 }, offset: -50 }}>
                            ...
                            <AnnotationsDirective>
                                <AnnotationDirective content='<div id="cycle" style="width:100px;"><img style="height:25px;width:25px;float:left" src="src/lineargauge/images/Cycling.svg" /></span><p style="float:left;margin-left:10px;">Cycling</p></div>'
                                    axisIndex={0}
                                    axisValue={0}
                                    zIndex= '1'
                                    x={50}
                    ...
                    <div className="row">
                        <LinearGaugeComponent style={{ height: "250px" }} id='gauge3' orientation='Horizontal' container={{ width: 30, backgroundColor: '#e0e0e0', border: { width: 0 }, offset: -90 }}>
                            ...
                            <AnnotationsDirective>
                                <AnnotationDirective content='<div id="walk" style="width:100px;"><img style="height:25px;width:25px;float:left" src="src/lineargauge/images/Walking.svg" /></span><p style="float:left;margin-left:10px;">Walking</p></div>'
                                    axisIndex={0}
                                    axisValue={0}
                                    zIndex= '1'
                                    x={50}
