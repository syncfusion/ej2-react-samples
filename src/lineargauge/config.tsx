export const LinearGaugeSampleOrder: Object = [
    ...
    { 'path': 'lineargauge/axes', 'component': 'Axes', 'name': 'Axes and Pointers', 'order': '01', 'category': 'Linear Gauge' },
    { 'path': 'lineargauge/annotation', 'component': 'Annotation', 'name': 'Annotation', 'order': '01', 'category': 'Linear Gauge' },
    { 'path': 'lineargauge/tooltip', 'component': 'Tooltip', 'name': 'Tooltip', 'order': '01', 'category': 'Linear Gauge' },
    { 'path': 'lineargauge/style', 'component': 'Style', 'name': 'Styles', 'order': '01', 'category': 'Linear Gauge' }
]