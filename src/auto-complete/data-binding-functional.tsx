...
function Data(){
    ...
    let localDataObj: AutoCompleteComponent;
     // AutoComplete Object creation
     let remoteDataObj: AutoCompleteComponent;
     // Bind change event
            ...
            <div className='control-section'>
                <div className='col-lg-9'>
                    <div className='col-lg-6'>
                        <div id="local">
                            <h4> Local Data</h4>
                            <AutoCompleteComponent id="country" dataSource={countries} ref={(autocomplete) => {localDataObj = autocomplete }} fields={localFields} popupHeight="250px" placeholder="e.g. Australia" autofill={true} filterType='StartsWith' />
                        </div>
                    </div>
                    <div className='col-lg-6'>
                        <div id="remote">
                            <h4>Remote Data</h4>
                            <AutoCompleteComponent id="products" dataSource={productData} query={query} ref={(autocomplete) => {remoteDataObj = autocomplete }} sortOrder="Ascending" fields={remoteFields} autofill={true} placeholder="e.g. Andrew Fuller" suggestionCount={5} filterType='StartsWith' />
                        </div>
                    </div>
                </div>
