...
export class Limits extends SampleBase {
    constructor() {
        ...
        this.ticks = { placement: 'After', largeStep: 20, smallStep: 5, showSmallTicks: true };
        this.tooltip = { isVisible: true, placement: 'Before' };
        this.minRangeLimits = { enabled: true, minStart: 10, minEnd: 40 };
