        ...
        <div className='control-section' id='dropIcon'>
            <div className='col-lg-6'>
                <div id="disabled-status">
                    <h4>Status</h4>
                    <DropDownListComponent id="status" dataSource={this.statusData} fields={this.statusFields} placeholder="Select Status" allowFiltering={true} />
                </div>
            </div>
            <div className='col-lg-6'>
                <div id="vegetable">
                    <h4>Vegetable</h4>
                    <DropDownListComponent id="vegetables" dataSource={this.vegetableData} fields={this.vegetableFields} placeholder="Select Vegetable"/>
                </div>
            </div>
        </div>
