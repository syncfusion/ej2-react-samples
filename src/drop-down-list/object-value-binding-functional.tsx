        ...
        <div className="col-lg-8 control-section">
          <div className="control-wrapper">
            <div id="default" style={{ paddingTop: '75px' }}>
              <DropDownListComponent id="games" dataSource={records}  allowObjectBinding={true} fields={fields} change={onChange.bind(this)} value={value} placeholder="Select a Item" popupHeight="220px" />
            </div>
          </div>
        </div>
