      ...
      <div className='control-pane'>
        <div className='control-section'>
          <div id='inline' style={{ paddingTop: '75px', textAlign: 'center' }}>
            ...
            <DropDownListComponent id="inline" cssClass="inlinecss" dataSource={this.employeesData} fields={this.fields} placeholder="Select an employee" popupHeight="200px" width="70px" popupWidth="140px" value='Michael' />
            </span>
          </div>
        </div>
