    ...
    return (
        <div className='control-pane'>
            <div className='control-section'>
                <div id='filtering'>
                    <DropDownListComponent id="country" ref={(dropdownlist) => {listObj = dropdownlist }} dataSource={searchData} filtering={onFiltering.bind(this)} filterBarPlaceholder='Search a country' allowFiltering={true} fields={fields} placeholder="Select a country" popupHeight="220px" />
                </div>
            </div>
