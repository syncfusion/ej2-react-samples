 ...
 */
 ...
 function UiVirtualization() {
    ...
    function onActionComplete() {
        (liElement as any)= document.getElementById('ui-list');
        if (Browser.isDevice) {
    ...
    function onChange(e: ChangeEventArgs) {
            ...
            <div className='ui-control-section control-section'>
                <div className='col-lg-8'>
                    <div className="content-wrapper" >
                        {/* ListView element */}
                        <ListViewComponent id='ui-list' dataSource={dataSource.data1} enableVirtualization={true} headerTitle="Contacts" fields={fields} cssClass="e-list-template"
                            height={500} template={template} actionComplete={onActionComplete.bind(this)} ref={(listview) => { listviewInstance = listview }} actionBegin={onActionBegin.bind(this)} showHeader={true} >
                                ...
                                <tr>
                                    ...
                                    <td style={{ width: '50%', paddingRight: '10px' }} >
                                        <div>
                                            ...
                                            <DropDownListComponent id='ddl' dataSource={ddlDatasource} fields={ddlFields} index={0} change={onChange.bind(this)} placeholder="Select a range"
                                                popupHeight="200px" />
                                        </div>
                                    </td>
                                </tr>
