...
function Remote() {
    ...
    let query:Query= new Query().from('Products').select('ProductID,ProductName').take(10);
    ...
    <div className='control-pane'>
        ...
        {/* ListView element */}
        <ListViewComponent id='sample-list' dataSource={dataSource} fields={fields} query={query} headerTitle='Products' showHeader={true}></ListViewComponent>
        </div>
