    ...
    return (
        <div className='control-pane'>
            <div className='control-section'>
                {/* ListView element */}
                <ListViewComponent id='groupedList' dataSource={groupDataSource} headerTitle='Settings' showHeader={true} fields={fields}
                    cssClass="e-list-template" template={listTemplate as any} groupTemplate={groupTemplate as any}
                    ></ListViewComponent>
            </div>
