  ...
  render() {
    return ( <div>
        <div className='control-section'>
            ...
            <PdfViewerComponent id="container" ref={(scope) => { this.viewer = scope; }} documentPath="https://cdn.syncfusion.com/content/pdf/form-filling-document.pdf"  validateFormFields={this.validateFormFields} enableFormFieldsValidation={true} showNotificationDialog={false} style={{ 'height': '640px' }}>
