    ...
    render() {
        ...
        return (<div>
            ...
            <div id="description">
                ...
                <p>
                    More information on the PDF Viewer instantiation can be found in this <a target="_blank" href="http://ej2.syncfusion.com/documentation/pdfviewer/getting-started.html#create-a-simple-pdfviewer">
