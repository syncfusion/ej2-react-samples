...
export class DocumentList extends SampleBase<{}, { hideDialog: boolean; hideGrid: boolean }> {

  private dialogInstance: DialogComponent;
  public viewer: PdfViewerComponent;
  private gridInstance: GridComponent;
  private commands:any=[{type:'View',buttonOption:{cssClass:'e-icons e-eye e-flat',title:'View'}},
  ...
  private buttonClick(args):void {
    this.dialogOpen();
    var viewerContainer = (document.getElementById('pdfviewer') as any).ej2_instances[0];
    ...
    return (
      <div className='control-pane pdfviewer-document-list'>
        <div  className='control-section col-lg-12 defaultDialogComponent dialog-target'>
          ...
          {this.state.hideGrid ? (
            <GridComponent ref={grid => this.gridInstance = grid} dataSource={gridData} commandClick={this.buttonClick}>
              <ColumnsDirective>
                <ColumnDirective headerText='File Name' headerTextAlign='Left' template={(props: any) => (
          ...
          <DialogComponent id="defaultDialog" showCloseIcon={true} visible={!this.state.hideDialog} width={'90%'}
            height={'90%'} isModal={true} ref={dialog => this.dialogInstance = dialog}
           header='Syncfusion Components inside Dialog' open={this.dialogOpen.bind(this)}
