...
function FormDesignerComponent() {
    ...
    return (<div>
        <div className='control-section'>
            ...
            <PdfViewerComponent id="container" ref={(scope) => { viewer = scope; }} documentPath="FormDesigner.pdf" serviceUrl="https://ej2services.syncfusion.com/production/web-services/api/pdfviewer" documentLoad={documentLoaded} validateFormFields={validateFormFields} enableFormFieldsValidation={true} showNotificationDialog={false} style={{ 'height': '640px' }}>
