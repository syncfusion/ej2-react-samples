...
function Annotations() {
    ...
    return (<div>
        <div className='control-section'>
            ...
            <PdfViewerComponent ref={(scope) => { viewer = scope; }} id="container" documentPath="Annotations.pdf" serviceUrl="https://ej2services.syncfusion.com/production/web-services/api/pdfviewer" documentLoad={documentLoaded} style={{ 'height': '640px' }}>
