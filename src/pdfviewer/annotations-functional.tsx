...
function Annotations() {
    ...
    return (<div>
        <div className='control-section'>
            ...
            <PdfViewerComponent ref={(scope) => { viewer = scope; }} id="container" documentPath="Annotations.pdf" serviceUrl="https://services.syncfusion.com/react/production/api/pdfviewer" documentLoad={documentLoaded} style={{ 'height': '640px' }}>
