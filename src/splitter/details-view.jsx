...
export class DetailsView extends SampleBase {
    constructor() {
        super();
        this.firstPaneSize = "35%";
        this.firstPaneMinSize = "25%";
        this.secondPaneSize = "65%";
        this.secondPaneMinSize = "45%";
        this.commonData = [];
        this.dataSource = {};
    ...
    ListViewContent() {
        return (<ListViewComponent className='splitter-list' height='289' dataSource={this.dataSource.data1} enableVirtualization={true} cssClass={'e-list-template'} template={this.template} select={this.onSelect.bind(this)} actionComplete={this.onActionComplete.bind(this)} ref={(listview) => { this.listViewObj = listview; }}>
