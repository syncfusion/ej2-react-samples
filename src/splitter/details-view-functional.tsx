    ...
    function ListViewContent(): JSX.Element {
        ...
        return (
            <div id="target" className="control-section details-view" >
                <SplitterComponent id="detailSplitter" height="292px" width="100%" ref={(splitter) => { splitterInstance = splitter }}
