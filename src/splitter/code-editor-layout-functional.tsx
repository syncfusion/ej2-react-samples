...
const CodeEditor = () => {
        ...
        return(
            <div className="splitter-editor-content">
                ...
                <div className="code-preview">
                    ...
                    <div style={paneImg}>
                        &lt;<span>img</span> src="src/albert.png"&gt;
                    </div>
                    <div>
                        &lt;<span>div</span>&gt;
                    </div>
        ...
        return(
            <div className="splitter-editor-content">
                ...
                <div className="code-preview">
                    <span>img &#123; </span>
                    <div id="code-text">
                        margin:<span>0 auto;</span>
                    </div>
                    <div id="code-text">
                        display:<span>flex;</span>
                    </div>
                    <div id="code-text">
                        height:<span>70px;</span>
                    </div>
                    <span> &#125; </span>
                </div>
            </div>
    ...
    const innerSplitterElement = () => {
        return(
            <SplitterComponent id="codeEditor">
            <PanesDirective>
    ...
    return (
        <div id="target" className="control-section code-editor" >
            <SplitterComponent id="splitter2" height="400px" orientation="Vertical">
                <PanesDirective>
