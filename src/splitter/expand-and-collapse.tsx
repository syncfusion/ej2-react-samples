...
export class ExpandCollapse extends SampleBase<{}, {}> {
    private leftPaneContent: string;
    private rightPaneContent1: string;
    private rightPaneContent2: string;
    private innerSplitterInstance: any;
    private splitterInstance: any;

    constructor() {
        super(arguments);
        this.leftPaneContent = `<div class="splitter-content-expand">
        ...
        this.rightPaneContent1 = `<div class="splitter-content-expand">
        ...
        this.rightPaneContent2 = `<div class="splitter-content-expand">
    ...
    public render(): JSX.Element {
        return (
            ...
            <SplitterComponent id="splitter2" separatorSize={3} orientation="Vertical"  ref={(splitter) => { this.splitterInstance = splitter; }} created={this.onCreate.bind(this)}>
                <PanesDirective>
