...
export class ExpandCollapse extends SampleBase<{}, {}> {
    private rightPaneContent1(): JSX.Element {
        return (
    ...
    private rightPaneContent2(): JSX.Element {
        return (
            <div className="splitter-content-expand">
    ...
    private innerSplitterInstance: SplitterComponent;
    private splitterInstance: SplitterComponent;

    private leftPaneContent(): JSX.Element {
        return (
            <div className="splitter-content-expand">
