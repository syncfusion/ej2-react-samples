...
export class Default extends SampleBase {
    ...
    render() {
        return (<div className='control-pane'>
          ...
          <p>
             More information on the calendar instantiation can be found in this <a target='_blank' href='https://ej2.syncfusion.com/react/documentation/calendar/getting-started/'>documentation</a> section.
          </p>
                </div>
            </div>);
    }
