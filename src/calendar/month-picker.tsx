...
import { CalendarComponent, ChangedEventArgs, CalendarView } from '@syncfusion/ej2-react-calendars';
...
export class MonthPicker extends SampleBase<{}, {}> {
    ...
    public onchange(args: ChangedEventArgs): void {
        ...
        (document.getElementById('date_label') as HTMLElement).textContent = 'Selected Value: ' + value;
    }
