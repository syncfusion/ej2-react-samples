    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                ...
                {/* Tooltip element */}
                <TooltipComponent id='targetContainer' ref={t => tooltipInstance = t} content='Drag me anywhere, to start walking with me !!!' offsetX={-15} target='#demoSmart' animation={tooltipAnimation}>
