...
const HtmlContentTooltip = () => {
    ...
    return (
        <div className='control-pane'>
            ...
            <div id="description">
                <p> 
                    Tooltip <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/tooltip/#content">content</a> has been customized using HTML tags and CSS, i.e. the content can be loaded with HTML tags such as &lt;img&gt;,
