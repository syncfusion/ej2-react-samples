        ...
        <div className='control-pane'>
            <div className='control-section'>
                <div id="htmlTemplate" className="col-lg-12 control-section">
                    <TooltipComponent id='content' created={created.bind(this)} content={tooltipTemplate} opensOn='Click' cssClass='e-tooltip-template-css' target="#content" ref={t => tooltipObj = t}>
