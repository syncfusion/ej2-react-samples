...
export class TemplateTooltip extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          ...
          <TooltipComponent id="template-tootip" content={this.state.content} target=".toolbar-container [title]" beforeRender={this.onBeforeRender.bind(this)} showTipPointer={false} offsetX={70} width={170}>
