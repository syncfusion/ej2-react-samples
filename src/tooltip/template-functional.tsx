   ...
   //Tooltip content customization.
    ...
    return (
        <div className='control-pane'>
            ...
            {/* Tooltip element */}
                <TooltipComponent id="template-tootip" content={content} target=".toolbar-container [title]" beforeRender={onBeforeRender.bind(this)} showTipPointer={false} offsetX={70} width={170}>
            ...
            <div id="description">
                <p>
                    This sample illustrates the way to display the template content on the tooltip. With the usage of Template, the user
