...
function TooltipMenu() {
    React.useEffect(() => {
     ...
     function onClick(args: any): void {
         ...
         if (!targetEle) {
             if (document.getElementsByClassName("e-tooltip-wrap").length > 0 && tooltip) {
                 tooltip.close(animationSettings);
             }
         }
     }
                 ...
                 <div className="control-section">
                     <div className="col-lg-12 control-section">
                         <TooltipComponent
                             ...
                             beforeRender={onBeforeRender.bind(this)}
                             target="#toolbar-menu button"
                             width={170}
                             tabIndex={0}
                             id="tooltip-menu"
                             content={tooltipTemplate.bind(this)}
                         >
