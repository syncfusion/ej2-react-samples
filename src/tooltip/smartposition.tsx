        ...
        return (
            <div className='control-pane'>
                ...
                to make it look fit within the sample container area. </p>
                    <p>In this sample, the tooltip is opened manually by using its <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/tooltip/#open">open</a> method on drag start of the target image.
                ...
                continuously and on drag stop, the tooltip will be hidden by using it’s <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/tooltip/#close">close</a> method.</p>
