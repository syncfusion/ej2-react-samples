 ...
 */
 ...
 import {
     ...
     Category, SplineRangeAreaSeries, ILoadedEventArgs, ChartTheme, Tooltip, Legend
                 ...
                 <div className='control-section'>
                     <ChartComponent id='charts' ref={chart => this.chartInstance = chart} style={{ textAlign: "center" }}
                         ...
                         <SeriesCollectionDirective>
                             <SeriesDirective dataSource={data} border={{ width: 2 }} xName='x' high='high' opacity={0.4}
                                 marker={{ visible: false }} low='low' animation={{ enable: true }} name='England' type='SplineRangeArea'>
                             </SeriesDirective>
                             <SeriesDirective dataSource={data1} border={{ width: 2 }} xName='x' high='high' opacity={0.4}
