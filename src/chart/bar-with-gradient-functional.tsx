    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <div>
                    <ChartComponent id='charts' style={{ textAlign: "center" }} legendSettings={{ visible: false }} primaryXAxis={{ valueType: 'Category', majorGridLines: { width: 1 }, majorTickLines: { width: 0 }, lineStyle: { width: 0 }, edgeLabelPlacement: 'Shift', enableWrap: true, maximumLabelWidth: 100 }} primaryYAxis={{ visible: false }} chartArea={{ border: { width: 0 } }} load={load.bind(this)} loaded={onChartLoad.bind(this)} width={Browser.isDevice ? '100%' : '90%'} title='Leading Revenue Drivers in India: 2024 Rankings' subTitle='Source: Wikipedia (Forbes 2024) | Revenue in USD Billions' tooltip={{ enable: true, format: '${point.x}: <b>${point.y} B</b>' }}>
