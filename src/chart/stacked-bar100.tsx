...
import {
    ...
    Legend, Category, StackingBarSeries, Tooltip, DataLabel, ILoadedEventArgs, ChartTheme, Highlight
    ...
    render() {
        return (
            <div className='control-pane'>
                ...
                <p>
                This React 100% stacked bar chart example visualizes a comparison of sales percentages over several months with a default 100% stacked bar series. The legend in the sample shows more information about the series.
            </p>
                </div>
                <div id="description">
                    <p>
                    ...
                    <p>
                        More information on the 100% stacked bar series can be found in this &nbsp;
                        <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/chart/chart-types/stacked-bar" aria-label="Navigate to the documentation for 100% Stacked Bar Chart in React Chart component">documentation section</a>.
                    </p>
                </div>
            </div>
        )
