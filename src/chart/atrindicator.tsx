        ...
        return (
            <div className='control-pane'>
                ...
                <div id="description">
                    ...
                    <p>
                        More information on the Average True Range Indicator can be found in this <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/chart/technical-indicators/#average-true-range-atr" aria-label="Navigate to the documentation for Average True Range in technical indicator of React Chart component">documentation section</a>.
                    </p>
                </div>
            </div >
        )
