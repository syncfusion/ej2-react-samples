        ...
        return (
            <div className='control-pane'>
                ...
                <div id="action-description">
                    <p>
                        This sample demonstrates selection feature in chart. To select a specific point, you can click on a point. You can change selection mode, by changing <code>Selection Mode</code> in properities. Also, multiple selection could be enabled by <code>Enable MultiplecSelection</code>.
                    </p>
                </div>
                <div id="description">
                    <p>
