...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject, DataLabel, BarSeries, Category, Legend, Tooltip } from '@syncfusion/ej2-react-charts';
...
export class Bar extends SampleBase {
    render() {
        ...
        }} chartArea={{ border: { width: 0 } }} load={this.load.bind(this)} width={Browser.isDevice ? '100%' : '60%'} title='UK Trade in Food Groups - 2015' loaded={this.onChartLoad.bind(this)} tooltip={{ enable: true }}>
            ...
            dataLabel: {
                ...
                font: {
                    fontWeight: '600', color: '#ffffff'
                                ...
                                <SeriesDirective dataSource={data2} xName='x' yName='y' type='Bar' name='Exports' width={2} marker={{
            dataLabel: {
                visible: true,
                position: 'Top',
                font: {
