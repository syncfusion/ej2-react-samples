    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <ChartComponent id='charts'style={{ textAlign: "center" }} primaryXAxis={{ valueType: 'Category', labelPlacement: 'OnTicks', interval: 1, coefficient: Browser.isDevice ? 80 : 100 }} load={load.bind(this)} legendSettings= {{ visible: true, enableHighlight: true }} title="Wind Rose Chart" loaded={onChartLoad.bind(this)} tooltip={{ enable: true, enableHighlight: true }}>
            ...
            <div id="description">
                <p>In this example, you can see how to render and configure the polar and radar charts with a stacking column series. Switching between polar and radar series can be done using Series Type in the property panel.</p>
                ...
                <p>
                    More information on the polar-radar series can be found in this <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/chart/chart-types/polar#stacked-column" aria-label="Navigate to the documentation for Polar Stacked Column in React Chart component">documentation section</a>.
                </p>
            </div>
        </div>
    )    
