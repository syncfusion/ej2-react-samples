 ...
 */
 ...
 import {
     ChartComponent, SeriesCollectionDirective, Highlight, DateTime, SeriesDirective, Inject, ILoadedEventArgs, ChartTheme, Tooltip, RangeStepAreaSeries, IPointRenderEventArgs
             ...
             <div className='control-pane'>
                 ...
                 <div className='control-section'>
                     <ChartComponent id='charts' ref={chart => chartInstance = chart} style={{ textAlign: "center" }}
                         ...
                         tooltip={{ enable: true ,  format:'Temperature : <b>${point.low} - ${point.high}</b>', header: '<b>${point.x}</b>',
                         shared: false}}
                         ...
                         <SeriesCollectionDirective>
                             <SeriesDirective dataSource={chartDataValues} border={{ width: 2 }} xName='x' high='high' opacity={0.5}
                                 marker={{ visible: false }} low='low' animation={{ enable: true }}  type='RangeStepArea'>
                             </SeriesDirective>
                         </SeriesCollectionDirective>
                     </ChartComponent>
                 </div>
                 ...
                 <div id="description">
                     <p>
                     In this example, you can see how to render and configure a range step area type chart. You can use <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/chart/border/">border</a> and <a target="_blank" href="https://helpej2.syncfusion.com/react/documentation/api/chart/seriesModel/#fill">fill</a> properties to customize the range step area. Both <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/chart/marker/">markers</a> and <a target="_blank" href="https://helpej2.syncfusion.com/react/documentation/api/chart/dataLabel/">dataLabels</a> are used to represent data points and their values.
                     </p>
                     <p>
