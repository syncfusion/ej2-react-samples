        ...
        return (
            <div className='control-pane'>
                ...
                <div className='control-section'>
                    <ChartComponent id='charts' style={{ textAlign: "center" }} primaryXAxis={{ valueType: 'Category', title: 'Population by Age Range', minimum: 0, interval: 3, majorGridLines: { width: 0 }, majorTickLines: { width: 0 } }} width={Browser.isDevice ? '100%' : '75%'} chartArea={{ border: { width: 0 }, margin: { bottom: 12 } }} primaryYAxis={{ labelFormat: '{value}%', interval: 3, title: 'Share of Total Population (%)', lineStyle: { width: 0 }, edgeLabelPlacement: 'Shift', rangePadding: 'Round', majorTickLines: { width: 0 } }} axisLabelRender={this.labelRender.bind(this)} legendSettings={{ enableHighlight: true, shapeWidth: 8, shapeHeight: 8 }} load={this.load.bind(this)} title='Belize Demographic Breakdown by Age and Gender (2024)' subTitle='Source: statisticstimes.com' loaded={this.onChartLoad.bind(this)} tooltip={{ enable: true, header: '${point.x}', enableHighlight: true }} tooltipRender={this.tooltipRender.bind(this)}>
