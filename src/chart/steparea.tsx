            ...
            <div className="control-pane">
                ...
                <div className="control-section">
                    <ChartComponent id="charts" style={{ textAlign: 'center' }}
                        primaryXAxis={{
                            valueType: 'Double', interval: 1, majorGridLines: { width: 0 }, edgeLabelPlacement: 'Shift',
                        }}
                ...
                <div id="description">
                    ...
                    <p>
                        More information about step area series can be found in this &nbsp;
                        <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/chart/chart-types/step-area" aria-label="Navigate to the documentation for Step Area Chart in React Chart component">documentation section</a>.
                    </p>
                </div>
            </div>
        )
