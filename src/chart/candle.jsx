...
export class Candle extends SampleBase {
    ...
    render() {
        return (<div className='control-pane'>
                ...
                <div className="row">
                    <ChartComponent id='charts' style={{ textAlign: "center" }} ref={chart => this.chart1 = chart} load={this.load.bind(this)} primaryXAxis={{
            valueType: 'DateTime',
        ...
        }} width={Browser.isDevice ? '100%' : '80%'} crosshair={{ enable: true, lineType: 'Vertical' }} pointRender={this.renderPoint.bind(this)} axisLabelRender={this.axisLabelRender.bind(this)} tooltipRender={this.tooltipLabelRender.bind(this)} chartArea={{ border: { width: 0 } }}>
