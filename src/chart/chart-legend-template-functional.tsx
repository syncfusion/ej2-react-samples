...
const ChartLegendTemplate: React.FC = () => {
  ...
  const loaded = (args: ILoadedEventArgs): void => {
    let chart: Element = document.getElementById('legendTemplateFunctional');
  ...
  const load = (args: ILoadedEventArgs): void => { loadChartTheme(args); };

  return (
    <div className='control-pane'>
      <style>{SAMPLE_CSS}</style>
      <div className='control-section'>
        <ChartComponent id='legendTemplateFunctional'
