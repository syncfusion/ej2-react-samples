        ...
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <ChartComponent id='charts'
                    ...
                    zoomSettings={{ enableSelectionZooming: true, enableMouseWheelZooming: true, enableDeferredZooming: false, enableScrollbar: true, enablePinchZooming: true, enableAnimation: true,  mode: 'X'}}
                    load={load}
