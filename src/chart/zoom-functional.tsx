...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject, SplineAreaSeries, DateTime, Legend, Zoom, ILoadedEventArgs, ChartTheme, ScrollBar } from '@syncfusion/ej2-react-charts';
...
const Zooming = () => {
    ...
    let data: any[] = GetZoomingData().series1;
    return (
        <div className='control-pane'>
            <style>{SAMPLE_CSS}</style>
            <div className='control-section'>
                <ChartComponent id='charts' style={{ textAlign: "center" }} primaryXAxis={{ valueType: 'DateTime', edgeLabelPlacement: 'Shift', majorGridLines: { width: 0 } }} load={load.bind(this)} primaryYAxis={{ title: 'Profit ($)', rangePadding: 'None', lineStyle: { width: 0 }, labelFormat: "${value}k", majorTickLines: { width: 0 } }} width={Browser.isDevice ? '100%' : '75%'} chartArea={{ border: { width: 0 } }} legendSettings={{ visible: false }} zoomSettings={{ enableMouseWheelZooming: true, enablePinchZooming: true, enableSelectionZooming: true, mode: 'X', showToolbar: true }} title='Sales History of Product X' loaded={onChartLoad.bind(this)}>
