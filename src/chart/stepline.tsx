                ...
                <div id="description">
                  ...
                  <code>Markers</code> are used to represent individual data and its values.
                    ...
                    <p>
                        ...
                        <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/chart/chart-types/step-line" aria-label="Navigate to the documentation for Step Line Chart in React Chart component">documentation section</a>.
                    </p>
                </div>
            </div>
        )
