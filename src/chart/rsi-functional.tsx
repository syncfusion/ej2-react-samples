    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <ChartComponent id='charts' load={load.bind(this)} style={{ textAlign: "center" }}
                    ...
                    <SeriesCollectionDirective>
                        <SeriesDirective dataSource={chartValues} xName='period' yName='silver'    name='Apple Inc'  bearFillColor='#2ecd71' bullFillColor='#e74c3d'
                    ...
                    <IndicatorsDirective>
                        <IndicatorDirective field='Close' yAxisName='secondary' type='Rsi' fill='#6063ff' seriesName='Apple Inc' period={3}
                            showZones={true} overBought={70} overSold={30} upperLine={{ color: '#ffb735' }} lowerLine={{ color: '#f2ec2f' }}
            ...
            <div id="description">
                ...
                <p>
                    More information on the RSI Indicator can be found in this <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/chart/technical-indicators/#relative-strength-index-rsi">documentation section</a>.
                </p>
            </div>
        </div >
    )
