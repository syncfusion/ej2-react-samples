...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject, Legend, Category, PolarSeries, RadarSeries, ScatterSeries, Tooltip } from '@syncfusion/ej2-react-charts';
        ...
        return (<div className='control-pane'>
            ...
            minimum: 0, maximum: 8, interval: 2
                            ...
                            <SeriesCollectionDirective>
                                <SeriesDirective dataSource={data1} xName='x' yName='y' name='2015' type='Polar' drawType='Scatter' marker={{ height: 10, width: 10, dataLabel: { name: 'text' } }}>
                                </SeriesDirective>
                                <SeriesDirective dataSource={data1} xName='x' yName='y1' name='2016' type='Polar' drawType='Scatter' marker={{ height: 10, width: 10, shape: 'Diamond', dataLabel: { name: 'text' } }}>
                                </SeriesDirective>
                                <SeriesDirective dataSource={data1} xName='x' yName='y2' name='2017' type='Polar' drawType='Scatter' marker={{ height: 10, width: 10, shape: 'Triangle', dataLabel: { name: 'text' } }}>
                                </SeriesDirective>
                            </SeriesCollectionDirective>
                        </ChartComponent>
                    </div>
