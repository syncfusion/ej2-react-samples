/**
 * Sample for the 100 percent StackingBar Series
 */
    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <ChartComponent id='charts' ref={chartInstance} style={{ textAlign: "center" }} legendSettings={{ enableHighlight: true, shapeWidth: 9, shapeHeight: 9 }} primaryXAxis={{ valueType: 'Category', majorGridLines: { width: 0 }, majorTickLines: { width: 0 } }} width={Browser.isDevice ? '100%' : '75%'} chartArea={{ border: { width: 0 }, margin: { bottom: 12 } }} primaryYAxis={{ lineStyle: { width: 0 }, majorTickLines: { width: 0 }, edgeLabelPlacement: 'Shift' }} load={load.bind(this)} title='Annual Renewable Energy Generation in China (2020–2023) by Source' subTitle='Source: wikipedia.org' loaded={onChartLoad.bind(this)} tooltip={{ enable: true, enableHighlight: true, header:'<b>Renewable Energy Generation</b>' }} legendClick={onLegendClick.bind(this)} tooltipRender={tooltipRender.bind(this)}>
