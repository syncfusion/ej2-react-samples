...
export class MultipleAxis extends SampleBase {
    render() {
        return (<div className='control-pane'>
            ...
            lineStyle: { width: 0 },
            labelFormat: '{value}°F'
        }} width={Browser.isDevice ? '100%' : '60%'} chartArea={{ border: { width: 0 } }} load={this.load.bind(this)} legendSettings={{ visible: false }} title='Weather Condition JPN vs DEU' loaded={this.onChartLoad.bind(this)} tooltip={{ enable: true }} animationComplete={this.animationComplete.bind(this)}>
                        ...
                        <AnnotationsDirective>
                            <AnnotationDirective content='<div id="chart_cloud"><img src="src/chart/images/cloud.png"  style={{width: "41px"; height: "41px"}}/></div>' x='Sun' y={35} coordinateUnits='Point' verticalAlignment='Top'>
                            </AnnotationDirective>
                            <AnnotationDirective content='<div id="chart_cloud"><img src="src/chart/images/sunny.png"  style={{width: "41px"; height: "41px"}}/></div>' x='Sat' y={34} coordinateUnits='Point' yAxisName='yAxis1'>
                            </AnnotationDirective>
                        </AnnotationsDirective>
