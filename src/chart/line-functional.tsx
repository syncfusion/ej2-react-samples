...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject, ILoadedEventArgs, ChartTheme, LineSeries, Legend, DateTime, Tooltip, AnnotationsDirective, AnnotationDirective, ChartAnnotation, ISeriesRenderEventArgs, Highlight } from '@syncfusion/ej2-react-charts';
