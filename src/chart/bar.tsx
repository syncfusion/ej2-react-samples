            ...
            <div className='control-pane'>
                ...
                <div id="description">
                   ...
                   <code>BarSeries</code> module into <code>services</code>.
                    ...
                    <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/chart/chart-types/bar" aria-label="Navigate to the documentation for Bar Chart in React Chart component">documentation section</a>.
                 </p>
                </div>
            </div>
        )
