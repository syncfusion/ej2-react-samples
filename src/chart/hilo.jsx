...
export class Hilo extends SampleBase {
    render() {
        ...
        }} legendSettings={{ visible: false }} chartArea={{ border: { width: 0 } }} tooltip={{ enable: true, shared: true }} crosshair={{ enable: true, lineType: 'Vertical', line: { width: 0 } }} width={Browser.isDevice ? '100%' : '80%'} title='AAPL Historical' loaded={this.onChartLoad.bind(this)}>
