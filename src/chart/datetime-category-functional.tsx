...
import {
    ...
    ILoadedEventArgs, DateTimeCategory, ColumnSeries, Inject, AnnotationDirective, AnnotationsDirective, DataLabel,
...
export let data1: any[] = [{ x: new Date(2017, 11, 20), y: 21, DataLabelMappingName:"21M" }, { x: new Date(2017, 11, 21), y: 24, DataLabelMappingName: "24M" },
                    ...
                    <ChartComponent id='charts' style={{ textAlign: "center" }}
                        ...
                        <SeriesCollectionDirective>
                            <SeriesDirective dataSource={data1} xName='x' yName='y' name="Product" type='Column'
                             marker={{ dataLabel: { visible: true, enableRotation: Browser.isDevice ? true : false, angle : -90, position: 'Top', name: 'DataLabelMappingName' } }} >
                            </SeriesDirective>
                        </SeriesCollectionDirective>
                    </ChartComponent>
                </div>
