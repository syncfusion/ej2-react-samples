        ...
        return (
            <div className='control-pane'>
                ...
                <div id="action-description">
                    <p>
                        This sample demonstrates polar series with line type for weather statistics for alaska. You can change <code>Series Type</code> in property panel. Start angle of as series can be changed by <code>Start Angle</code> and
        Series can be closed by enabling <code>Enabled</code> and inversed axis can be acheived by <code>Inversed</code> in property panel.
                    </p>
                </div>
                <div id="description">
                    <p>
