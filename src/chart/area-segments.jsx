...
export class AreaMultiColored extends SampleBase {
    render() {
        ...
        }} tooltip={{ enable: true }} legendSettings={{ visible: false }} chartArea={{ border: { width: 0 } }} load={this.load.bind(this)} width={Browser.isDevice ? '100%' : '60%'} title="Organic Revenue in US - 2016" loaded={this.onChartLoad.bind(this)}>
