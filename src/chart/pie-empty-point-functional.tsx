...
function PieEmptyPoint() {
    ...
    function mode(): void {
        pie.series[0].emptyPointSettings.mode = modeElement.value as EmptyPointMode;
        pie.refresh();
    };
        ...
        <div className='control-pane'>
            ...
            <div className='control-section row'>
                <div className='col-md-8'>
                    <AccumulationChartComponent id='pie-chart' ref={(scope) => { pie = scope }} title='Annual Product-Wise Profit Analysis' load={load.bind(this)} textRender={textRender.bind(this)} legendSettings={{ visible: false }} tooltip={{ enable: true, header: "", format: '<b>${point.x}</b><br> Profit: <b>$${point.y}K</b>' }} enableBorderOnMouseMove={false} loaded={onChartLoad.bind(this)}>
                    ...
                    <PropertyPane title='Properties'>
                        <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
                            <tr style={{ height: '50px' }}>
                                ...
                                <td style={{ width: '40%' }}>
                                    <div>
                                        <DropDownListComponent width="120px" id="selmode" change={mode.bind(this)} ref={d => modeElement = d} dataSource={droplist} fields={{ text: 'value', value: 'value' }} value="Drop" />
                                    </div>
                                </td>
                            </tr>
                        </table>
    ...
    function textRender(args: { text: string; point: { x: string; y: string; }; }) {
