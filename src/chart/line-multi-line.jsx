...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject, Tooltip, DateTime, MultiColoredLineSeries, } from '@syncfusion/ej2-react-charts';
...
export class LineMultiLine extends SampleBase {
    render() {
        ...
        }} tooltip={{ enable: true, shared: true, enableAnimation: false }} legendSettings={{ visible: false }} chartArea={{ border: { width: 0 } }} load={this.load.bind(this)} width={Browser.isDevice ? '100%' : '60%'} title="Particulate Levels in Rainfall" loaded={this.onChartLoad.bind(this)}>
                        <Inject services={[MultiColoredLineSeries, DateTime, Tooltip]}/>
                        <SeriesCollectionDirective>
                            <SeriesDirective dataSource={dataValues} width={1.5} xName='XValue' yName='YValue' name='Rainfall' type='MultiColoredLine' pointColorMapping='color'>
                            </SeriesDirective>
                        </SeriesCollectionDirective>
                    </ChartComponent>
                </div>
