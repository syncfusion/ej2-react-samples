...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject, CandleSeries, Category, Tooltip, ILoadedEventArgs, DateTime, Zoom, Logarithmic, Crosshair, LineSeries, BollingerBands, ChartTheme, IndicatorsDirective, IndicatorDirective, RangeAreaSeries, Legend, SplineRangeAreaSeries } from '@syncfusion/ej2-react-charts';
    ...
    return (
        <div className='control-pane'>
            ...
            <div id="description">
                ...
                <p>
                    More information on the Bollingear Bands Indicator can be found in this <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/chart/technical-indicators/#bollinger-band" aria-label="Navigate to the documentation for Bollinger Band in React Chart component">documentation section</a>.
                </p>
            </div>
        </div >
    )     
