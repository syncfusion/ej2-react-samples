...
var StackedLine = /** @class */ (function (_super) {
    __extends(StackedLine, _super);
        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_charts_1.ChartComponent, { id: 'charts', style: { textAlign: "center" }, primaryXAxis: {
                    ...
                    React.createElement(ej2_react_charts_1.SeriesCollectionDirective, null,
                        React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.chartData, xName: 'x', yName: 'y', name: 'John', width: '2', type: 'StackingLine', marker: { visible: true }, dashArray: '5,1' }),
                        React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.chartData, xName: 'x', yName: 'y1', name: 'Peter', width: '2', type: 'StackingLine', marker: { visible: true }, dashArray: '5,1' }),
                        React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.chartData, xName: 'x', yName: 'y2', name: 'Steve', width: '2', type: 'StackingLine', marker: { visible: true }, dashArray: '5,1' }),
                        React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.chartData, xName: 'x', yName: 'y3', name: 'Charle', width: '2', type: 'StackingLine', marker: { visible: true }, dashArray: '5,1' }))),
            ...
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    "In this example, you can see how to render and configure the stacked line type charts. Stacked Line type charts are used to represent time-dependent data, showing trends in data at equal intervals with stacked values of multiple series. You can use ",
    ...
    // custom code start
    StackedLine.prototype.load = function (args) {
