...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject, ChartTheme, Selection, Legend, ColumnSeries, Category, ScatterSeries, ILoadedEventArgs, SelectionMode } from '@syncfusion/ej2-react-charts';
...
const RangeSelection = () => {
    ...
    const [selectionMode, setSelectionMode] = useState<SelectionMode>('DragXY');
