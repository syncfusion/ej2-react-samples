...
function RangeSelection() {
    ...
    let droplist: { [key: string]: Object }[] = [
     ...
     function check(): void {
        chartInstance.allowMultiSelection = checkElement.checked;
        chartInstance.series[0].animation.enable = false;
        chartInstance.series[1].animation.enable = false;
        chartInstance.refresh();
    }
                ...
                <div className='control-section row'>
                    <div className='col-md-8'>
                        <ChartComponent id='charts' ref={chart => chartInstance = chart}
                            ...
                            title='Profit Comparision of A and B' loaded={onChartLoad.bind(this)}
                        ...
                        <PropertyPane title='Properties'>
                            <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
                                <tr style={{ height: '50px' }}>
                                    ...
                                    <td style={{ width: '40%' }}>
                                        <div>
                                            <DropDownListComponent width="120px" id="selmode" change={change.bind(this)} ref={d => dropElement = d} dataSource={droplist} fields={{ text: 'value', value: 'value' }} value="DragXY" />
                                        </div>
                                    </td>
                                </tr>
                                <tr style={{ height: '50px' }}>
