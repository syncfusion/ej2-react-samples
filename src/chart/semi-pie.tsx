...
let content = Browser.isDevice ? "<div style='font-Weight:600; font-size:10px;'>Browser<br>Market<br>Shares</div>" : "<div style='font-Weight:600; font-size:14px;'>Browser<br>Market<br>Shares</div>";
const SAMPLE_CSS = `
    .control-fluid {
  ...
  render() {
    return (
      ...
      <div className='control-section row'>
          <AccumulationChartComponent id='pie-chart' ref={pie => pie = pie} legendSettings={{ visible: false }} enableAnimation={false} enableBorderOnMouseMove={false} load={this.load.bind(this)} loaded={this.onChartLoad.bind(this)}>
