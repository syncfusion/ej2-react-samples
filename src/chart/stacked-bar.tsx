        ...
        return (
            <div className='control-pane'>
                ...
                <div className='control-section'>
                    <ChartComponent id='charts' style={{ textAlign: "center" }} legendSettings={{ enableHighlight: true, shapeWidth: 9, shapeHeight: 9 }} primaryXAxis={{ valueType: 'Category', majorGridLines: { width: 0 }, majorTickLines: { width: 0 } }} width={Browser.isDevice ? '100%' : '75%'} chartArea={{ border: { width: 0 }, margin: { bottom: 12 } }} primaryYAxis={{ maximum: 3500, labelFormat: '{value}TWh', lineStyle: { width: 0 }, majorTickLines: { width: 0 }, edgeLabelPlacement: 'Shift' }} load={this.load.bind(this)} title='Annual Renewable Energy Generation in China (2020–2023) by Source' subTitle='Source: wikipedia.org' loaded={this.onChartLoad.bind(this)} tooltip={{ enable: true, enableHighlight: true, header: '<b>Renewable Energy Generation</b>', format: '${series.name} : <b>${point.y}</b>' }} legendClick={this.onLegendClick.bind(this)} stackLabels={{ visible: true, format: '{value}TWh' }}>
