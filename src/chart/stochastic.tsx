            ...
            <div className='control-pane'>
                ...
                <div id="description">
                    ...
                    <p>
                        ...
                        <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/chart/technical-indicators/#stochastic" aria-label="Navigate to the documentation for Stochastic in technical indicators of React Chart component">documentation section</a>.
                  </p>
                </div>
            </div >
        )
