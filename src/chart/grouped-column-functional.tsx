    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <ChartComponent id="charts" style={{ textAlign: 'center' }} load={load.bind(this)} tooltipRender={tooltipRender.bind(this)} primaryXAxis={{ valueType: 'Category', interval: 1, majorGridLines: { width: 0 }, majorTickLines: { width: 0 } }} primaryYAxis={{ majorTickLines: { width: 0 }, lineStyle: { width: 0 }, title: 'Number of Medals Won' }} chartArea={{ border: { width: 0 }, margin: { bottom: 12 } }} tooltip={{ enable: true, enableHighlight: true, header: '<b>${point.x}</b>', format: '${series.groupName} : <b>${point.y} Gold</b>' }} width={Browser.isDevice ? '100%' : '75%'} title="Olympic Medal Trends by Country and Year" subTitle="A Historical Overview of Medal Counts Across Nations" legendSettings={{ visible: true, shapeWidth: 9, shapeHeight: 9 }} loaded={onChartLoad.bind(this)}>
