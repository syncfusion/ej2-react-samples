...
import {
    ...
    AccumulationDataLabel, PieSeries, Inject, IAccLoadedEventArgs, AccumulationTheme, AnnotationsDirective, AnnotationDirective, AccumulationAnnotationsDirective, AccumulationAnnotationDirective, ChartAnnotation, AccumulationAnnotation, AccumulationTooltip,
...
function SemiPie() {
    ...
    return (
        <div className='control-pane'>
            ...
            <div id="description">
                <p> In this example, you can see how to render a semi pie chart using <code>StartAngle</code> and <code>EndAngle</code> properties. Data labels are wrapped to fit inside the pie slice.</p>
