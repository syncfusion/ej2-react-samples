...
import { ChartComponent, SeriesCollectionDirective, AxesDirective, AxisDirective, RowDirective, RowsDirective, SeriesDirective, Inject, CandleSeries, Category, Tooltip, DateTime, Zoom, Logarithmic, StripLinesDirective, StripLineDirective, Crosshair, LineSeries, AtrIndicator, StripLine, IndicatorsDirective, IndicatorDirective } from '@syncfusion/ej2-react-charts';
    ...
    render() {
        return (<div className='control-pane'>
            ...
            AtrIndicator]}/>
                        ...
                        <AxesDirective>
                            <AxisDirective name='secondary' opposedPosition={true} rowIndex={0} majorGridLines={{ width: 0 }} lineStyle={{ width: 0 }} majorTickLines={{ width: 0 }} maximum={14} minimum={0} interval={7} title={'ATR'}>
                                <StripLinesDirective>
