...
export let data1: any[] = [{ x: "Hired", y: 50, text: "Hired: 50" },
...
function Funnel() {
    ...
    let funnel: AccumulationChartComponent;
    let slider: HTMLInputElement;
    return (
        <div className='control-pane'>
            <div className='control-section row'>
                <AccumulationChartComponent legendSettings={{ visible: false }} id='funnel-chart' ref={funnel => funnel = funnel} title='Recruitment Process' load={load.bind(this)} tooltip={{ enable: false, format: '${point.x} : <b>${point.y}</b>' }} resized={onChartResized.bind(this)} loaded={onChartLoad.bind(this)}>
                    ...
                    <AccumulationSeriesCollectionDirective>
                        <AccumulationSeriesDirective dataSource={data1} xName='x' yName='y' type='Funnel' width='45%' height='80%'  neckWidth='15%' gapRatio={0.03} neckHeight='18%' explode={false} dataLabel={{ 
                            connectorStyle: {length:'20px'},name: 'text', visible: true, position: 'Inside', font: { fontWeight: '600' }
                        }}>
