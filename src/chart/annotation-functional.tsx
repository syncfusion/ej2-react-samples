...
function Annotation() {
    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <ChartComponent id='charts' ref={charts => chart = charts} style={{ textAlign: "center" }}
                    ...
                    <SeriesCollectionDirective>
                        <SeriesDirective dataSource={dataSource} type='StackingColumn' xName='x' yName='y0' name='UK' >
                        </SeriesDirective>
                        <SeriesDirective dataSource={dataSource} type='StackingColumn' xName='x' yName='y1' name='Germany' >
                        </SeriesDirective>
                        <SeriesDirective dataSource={dataSource} type='StackingColumn' xName='x' yName='y2' name='France' >
                        </SeriesDirective>
                        <SeriesDirective dataSource={dataSource} type='StackingColumn' xName='x' yName='y3' name='Italy' >
                        </SeriesDirective>
                    </SeriesCollectionDirective>
                </ChartComponent>
            </div>
            ...
            <div id="description">
                ...
                <p>
                    More information on the chart annotation can be found in this <a target="_blank" href="http://ej2.syncfusion.com/react/documentation/chart/api-chartAnnotation.html">documentation section</a>.
                </p>
            </div>
        </div>
    )
    ...
    function chartMouseUp(args: IMouseEventArgs): void {
