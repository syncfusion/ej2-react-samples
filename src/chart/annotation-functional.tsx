...
import {
    ...
    AnnotationsDirective, AnnotationDirective, Series, AreaSeries, IAxisLabelRenderEventArgs, Tooltip
...
.e-view.highcontrast .box-bottom, .e-view.tailwind .box-bottom, .e-view.fluent .box-bottom,.e-view.material .box-bottom, .e-view.bootstrap .box-bottom,.e-view.bootstrap5 .box-bottom,.e-view.bootstrap4 .box-bottom, .e-view.fabric .box-bottom,
.e-view.highcontrast .first-box-bottom, .e-view.tailwind .first-box-bottom, .e-view.fluent .first-box-bottom,.e-view.material .first-box-bottom,.e-view.bootstrap .first-box-bottom, .e-view.bootstrap5 .first-box-bottom, .e-view.bootstrap4 .first-box-bottom ,.e-view.fabric .first-box-bottom, 
.e-view.highcontrast .first-box-bottom, .e-view.tailwind .first-box-bottom, .e-view.fluent .second-box-bottom,.e-view.material .second-box-bottom,.e-view.bootstrap .second-box-bottom, .e-view.bootstrap5 .second-box-bottom,.e-view.bootstrap4 .second-box-bottom, .e-view.fabric .second-box-bottom, 
.e-view.highcontrast .third-box-bottom, .e-view.tailwind .third-box-bottom, .e-view.fluent .third-box-bottom,.e-view.material .third-box-bottom,.e-view.bootstrap .third-box-bottom,.e-view.bootstrap5 .third-box-bottom,.e-view.bootstrap4 .third-box-bottom,.e-view.fabric .third-box-bottom,
.e-view.highcontrast  .box-left, .e-view.material  .box-left,.e-view.tailwind  .box-left, .e-view.fluent .box-left,.e-view.bootstrap .box-left, .e-view.bootstrap5 .box-left, .e-view.bootstrap4 .box-left,.e-view.fabric .box-left {
    position: relative;
    background: #fdf7e7;
...
.e-view.highcontrast .box-bottom, .e-view.material-dark .box-bottom,.e-view.tailwind-dark .box-bottom, .e-view.fluent-dark .box-bottom, .e-view.bootstrap-dark .box-bottom,.e-view.bootstrap5-dark .box-bottom,.e-view.fabric-dark .box-bottom,
.e-view.highcontrast .first-box-bottom, .e-view.material-dark  .first-box-bottom,.e-view.tailwind-dark .first-box-bottom, .e-view.fluent-dark .first-box-bottom,.e-view.bootstrap-dark .first-box-bottom, .e-view.bootstrap5-dark .first-box-bottom ,.e-view.fabric-dark .first-box-bottom, 
.e-view.highcontrast .second-box-bottom,.e-view.material-dark  .second-box-bottom, .e-view.fluent-dark .second-box-bottom,.e-view.bootstrap-dark .second-box-bottom, .e-view.bootstrap5-dark .second-box-bottom, .e-view.fabric-dark .second-box-bottom, 
.e-view.highcontrast .third-box-bottom,.e-view.material-dark  .third-box-bottom, .e-view.fluent-dark .third-box-bottom,.e-view.bootstrap-dark .third-box-bottom,.e-view.bootstrap5-dark .third-box-bottom,.e-view.fabric-dark .third-box-bottom,
.e-view.highcontrast .box-left, .e-view.material-dark .box-left, .e-view.fluent-dark .box-left,.e-view.bootstrap-dark .box-left, .e-view.bootstrap5-dark .box-left, .e-view.fabric-dark .box-left {
    position: relative;
    background: black;
    border: 1.5px solid black;
    padding: 2px 3px 2px 3px;
...
.e-view.highcontrast .box-top-left, .e-view.tailwind .box-top-left,.e-view.fluent .box-top-left,.e-view.material .box-top-left,.e-view.bootstrap .box-top-left,.e-view.bootstrap5 .box-top-left, .e-view.bootstrap4 .box-top-left, .e-view.fabric .box-top-left {
    position: relative;
    color: white;
    background: black;
    border: 1.5px solid black;
...
.e-view.highcontrast .box-top-left, .e-view.tailwind-dark .box-top-left, .e-view.fluent-dark .box-top-left,.e-view.material-dark .box-top-left,.e-view.bootstrap-dark .box-top-left,.e-view.bootstrap5-dark .box-top-left, .e-view.bootstrap4-dark .box-top-left, .e-view.fabric-dark .box-top-left {
    position: relative;
    color: white;
    background: #fdf7e7;
    border: 1.5px solid black;
    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <ChartComponent id='charts' ref={charts => chart = charts} style={{ textAlign: "center" }}
                    primaryXAxis={{
                       title: 'Distance',
                       labelFormat: 'N2',
                    ...
                    animationComplete={onChartLoad.bind(this)}
                    axisLabelRender={axisLabelRender.bind(this)}
                    selectionMode='Cluster'
                    tooltip={{ enable : true, shared: true, header: " ", enableMarker: false, format: "Distance: ${point.x} KM <br> ${point.y} KM/H", fill: "white", border:{color:"rgb(247, 206, 105)", width: 2},textStyle:{color:"black"} }}
                    selectedDataIndexes={[{ series: 0, point: 0 }]}
                    legendSettings={{ visible: true, toggleVisibility: false }}
                    title="Speed Data Plot for Interlagos Circuit">
                    <Inject services={[StackingColumnSeries, Category, Legend,Tooltip, Selection, ChartAnnotation, AreaSeries]} />
                    <AnnotationsDirective>
                        <AnnotationDirective content= '<div class="first-box-bottom" > Senna S </div>' x='0.360' y='80' coordinateUnits='Point' > </AnnotationDirective>
                        <AnnotationDirective content='<div class="second-box-bottom" > Descida do Lego </div>' x='1.400' y='130' coordinateUnits='Point' > </AnnotationDirective>
                        <AnnotationDirective content='<div class="third-box-bottom" > Ferradura </div>' x='2.100' y='200' coordinateUnits='Point' > </AnnotationDirective>
                        <AnnotationDirective content='<div class="box-left" > Curva do Sol </div>' x='0.85' y='155' coordinateUnits='Point' > </AnnotationDirective>
                        <AnnotationDirective content='<div class="box-top-left" > Reta Oposta </div>' x='0.700' y='292' coordinateUnits='Point' > </AnnotationDirective>
                        <AnnotationDirective content='<div class="box-bottom" > Bico de Pato </div>' x='2.750' y='80' coordinateUnits='Point' > </AnnotationDirective>
                        <AnnotationDirective content='<div class="box-top" > Mergulho </div>' x='3.136' y='284' coordinateUnits='Point' > </AnnotationDirective>
                        <AnnotationDirective content= { Browser.isDevice  ? '' : '<div class="third-box-bottom" > Junção </div>'} x='3.270' y='98' coordinateUnits='Point' > </AnnotationDirective>
                        <AnnotationDirective content= { Browser.isDevice  ? '' : '<div class="box-top" > Subida dos <br /> Boxes </div>'} x='3.800' y='312' coordinateUnits='Point' > </AnnotationDirective>
                        <AnnotationDirective content= { Browser.isDevice  ? '' :'<div style="font-family: sans-serif" > Max, accelertion <br /> 5.00 g at 5th gear </div>'} x='1.65' y='300' coordinateUnits='Point' > </AnnotationDirective>
                        <AnnotationDirective content= { Browser.isDevice  ? '' :'<div style="font-family: sans-serif" > Max, accelertion <br /> 4.58 g at 5th gear </div>'} x='2.60' y='250' coordinateUnits='Point' > </AnnotationDirective>
                    </AnnotationsDirective>
                    <SeriesCollectionDirective>
                        <SeriesDirective dataSource={chartDatas}  type= 'Area'  xName='Distance' yName='Speed'
                            border = {{
                                width: 2.5,
                                color: '#000000'
                            }}
