        ...
        return (
            <div className='control-pane'>
                ...
                <p>
                        ...
                        <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/chart/chart-types/polar#spline" aria-label="Navigate to the documentation for Polar Spline in React Chart component">documentation section</a>.
              </p>
                </div>
            </div>
        )
