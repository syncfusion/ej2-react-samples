...
export class Symbols extends SampleBase {
    render() {
        ...
        }} width={Browser.isDevice ? '100%' : '60%'} chartArea={{ border: { width: 0 } }} title='FB Penetration of Internet Audience' loaded={this.onChartLoad.bind(this)} legendSettings={{ visible: false }} tooltip={{ enable: true }}>
                        <Inject services={[LineSeries, Legend, Tooltip, DataLabel, Category]}/>
                        <SeriesCollectionDirective>
                            <SeriesDirective dataSource={data} xName='x' yName='y' width={2} name='December 2007' type='Line' marker={{ visible: true, dataLabel: { name: 'text' }, width: 10, height: 10, shape: 'Diamond' }}>
                            </SeriesDirective>
                            <SeriesDirective dataSource={data} xName='x' yName='y1' width={2} name='December 2008' type='Line' marker={{ visible: true, dataLabel: { name: 'text' }, width: 10, height: 10, shape: 'Pentagon' }}>
                            </SeriesDirective>
                            <SeriesDirective dataSource={data} xName='x' yName='y2' width={2} name='December 2009' type='Line' marker={{ visible: true, dataLabel: { name: 'text' }, width: 10, height: 10, shape: 'Triangle' }}>
                            </SeriesDirective>
                        </SeriesCollectionDirective>
                    </ChartComponent>
