  ...
  render() {
    return (
      ...
      <div className='control-section row'>
          <AccumulationChartComponent legendSettings={{ visible: false }} id='funnel-chart' title='Recruitment Process' load={this.load.bind(this)} tooltip={{ enable: false, format: '${point.x} : <b>${point.y}</b>' }} loaded={this.onChartLoad.bind(this)}>
