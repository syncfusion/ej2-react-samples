    ...
    render() {
        return (
            <div className='control-pane'>
                ...
                <div id="description">
                    <p>
                        In this example, you can see how to render and configure the Bollingear Bands Indicator. Bollingear Bands Indicator is used to represent the price movements in stock. You can use
