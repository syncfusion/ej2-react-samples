        ...
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <ChartComponent id='charts' style={{ textAlign: "center" }}
                    load={load.bind(this)}
                    primaryXAxis={{ majorGridLines: { width: 0 }, title: 'Score of Final Examination', minimum: 0, maximum: 100, edgeLabelPlacement: 'Shift' }}
                    primaryYAxis={{
                    ...
                    title='Examination Result' loaded={onChartLoad.bind(this)}>
            ...
            <div id="action-description">
                <p>
                This React Histogram Chart example visualizes final examination results. The number of students between each interval is shown in data labels.
                </p>
            </div>
            <div id="description">
                <p>
