    ...
    return (
        <div className='control-pane'>
            ...
            <div id="description">
                ...
                <p>
                    More information on the StepLine series can be found in this <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/chart/chart-types/step-line" aria-label="Navigate to the documentation for Step Line Chart in React Chart component">documentation section</a>.
                </p>
            </div>
        </div>
    )
