    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <AccumulationChartComponent id='pie-chart2' load={load.bind(this)} legendSettings={{ visible: true, toggleVisibility: false, position: 'Bottom', textWrap: 'Wrap' }} enableBorderOnMouseMove={false} selectionMode='Point' tooltip={{ enable: true, format: '<b>${point.x}</b><br>Percentage: <b>${point.y}%</b>', header: "" }}>
