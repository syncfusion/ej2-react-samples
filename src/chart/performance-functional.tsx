...
import {
    ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject, AreaSeries,
     ILoadedEventArgs, ChartTheme, DateTime, Legend
    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                    <ChartComponent id='charts' ref={(scope) => { chart = scope }}
                        primaryXAxis={{
                            intervalType: 'Years',
                            valueType: 'DateTime',
                        ...
                        }}   chartArea={{ border: { width: 0 } }}  legendSettings={{ visible: false }}  title="Chart with 100k points"  width={Browser.isDevice ? '100%' : '90%'} loaded={onChartLoad.bind(this)} load={load.bind(this)} >
            ...
            <div id="action-description">
                <p>
                   This sample demonstrates the performance of React Charts rendering 100K data points.
                </p>
            </div>
            <div id="description">
                <p>
