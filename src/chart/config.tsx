export const ChartSampleOrder: Object = [
    ...
    },
    {
        ...
        'description': 'This demo sample for Essential JavaScript2 Chart control demonstrates how to render and configure the step line series.'
    },
    {
    ...
    {
        'path': 'chart/line-segments', 'component': 'LineZone', 'name': 'Line Zone', 'order': '01', 'category': 'Line Charts',
        'description': 'This demo for Essential JS2 Chart control shows how to render and configure the points in a particular range using MultiColoredLine series.'
    },
    {
        'path': 'chart/line-multi-line', 'component': 'LineMultiLine', 'name': 'Multi Colored Line', 'order': '01', 'category': 'Line Charts',
        'description': 'This demo for Essential JS2 Chart control shows how to render and configure the points in a particular range using MultiColoredLine series.'
    },
    {
        'path': 'chart/stacked-line', 'component': 'StackedLine', 'name': 'Stacked Line', 'order': '01', 'category': 'Line Charts',
        'description': 'This demo sample for Essential JavaScript2 Chart control demonstrates how to render and configure the stacked line series.'
    },
    {
        'path': 'chart/stacked-line-100', 'component': 'StackedLine100', 'name': '100% Stacked Line', 'order': '01', 'category': 'Line Charts',
        'description': 'This demo sample for Essential JavaScript2 Chart control demonstrates how to render and configure the 100% stacked line series.'
    },
    {
        'path': 'chart/area', 'component': 'Area', 'name': 'Area', 'order': '02', 'category': 'Area Charts',
        'description': 'This demo sample for Essential JS2 Chart control shows how to render and configure the area series chart.'
    },
    {
        'path': 'chart/spline-area', 'component': 'SplineArea', 'name': 'Spline Area', 'order': '02', 'category': 'Area Charts',
        'description': 'This demo sample for Essential JavaScript2 Chart control demonstrates how to render and configure the spline area series.'
    },
    {
    ...
    {
        'path': 'chart/rangearea', 'component': 'RangeArea', 'name': 'Range Area', 'order': '02', 'category': 'Area Charts',
    ...
    {
        'path': 'chart/stacked-step-area', 'component': 'StackedStepArea', 'name': 'Stacked Step Area', 'order': '02', 'category': 'Area Charts',
    ...
    {
        'path': 'chart/area-segments', 'component': 'AreaMultiColored', 'name': 'Area Zone', 'order': '02', 'category': 'Area Charts',
        'description': 'This demo sample for Essential JavaScript2 Chart control demonstrates how to render the points in a particular range using MultiColoredArea series.'
    },
    {
    ...
    {
        'path': 'chart/grouped-column', 'component': 'GroupedColumn', 'name': 'Grouped Column', 'order': '03', 'category': 'Bar Charts',
    ...
    },
    {
        ...
        'description': 'This demo sample for Essential JavaScript2 Chart control demonstrates how to render and configure the column charts.'
    },
    {
        'path': 'chart/range-column', 'component': 'RangeColumn', 'name': 'Range Column', 'order': '03', 'category': 'Bar Charts',
        'description': 'This demo sample for Essential JavaScript2 Chart control demonstrates how to render and configure the range column series.'
    },
    {
        'path': 'chart/range-bar', 'component': 'RangeBar', 'name': 'Inversed Range Column', 'order': '03', 'category': 'Bar Charts',
    ...
    },
    {
        ...
        'description': 'This demo sample for Essential JavaScript2 Chart control demonstrates how to render and configure the hilo series.'
    },
    {
        'path': 'chart/hiloopenclose', 'component': 'HiloOpenClose', 'name': 'Hilo Open Close', 'order': '04', 'category': 'Financial Charts',
        'description': 'This demo sample for Essential JavaScript2 Chart control demonstrates how to render and configure the hiloopenclose series.'
    },
    {
        'path': 'chart/candle', 'component': 'Candle', 'name': 'Candle', 'order': '04', 'category': 'Financial Charts',
        'description': 'This demo sample for Essential JavaScript2 Chart control demonstrates how to render and configure the candle series.'
    },
    {
        'path': 'chart/scatter', 'component': 'Scatter', 'name': 'Scatter', 'order': '05', 'category': 'Scatter and Bubble',
        'description': 'This demo sample for Essential JavaScript2 Chart control demonstrates how to render and configure the scatter series.'
    },
    {
    ...
    {
        'path': 'chart/histogram', 'component': 'Histogram', 'name': 'Histogram', 'order': '06', 'category': 'Other Types',
    ...
    {
        'path': 'chart/lazy-loading', 'component': 'LazyLoading', 'name': 'Lazy Loading', 'order': '11', 'category': 'Data Binding',
    ...
    {
        'path': 'chart/datetime-category', 'component': 'DatetimeCategoryAxis', 'name': 'DateTime Category Axis', 'order': '12', 'category': 'Chart Axes',
    ...
    {
        'path': 'chart/strip-line-recurrence', 'component': 'Striplinerecurrence', 'name': 'Strip Line Recurrence', 'order': '12', 'category': 'Chart Axes',
    ...
    {
        'path': 'chart/multi-level-label', 'component': 'Multilevellabels', 'name': 'Multi Level Labels', 'order': '12', 'category': 'Chart Axes',
        'description': 'This demo sample for Essential JavaScript2 Chart control demonstrates how to group the axis labels. '
    },
    {
        'path': 'chart/axis-crossing', 'component': 'AxisCrossing', 'name': 'Axes Crossing', 'order': '12', 'category': 'Chart Axes',
    ...
    {
        'path': 'chart/sorting', 'component': 'Sorting', 'name': 'Sorting', 'order': '13', 'category': 'Chart Customization',
    ...
    {
        'path': 'chart/rtl', 'component': 'RTL', 'name': 'RTL', 'order': '13', 'category': 'Chart Customization',
