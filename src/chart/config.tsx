export const ChartSampleOrder: Object = [
    ...
    {
        'path': 'chart/column-drilldown', 'component': 'ColumnDrilldown', 'name': 'Column Drilldown', 'order': '04', 'category': 'Bar Charts',
        'description': 'This demo sample for Essential JavaScript2 Chart control demonstrates how to render and configure the column series with drilldown.'
    },
    {
