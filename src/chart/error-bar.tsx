        ...
        return (
            <div className='control-pane'>
                ...
                <div className='control-section ' style={{ textAlign: "center" }}>
                    <ChartComponent id='charts' primaryXAxis={{ valueType: 'Category', interval: 1,  majorTickLines: {width : 0}, minorTickLines: {width: 0}, majorGridLines: { width: 0 }, labelRotation: Browser.isDevice ? -45 : 0, labelIntersectAction: Browser.isDevice ? 'None' : 'Trim' }} chartArea={{ border: { width: 0 } }} primaryYAxis={{ minimum: 0, maximum: 1250, interval: 250, lineStyle: { width: 0 }, title: 'Quantity' }} load={this.load.bind(this)} tooltipRender={this.tooltipRender.bind(this)} highlightColor= '' width={Browser.isDevice ? '100%' : '75%'} pointRender={pointRender.bind(this)} title="Quantity vs Items" loaded={this.onChartLoad.bind(this)} tooltip={{ enable: true,  enableMarker: false }}>
