...
export class Stochastic extends SampleBase {
    render() {
        return (<div className='control-pane'>
        ...
        }} tooltip={{ enable: true, shared: true }} crosshair={{ enable: true, lineType: 'Vertical' }} width={Browser.isDevice ? '100%' : '80%'} chartArea={{ border: { width: 0 } }} legendSettings={{ visible: false }} zoomSettings={{ enableSelectionZooming: true, mode: 'X', enablePan: true }} title='AAPL 2012-2017' loaded={this.onChartLoad.bind(this)}>
            ...
            StochasticIndicator, StripLine]}/>
                        ...
                        <IndicatorsDirective>
                            <IndicatorDirective type='Stochastic' field='Close' seriesName='Apple Inc' yAxisName='secondary' fill='#6063ff' kPeriod={2} dPeriod={3} showZones={true} periodLine={{ color: '#f2ec2f' }} period={3} animation={{ enable: false }} upperLine={{ color: '#e74c3d' }} lowerLine={{ color: '#2ecd71' }}>
                            </IndicatorDirective>
                        </IndicatorsDirective>
                    </ChartComponent>
                </div>
