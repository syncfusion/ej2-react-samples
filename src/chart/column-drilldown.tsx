        ...
        return (
            <div className='control-pane'>
                ...
                <div className='control-section'>
                    <div id="link">
                        <a id="category" style={{ visibility: this.clicked ? 'visible' : 'hidden', display: 'inline-block', cursor: 'pointer' }} onClick={this.goBack}>Population</a>
                        <p style={{ visibility: this.clicked ? 'visible' : 'hidden', display: 'inline-block' }} id="symbol">&nbsp;&gt;&gt;&nbsp;</p>
