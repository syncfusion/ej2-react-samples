    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section row'>
                <div className='col-md-9'>
                    <ChartComponent id='charts' ref={chart => chartInstance = chart}
                        ...
                        load={load.bind(this)}
                        title="Sales Comparision" loaded={onChartLoad.bind(this)}
                        tooltip={{ enable: true }}>
            ...
            <div id="description">
                ...
                <p>
                    More information on the print can be found in this <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/chart/chart-print/#print">documentation section</a>.
                </p>
            </div>
        </div >
    )
