            ...
            <div className='control-pane'>
                ...
                <div className='control-section'>
                    <ChartComponent id='charts' style={{ textAlign: "center" }} ref={charts => chartInstance = charts}
                        ...
                        title='Weather Condition JPN vs DEU' loaded={onChartLoad.bind(this)}
                        tooltip={{ enable: true }}
                ...
                <div id="description">
                    ...
                    <p>
                        More information on the multiple axis can be found in this <a target="_blank" href="http://ej2.syncfusion.com/react/documentation/chart/api-axis.html">documentation section</a>.
                    </p>
                </div>
            </div>
        )
