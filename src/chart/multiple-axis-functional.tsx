            ...
            <div className='control-pane'>
                ...
                <div className='control-section'>
                    <ChartComponent id='charts' style={{ textAlign: "center" }} ref={charts => chartInstance = charts}
                        ...
                        title='Weather Data' loaded={onChartLoad.bind(this)}
                        tooltip={{ enable: true }}
                        ...
                        <AnnotationsDirective>
                            <AnnotationDirective content='<div id="chart_cloud"><img src="src/chart/images/cloud.png"  style={{width: "41px"; height: "41px"}}/></div>'
                                x='Sun' y={62} coordinateUnits='Point' verticalAlignment='Top'>
                            </AnnotationDirective>
                            <AnnotationDirective content='<div id="chart_cloud"><img src="src/chart/images/sunny.png"  style={{width: "41px"; height: "41px"}}/></div>'
                                x='Sat' y={35} coordinateUnits='Point' yAxisName='yAxis1'>
                            </AnnotationDirective>
                        </AnnotationsDirective>
                        <SeriesCollectionDirective>
                            <SeriesDirective dataSource={data1} xName='x' yName='y' width={2} name='Germany' type='Column'   marker={{
                                    visible: true, width: 7, height: 7
                                }} >
                            </SeriesDirective>
                            <SeriesDirective dataSource={data2} xName='x' yName='y' name='Japan' type='Spline'
                                marker={{
