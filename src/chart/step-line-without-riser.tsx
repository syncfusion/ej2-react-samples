...
import {
    ...
    DateTime, StepAreaSeries, Tooltip, ILoadedEventArgs, ChartTheme, Highlight, Legend
        ...
        return (
            <div className='control-pane'>
                ...
                <div id="description">
                    ...
                    <p>
                        More information on the step area series can be found in this <a target="_blank" href="https://ej2.syncfusion.com/documentation/chart/Chart-types/step-area">documentation
                            section</a>.
                    </p>
                </div>
            </div>
