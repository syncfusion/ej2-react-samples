...
export let Segments: any = [[0, 5 ], [ 7, 12 ], [14, 19 ], [21, 26 ] ];
    ...
    let tailwindDarkColors: string[] = ["#8B5CF6", "#22D3EE", "#F87171", "#4ADE80", "#E879F9", "#FCD34D", "#F97316", "#2DD4BF", "#F472B6",
        "#10B981"];
    let material3Colors: string[] = ["#6355C7", "#00AEE0", "#FFB400", "#F7523F", "#963C70", "#FD7400", "#4BE0BC", "#2196F5", "#DE3D8A",
        "#162F88"];
...
export class KeyboardNavigation extends SampleBase<{}, {}> {
        ...
        return (
            <div className='control-pane'>
                ...
                <div className='control-section'>
                    <ChartComponent id='keyboard_charts' ref={chart => this.chartInstance = chart} style={{ textAlign: "center" }}
                        selectionMode='Point'
    ...
    public getStriplineValues(legendClickedName): void {
        let chart: any = this.chartInstance;
