    ...
    render() {
        return (<div className='control-pane'>
                ...
                <div className='control-section'>
                    ...
                    <div className="row">
                    <RangeNavigatorComponent id='rangenavigator' style={{ textAlign: "center" }} valueType='DateTime' load={this.load.bind(this)} tooltip={{ enable: true, displayMode: 'Always', format: 'MM/dd/yyyy' }} navigatorStyleSettings={{
