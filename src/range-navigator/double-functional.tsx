...
export let selectedTheme: string = loadRangeNavigatorTheme(null, true);
    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                ...
                <div className="row">
                    <RangeNavigatorComponent id='double' ref={rangenavigator => rangenavigator1 = rangenavigator} style={{ textAlign: "center" }}
