export const TreeViewSampleOrder:Object = [
    { 'path': 'treeview/default', 'component':'Default', 'name': 'Default Functionalities', 'order': '01', 'category': 'TreeView' },
    { 'path': 'treeview/icons', 'component':'Icons', 'name': 'Icons and Images', 'order': '01', 'category': 'TreeView' },
    ...
    { 'path': 'treeview/remotedata', 'component':'RemoteData', 'name': 'Remote Data', 'order': '02', 'category': 'Data Binding' }
]
