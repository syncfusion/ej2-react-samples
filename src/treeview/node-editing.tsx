  ...
  render() {
    return (       
      <div className = 'control-pane'>
        ...
        <div id="description">
            <p>The <code>TreeView</code> component has the built-in option to edit and modify the node text in inline by enabling the <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/treeview#allowediting">allowEditing</a> property.</p>
