    ...
    return (       
      <div className = 'control-pane'>
        ...
        <div id="description">
            ...
            <p>For more information, you can refer to the <a href="http://ej2.syncfusion.com/react/documentation/treeview/checkbox.html" target="_blank">Checkboxes</a> section from the documentation.</p>
        </div>
      </div>
    )
  }
