...
export class PeriodicTable extends SampleBase<{}, {}> {
    ...
    private handleMouseEnter = (args: MouseEventArgs) => {
    ...
    private handleMouseLeave = (args: MouseEventArgs) => {
    ...
    private handleSelectionChange = (args: any) => {
    ...
    private getConnectorDefaults = (connector: ConnectorModel): ConnectorModel => {
    ...
    render() {
        return (
            <div className="control-pane diagram-control-pane">
                <div className="control-section periodic-table-container" style={{ width: "100%", opacity: 0 }}>
                    ...
                    <DiagramComponent
                        ...
                        width={'100%'}
                        height={'700px'}
                        nodes={this.periodicTableModel.nodes}
                        connectors={this.periodicTableModel.connectors}
                        ...
                        created={() => {
                            if (diagramInstance){
                                ...
                                // show diagram
                                setTimeout(()=>{
                                    const container = document.querySelector('.periodic-table-container') as HTMLElement;
                                    if (container) {
