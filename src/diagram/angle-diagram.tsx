...
function calculateEfficiency() {
  ...
  // Tweaked model to match TS changes
    ...
    return (
      <div className="control-pane diagram-control-pane">
        ...
        <div id="action-description">
          <p>
            This sample demonstrates an interactive solar panel tilt system built with the Syncfusion® EJ2 React Diagram component. Adjust
