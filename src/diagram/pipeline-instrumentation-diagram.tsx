...
export class PipelineInstrumentationDiagram extends SampleBase<{}, {}> {
    ...
    private getNodeDefaults = (node: NodeModel): NodeModel => {
    ...
    render() {
        return (
            <div className="control-pane">
                <div className="control-section diagram-pipeline" style={{ width: "100%", opacity: 0 }}>
                    <style>
                        {`
                    ...
                    <DiagramComponent
                        ...
                        width={'100%'}
                        height={'700px'}
                        nodes={this.pipelineModel.nodes}
                        connectors={this.pipelineModel.connectors}
                        ...
                        created={() => {
                            ...
                            // show diagram
                            setTimeout(()=>{
                                const container = document.querySelector('.diagram-pipeline') as HTMLElement;
                                if (container) {
