...
/* tslint:enable */
let flipPorts = [{ offset: { x: 0.01, y: 0.221 } }, { offset: { x: 0.01, y: 0.779 } }, { offset: { x: 0.99, y: 0.221 } }, { offset: { x: 0.99, y: 0.779 } }];
let jkPorts = [{ offset: { x: 0.01, y: 0.270 } }, { offset: { x: 0.01, y: 0.5 } }, { offset: { x: 0.01, y: 0.720 } }, { offset: { x: 0.99, y: 0.270 } }, { offset: { x: 0.99, y: 0.720 } }, { offset: { x: 0.5, y: 0.01 } }, { offset: { x: 0.5, y: 0.99 } }];
let rPorts = [{ offset: { x: 0.01, y: 0.210 } }, { offset: { x: 0.01, y: 0.778 } }, { offset: { x: 0.5, y: 0.218 } }, { offset: { x: 0.99, y: 0.210 } }, { offset: { x: 0.99, y: 0.778 } }];
...
export class LogicCircuit extends SampleBase {
    render() {
      ...
      <style>{SAMPLE_CSS}</style>
        ...
        ]} width={"100%"} height={"600px"} symbolHeight={60} symbolWidth={62} symbolPreview={{ height: 50, width: 50 }} getSymbolInfo={(symbol) => {
            return { fit: true };
        }}/>
            </div>
