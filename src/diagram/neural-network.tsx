...
// Layer label node (HTML annotation)
...
// Neuron node (ellipse with tooltip)
...
// Connector (with tooltip and annotation)
...
// --- Build Diagram once, for both speed and sample-browsers ---
...
// ---- Main React Sample Component ----
export class NeuralNetworkDiagram extends SampleBase<{}, {}> {
  rendereComplete() {
    if (diagramInstance) {
  ...
  render() {
    return (
      <div className="control-pane">
        <div className="control-section neural-network-container" style={{ opacity: 0 }}>
          <div style={{ width: "100%" }}>
            <DiagramComponent
              id="diagram"
              ...
              created={() => {
                  ...
                  setTimeout(()=>{
                      // show diagram
                      const container = document.querySelector('.neural-network-container') as HTMLElement;
                      if (container) {
