...
import { ComplexHierarchicalTree, DataBinding, DiagramComponent, Inject, DiagramTools } from "@syncfusion/ej2-react-diagrams";
    ...
    render() {
        ...
        <div className="col-lg-8 control-section">
          <div className="content-wrapper" style={{ width: "100%" }}>
            <DiagramComponent id="diagram" ref={diagram => (diagramInstance = diagram)} width={"100%"} height={580} layout={{
        ...
        }} tool={DiagramTools.ZoomPan //Disables all interactions except zoom/pan
          ...
          <div className="row property-panel-content" style={{ paddingTop: "10px" }}>
            ...
            <div className="row" style={{ paddingTop: "8px" }}>
              ...
              <div className="col-xs-7">
                ...
                <NumericTextBoxComponent ref={marginLeftObjRef => (marginLeftObj = marginLeftObjRef)} id="marginLeft" value={10} step={1} format={"##.##"} change={(args) => {
            update("left");
        }}/>
              </div>
            </div>
            <div className="row" style={{ paddingTop: "8px" }}>
              ...
              <div className="col-xs-7">
                ...
                <NumericTextBoxComponent ref={marginTopObjRef => (marginTopObj = marginTopObjRef)} id="marginTop" value={50} step={1} format={"##.##"} change={(args) => {
            update("top");
        }}/>
              </div>
            </div>
            <div className="row" style={{ paddingTop: "8px" }}>
              ...
              <div className="col-xs-7">
                ...
                <NumericTextBoxComponent ref={horizontalSpacingObjRef => (horizontalSpacingObj = horizontalSpacingObjRef)} id="horiontal" value={40} step={1} format={"##.##"} change={(args) => {
            update("hspacing");
        }}/>
              </div>
            </div>
            <div className="row" style={{ paddingTop: "8px" }}>
              ...
              <div className="col-xs-7">
                ...
                <NumericTextBoxComponent ref={verticalSpacingObjRef => (verticalSpacingObj = verticalSpacingObjRef)} id="vertical" value={40} step={1} format={"##.##"} change={(args) => {
            update("vspacing");
        }}/>
              </div>
            </div>
