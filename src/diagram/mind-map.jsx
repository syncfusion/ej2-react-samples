...
import { MindMap as MindMapModule, HierarchicalTree, ConnectorConstraints, ToolBase, randomId, PointPort, SelectorConstraints, SnapConstraints, PortVisibility, DiagramComponent, NodeConstraints, Node, DiagramTools, Inject, DataBinding } from "@syncfusion/ej2-react-diagrams";
...
export class MindMap extends SampleBase {
    ...
    render() {
        ...
        <div className="content-wrapper" style={{ width: "100%" }}>
            <DiagramComponent ref={diagram => (diagramInstance = diagram)} id="diagram" style={{ width: "74%", height: "550px", float: "left" }} width={"100%"} height={"550px"} snapSettings={{ constraints: SnapConstraints.None }} tool={DiagramTools.SingleSelect} layout={{
            type: "MindMap",
