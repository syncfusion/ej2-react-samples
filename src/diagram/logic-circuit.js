 ...
 */
/* tslint:disable */
var orData = "M21.71,76.5h0a83.59,83.59,0,0,0,0-55.9l0-.1h1.58a66.37,66.37,0,0,1,54.1,28h0a66.37,66.37,0,0,1-54.1,28Z M 77,48.5 L 100,48.5 Z M 0,32.5 L 25,32.5Z M 0,65.5 L 25,65.5";
...
var notData = "M0,50.5 L 23,50.5Z M82,50.5 L 100,50.5Z  M75.5,50.5 L23.5,78.5 L23.5,22.5 L75.5,50.5Z M 79,50.5 m -5, 0 a 5,5 0 1,0 10,0 a 5,5 0 1,0 -10,1Z";
/* tslint:enable */
...
var LogicCircuit = /** @class */ (function (_super) {
    __extends(LogicCircuit, _super);
    function LogicCircuit() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    LogicCircuit.prototype.render = function () {
        return (React.createElement("div", { className: "control-pane" },
            React.createElement("style", null, SAMPLE_CSS),
            React.createElement("div", { className: "control-section" },
                React.createElement("div", { id: "logicCircuit", style: { width: "100%", height: "600px" } },
                    ...
                    React.createElement("div", { id: "palette-space", className: "sb-mobile-palette" },
                        React.createElement(ej2_react_diagrams_1.SymbolPaletteComponent, { id: "symbolpalette", expandMode: "Multiple", palettes: [
                            ...
                            ], width: "100%", height: "600px", symbolHeight: 60, symbolWidth: 62, symbolPreview: { height: 50, width: 50 }, getSymbolInfo: function (symbol) {
                                return { fit: true };
                            } })),
                    React.createElement("div", { id: "diagram-space", className: "sb-mobile-diagram" },
                        React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "diagram", ref: function (diagram) { return (diagramInstance = diagram); }, width: "100%", height: "100%", snapSettings: {
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample visualizes implementation of three input Boolean functions using universal logic gates. The shapes for logic gates are designed with diagram's path node feature.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null, "This example shows how to create Boolean algebraic laws and theorems using diagram `path` shapes. The `type` property of the `shape` can be used to create `path` nodes. The` data` property of the shape allows you to define path data of the path shape."),
                React.createElement("br", null))));
    };
    LogicCircuit.prototype.rendereComplete = function () {
