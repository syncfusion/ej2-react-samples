...
const handleCreated = () => {
    ...
    if (diagram) {
        ...
        setTimeout(()=>{
            // show diagram
            const container = document.querySelector('.shortest-path-container') as HTMLElement;
            if (container) {
...
export class ShortestPathVisualizerDiagram extends SampleBase<{}, {}> {
  ...
  cleanupIntervals() {
    ...
    render() {
        return (
            <div className="shortest-path-container" style={{ opacity: 0 }}>
