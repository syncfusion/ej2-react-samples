...
function VirtualizationModel() {
    ...
    function setNodeDefaults(node: any): Node {
    ...
    function setConnectorDefaults(connector: ConnectorModel): ConnectorModel {
            ...
            <div>
                <div style={{ width: "100%" }}>
                    ...
                    <DiagramComponent
                        ...
                        width={"100%"}
                        height={"500px"}
                        snapSettings={{ constraints: SnapConstraints.None }} // Disables snapping to objects
                        dataSourceSettings={{
