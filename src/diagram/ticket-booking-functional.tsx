...
let diagramInstance: Diagram | undefined;
...
function isSeatBooked(seatId: string): boolean {
...
function onTimingClick(timing: ShowTiming): void {
...
function TicketBookingDiagram() {
  ...
  React.useEffect(() => {
    ...
    const firstAvailableTiming = showTimings.find(t => t.status !== "sold-out");
    ...
    <div className="control-pane diagram-seat-booking">
      ...
      <div className="control-section">
        ...
        <DialogComponent
          ...
          ref={(dialog) => (seatDialogRef = dialog)}
          visible={false}
          width="400px"
...
export default TicketBookingDiagram;
