...
// Snapping Sample component definition
                        ...
                        <DiagramComponent
                            ...
                            onUserHandleMouseDown={(args: UserHandleEventsArgs) => {
                                switch (args.element.name) {
                                    ...
                                    case 'Draw':
                                        ...
                                        (diagramInstance.drawingObject as any).type = (diagramInstance.drawingObject as any).type || 'Orthogonal';
                            ...
                            selectionChange={(args: ISelectionChangeEventArgs) => {
                                if (args.state === 'Changed') {
                                    ...
                                    let selectedConnectors: ConnectorModel[] = diagramInstance.selectedItems.connectors;
