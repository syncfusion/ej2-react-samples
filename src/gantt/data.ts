...
export let overviewData: object[] = [
    ...
    { TaskId: 4, TaskName: "Project Charter Creation", ParentId: 2, StartDate: new Date('2025-02-10'), EndDate: new Date('2025-02-27'), Progress: 100, Status: "Open", Priority: "High", Assignee: "Emily Chen", resource: [], Department: "Project Management", Predecessor: "3FS", ConstraintType: 3, ConstraintDate: new Date('2025-02-10') },
