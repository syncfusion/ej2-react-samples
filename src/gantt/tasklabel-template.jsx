...
export class TasklabelTemplate extends SampleBase {
    constructor() {
        ...
        this.templateLeft = this.LeftLabelTemplate;
        this.templateRight = this.RightLabelTemplate;
        this.labelSettings = {
