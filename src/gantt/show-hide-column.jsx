              ...
              <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
                  ...
                  <td style={{ width: '30%' }}>
                    ...
                    <td style={{ width: '70%', paddingRight: '10px' }}>
                      <div id='columnddl'>
                         <DropDownListComponent width="120px" id="dropDown" change={this.change.bind(this)} dataSource={this.columnsName} fields={{ text: 'name', value: 'id' }} value="TaskID" ref={dropdown => this.dropdownObj = dropdown}/>
                      </div>
                    </td>
                  </tr>
                  <tr>
                     ...
                     <td style={{ width: '70%' }}>
                        <div>
                          <ButtonComponent id='show' created={this.created.bind(this)} ref={button => this.showButtonObj = button} onClick={this.showButtonClick.bind(this)}> Show </ButtonComponent>
                        </div>
                     </td>
                  </tr>
                  <tr>
