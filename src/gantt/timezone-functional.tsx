  ...
  return (
    <div className="control-pane">
      <div className="control-section">
        <GanttComponent id='Timezone' dataSource={timezoneData} timelineSettings={timelineSettings} height='450px' timezone='UTC'
          durationUnit='Hour' includeWeekend={true} treeColumnIndex={1} dateFormat='hh:mm a' dayWorkingTime={dayWorkingTime} taskFields={taskFields}>
          <ColumnsDirective>
