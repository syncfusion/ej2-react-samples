...
function GridLines() {
 ...
 let linesData: { [key: string]: Object }[] = [
  ...
  function changeLine(args: ChangeEventArgs): void {
    let lines: any = args.value.toString();
    ganttInstance.gridLines = lines;
      ...
      <div className='control-pane'>
        <div className='control-section'>
          <div className='col-lg-9'>
            <GanttComponent id='GridLines' ref={gantt => ganttInstance = gantt} dataSource={projectNewData}
            ...
            <PropertyPane title='Properties'>
              <table id="property" className="property-panel-table" title="Properties" style={{ width: '100%' }}>
                ...
                <tr>
                  <td style={{ width: '100%' }}>
                    <div>
                      <DropDownListComponent ref={dropdown => dropdownObj = dropdown} id='gridLines' dataSource={linesData} fields={{ text: 'type', value: 'id' }}
