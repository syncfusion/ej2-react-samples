      ...
      <div className='control-section'>
        <div className='col-lg-9'>
          <GanttComponent id='Events' dataSource={projectNewData} highlightWeekends={true}
            ...
            columns={columns} toolbar={toolbar} editSettings={editSettings} splitterSettings={splitterSettings}
            taskFields={taskFields} labelSettings={labelSettings} height='410px'
            created={created.bind(this)} load={load.bind(this)} dataBound={dataBound.bind(this)} toolbarClick={toolbarClick.bind(this)}
            beforeTooltipRender={beforeTooltipRender.bind(this)} actionBegin={actionBegin.bind(this)}
            actionComplete={actionComplete.bind(this)} cellEdit={cellEdit.bind(this)} endEdit={endEdit.bind(this)}
            taskbarEditing={taskbarEditing.bind(this)} taskbarEdited={taskbarEdited.bind(this)}
            rowSelecting={rowSelecting.bind(this)} rowSelected={rowSelected.bind(this)} rowDeselecting={rowDeselecting.bind(this)}
            rowDeselected={rowDeselected.bind(this)} columnDragStart={columnDragStart.bind(this)} columnDrag={columnDrag.bind(this)}
            columnDrop={columnDrop.bind(this)} expanding={expanding.bind(this)} expanded={expanded.bind(this)}
            collapsing={collapsing.bind(this)} collapsed={collapsed.bind(this)} columnMenuClick={columnMenuClick.bind(this)}
            columnMenuOpen={columnMenuOpen.bind(this)} contextMenuClick={contextMenuClick.bind(this)}
            contextMenuOpen={contextMenuOpen.bind(this)} resizeStart={resizeStart.bind(this)} resizing={resizing.bind(this)}
            resizeStop={resizeStop.bind(this)} splitterResizeStart={splitterResizeStart.bind(this)}
            splitterResizing={splitterResizing.bind(this)} splitterResized={splitterResized.bind(this)}
            recordDoubleClick={recordDoubleClick.bind(this)} onTaskbarClick={onTaskbarClick.bind(this)}
            ...
            <table id="property" className="property-panel-table" title="Event Trace" style={{ width: '100%' }}>
              ...
              <tr>
                <td style={{ width: '50%', padding: '20px 10px 10px 80px' }}>
                  <div>
                    <ButtonComponent onClick={clear.bind(this)}> Clear </ButtonComponent>
                  </div>
                </td>
              </tr>
