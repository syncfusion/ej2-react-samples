...
export class EventMarkers extends SampleBase {
    constructor() {
        ...
        this.eventMarkerDay1 = new Date('04/02/2019');
        this.eventMarkerDay2 = new Date('04/09/2019');
        this.eventMarkerDay3 = new Date('04/19/2019');
        this.eventMarkerDay4 = new Date('05/23/2019');
        this.eventMarkerDay5 = new Date('06/20/2019');
        this.labelSettings = {
            leftLabel: 'TaskName'
        };
