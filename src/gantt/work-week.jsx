...
export class WorkWeek extends SampleBase {
    constructor() {
        ...
        this.defaultValue = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"];
        this.taskFields = {
            id: 'TaskID',
            name: 'TaskName',
            startDate: 'StartDate',
    ...
    select(args) {
        let workingDays = extend([], this.multiselectObj.value, [], true);
    ...
    render() {
        ...
        <div className='control-section'>
          <div className='col-lg-8'>
            <GanttComponent id='WorkWeek' ref={gantt => this.ganttInstance = gantt} dataSource={projectNewData} highlightWeekends={true} taskFields={this.taskFields} labelSettings={this.labelSettings} height='410px' projectStartDate={this.projectStartDate} projectEndDate={this.projectEndDate}>
                ...
                <tr>
                  ...
                  <td style={{ width: '70%' }}>
                    <div style={{ paddingTop: '0px' }}>
                      <MultiSelectComponent ref={multiselect => this.multiselectObj = multiselect} id="WorkWeek" mode="CheckBox" value={this.defaultValue} dataSource={this.workDays} showDropDownIcon={true} popupHeight='350px' fields={{ text: 'day', value: 'id' }} select={this.select.bind(this)} removed={this.removed.bind(this)}>
