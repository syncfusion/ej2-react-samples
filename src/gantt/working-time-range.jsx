...
export class WorkingTimeRange extends SampleBase {
    ...
    updateTime() {
        let defaultDate = "08/08/2016", startDate = new Date(defaultDate), endDate = new Date(defaultDate);
        let decPlace = this.workStartTime.value - Math.floor(this.workStartTime.value);
    ...
    render() {
        ...
        <div className='control-section'>
          <div className='col-lg-8'>
            <GanttComponent id='WorkingTimeRange' ref={gantt => this.ganttInstance = gantt} dataSource={workTimeRange} highlightWeekends={true} taskFields={this.taskFields} labelSettings={this.labelSettings} height='410px' timelineSettings={this.timelineSettings} durationUnit={this.durationUnit} projectStartDate={this.projectStartDate} projectEndDate={this.projectEndDate}>
