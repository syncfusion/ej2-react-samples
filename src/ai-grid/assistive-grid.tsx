        ...
        return (
            <div className='control-pane'>
                ...
                <div id="action-description">
                    ...
                    Grid data operations, such as sorting, filtering, paging and grouping, can be performed using natural language input, offering a streamlined alternative to traditional UI interactions.</p>
                    <p>To explore this and more Syncfusion React Smart AI integrations locally, check out our <a target='_blank'
                        href='https://github.com/syncfusion/smart-ai-samples/tree/master/react/src/ai-components/grid/assistive-grid'
