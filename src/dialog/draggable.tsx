      ...
      <div className = 'control-pane'>
        <div id='target' className='col-lg-12 control-section dialog-draggable'>        
            ...
            <div id="description">
                ...
                href="https://ej2.syncfusion.com/react/documentation/dialog/api-dialogComponent.html#allowdragging">allowDragging </a> property.
                when you configure the <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/dialog/api-dialogComponent.html#target">target</a> property, the dialog can be draggable within its target container alone.
                ...
                More information on the draggable operation of Dialog can be found in the <a target="_blank" 
                    href="https://ej2.syncfusion.com/react/documentation/dialog/getting-started.html#draggable">
