...
export class Basic extends SampleBase<{}, { hideAlertDialog: boolean, hideConfirmDialog: boolean, hidePromptDialog: boolean; }> {
    ...
    private alertButtons: ButtonPropsModel[];
    private confirmButton: ButtonPropsModel[];
    private promptButtons: ButtonPropsModel[];
    private animationSettings: AnimationSettingsModel;

    private alertButtonEle: HTMLButtonElement;
    private alertButtonRef: React.Ref<HTMLButtonElement>;
    private confirmButtonEle: HTMLButtonElement;
    private confirmButtonRef: React.Ref<HTMLButtonElement>;
    private promptButtonEle: HTMLButtonElement;
    private promptButtonRef: React.Ref<HTMLButtonElement>;
    private spanEle: HTMLSpanElement;
    private spanRef: React.Ref<HTMLSpanElement>;
