...
export class Positioning extends SampleBase<{}, { hideDialog: boolean; }> {
  ...
  private position: PositionDataModel;
    ...
    return (
      <div className='control-pane'>
        <div id='target' className='col-lg-12 control-section dialog-position'>
          ...
          <DialogComponent id='positionDialog' header='Choose a Dialog Position' visible={this.state.hideDialog} showCloseIcon={true} position={this.position} footerTemplate={this.footerTemplate} width='452px' ref={positionDialog => this.defaultDialogInstance = positionDialog}
          ...
          <div id="description">
            <p>
              By default, the dialog is displayed in the center of the target container. Use the <a target="_blank"
                href="https://ej2.syncfusion.com/react/documentation/api/dialog/#position">
            ...
            <p>
              More information on the positioning of Dialog can be found in the <a target="_blank"
                href="https://ej2.syncfusion.com/react/documentation/dialog/getting-started/#positioning">
