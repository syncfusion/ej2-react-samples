...
export class AjaxContent extends SampleBase {
    constructor(props) {
        super(props);
        this.innerContent = `On October 17, Microsoft will release its Fall Creators Update for the Windows
    ...
    render() {
        return (<div className='control-pane'>
                <div id='target' className='control-section ajaxcontent col-lg-12'>
                    ...
                    <DialogComponent id="dialog" visible={this.state.hideDialog} header={'<img class="img1" src="src/dialog/images/2.png">' + 'What’s Coming from Microsoft this Fall'} showCloseIcon={true} animationSettings={this.animationSettings} ref={dialog => this.dialogInstance = dialog} width={'500px'} target={'#target'} close={this.dialogClose} open={this.dialogOpen} content={this.innerContent} buttons={this.buttons}></DialogComponent>
                </div>
