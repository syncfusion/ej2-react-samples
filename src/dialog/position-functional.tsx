    ...
    <div className="control-pane">
      <div id="target" className="col-lg-12 control-section dialog-position">
        ...
        <DialogComponent
          ...
          ref={(positionDialog) => (defaultDialogInstance = positionDialog)}
          target="#target"
          open={dialogOpen}
          close={dialogClose}
          closeOnEscape={false}
