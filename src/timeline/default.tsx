        ...
        return (
            <div className="control-pane">
                ...
                <div id="description">
                    ...
                    In this example, we have used the <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/timeline/timelineItem/#content">content</a> property to display the item's content, <a  target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/timeline/timelineItem/#dotcss">dotCss</a> property to customize the dot with background color and <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/timeline/timelineItem/#cssclass">cssClass</a> to customize the last connector as dashed style.
                    </p>
                </div>
            </div>
        );
