...
const API = () => {
  ...
  return (
    <div className="control-pane">
          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td> <SwitchComponent id="opposite" checked={true} change={(args) => handleTogglers(args, 'oppositeContent')}></SwitchComponent> </td>
              </tr>
              <tr>
                <td><label htmlFor="icon"> Show Icon </label></td>
                <td> <SwitchComponent id="icon" checked={true} change={(args) => handleTogglers(args, 'dotCss')}></SwitchComponent> </td>
              </tr>
              <tr>
                <td><label htmlFor="reverse"> Reverse </label></td>
                <td> <SwitchComponent id="reverse" change={(args) => setIsReverse(args.checked)}></SwitchComponent> </td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div id="description">
        <p>This sample can be customized further with the combination of Timeline properties from the property pane. For
          example,</p>
        <ul>
