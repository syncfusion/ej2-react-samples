...
const ChatIntegration = () => {
    ...
    const chatUiInst = useRef<ChatUIComponent>(null);
    const listviewInst = useRef<ListViewComponent>(null);
    ...
    const handleMessageSend = (args: MessageSendEventArgs) => {
        chatUiInst.current.suggestions = [];
        setTimeout(() => {
                    ...
                    <SplitterComponent paneSettings={[{ size: 'auto', resizable: false, cssClass: "chat-leftContent" }, { size: '80%', resizable: false, cssClass: "chat-rightContent" }]} created={() => { onCreated()}}>
                        ...
                        <div id="integration-chat">
                                <ChatUIComponent
                                    ...
                                    messageSend={(args) => { handleMessageSend(args) }}
                                />
                        </div>
                    </SplitterComponent>
                </div>
