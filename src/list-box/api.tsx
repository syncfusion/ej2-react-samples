...
export class Api extends SampleBase<{}, {sortOrder: SortOrder, selectionSettings: SelectionSettingsModel}> {
    ...
    public data = data["vegetableData"];
    public ddlData1 = data["sort"]; public ddlData2 = data["selectionMode"];
    ...
    public ddlFields: FieldSettingsModel = { text: 'type', value: 'type' };
    public sortChange(args: ChangeEventArgs) {
        this.setState({ sortOrder: args.value as SortOrder });
    }
    public selectionChange(args: ChangeEventArgs) {
        this.setState({ selectionSettings: { mode: args.value } as SelectionSettingsModel });
    }
    render() {
        return (
